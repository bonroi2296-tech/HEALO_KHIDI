...
put(5, {
    (8, 1): 'o 카자흐스탄 UMIT International Oncological Center와 업무협약을 체결하여 '
            ...
            '러시아어 회신의 협진 왕복 실증\n'
            'o 원격협진 실시간 통역(한↔러) 자막 3,277건(시험 제외), AI 상담 품질 자동 회귀시험 통과율 95.3%',
...
PARA_BLOCKS = {
    (72, 73): [
        ...
        'ㅇ (플랫폼 운영 실적) 원격협진 실시간 통역(한↔러) 자막 3,277건(시험 데이터 제외). AI 상담 품질 매일 자동 회귀시험 — 최근 30일 1,288회, 통과율 95.3%, 의료 레드라인 위반 1건 자동 검출',
