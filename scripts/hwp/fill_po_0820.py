...
put(23, {
    ...
    (3, 0): '운영비‧일반수용비\n(홍보비‧소모품비)', (3, 1): '07.23~07.31', (3, 2): '계', (3, 3): '13,600,000',
...
PARA_BLOCKS = {
    ...
    # 4. 개선 및 향후 추진계획
    (96, 97): [
        'ㅇ (집행률) 사업비 집행률 16.4%(보조금 11.2%, 자부담 37.2%). 인건비 국고분‧국외여비‧위탁사업비 미집행',
