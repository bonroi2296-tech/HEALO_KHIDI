...
B.note(s, "특허 10-2745881(EMR 연동 플랫폼) · 10-2868334(AI 기반 중개 시스템) 보유. AI 자막은 오인식이 있을 수 있어 진단·처방 근거로 쓰지 않으며, 중요한 진료 대화에는 통역 인력을 함께 배정합니다. 위 화면은 기능을 설명하기 위한 예시이며 실제 통화를 촬영한 것이 아닙니다.", y=510)
...
B.note(s, "화면은 러시아어판이며 한국어·영어·카자흐어·중국어·일본어로도 같은 기능을 제공합니다(2026년 9월 10일 촬영). 보험 화면의 보장 조건은 상품마다 다르고 대기기간·기존 진단 제외 같은 조건이 붙으므로, 실제 적용은 환자의 계약을 확인한 뒤에 안내합니다.", y=498)
