...
s = B.content(
    ...
    "①~③은 현지에서, ④~⑥은 방한 이후의 단계입니다. 여섯 단계가 모두 한 플랫폼에 기록됩니다.",
)
steps = [
...
B.note(s, "특허 10-2745881(EMR 연동 플랫폼) · 10-2868334(AI 기반 중개 시스템) 보유. AI 자막은 오인식이 있을 수 있어 진단·처방 근거로 쓰지 않으며, 중요한 진료 대화에는 통역 인력을 함께 배정합니다. 위 화면은 기능을 설명하기 위한 예시이며 실제 통화를 촬영한 것이 아닙니다.", y=492)
...
B.note(s, "화면은 러시아어판이며 한국어·영어·카자흐어·중국어·일본어로도 같은 기능을 제공합니다(2026년 9월 10일 촬영). 보험 화면의 보장 조건은 상품마다 다르고 대기기간·기존 진단 제외 같은 조건이 붙으므로, 실제 적용은 환자의 계약을 확인한 뒤에 안내합니다.", y=504)
...
B.note(s, "이대서울·이대목동은 이화의료원과 2026년 7월 의료서비스 협약을 체결했고, 신촌세브란스는 협약 없이 환자 의뢰가 가능한 경로로 업체 등록을 진행하고 있습니다. 이대목동·신촌세브란스는 보건복지부 제5기 상급종합병원(지정기간 2024-01-01~2026-12-31, 47개소)이고 이대서울병원은 제5기 지정 기관이 아닙니다.")
