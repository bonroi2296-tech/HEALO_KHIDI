...
quad(X0, Y0, 'S', '강점', 'Strength', [
    ...
    ('제도 요건 완비', '외국인환자 유치업 등록 A-2026-01-02-06761 · 보증보험 1억원'),
...
quad(X0, Y0 + CH + GAP, 'O', '기회', 'Opportunity', [
    ('법이 우리 쪽으로 온다', '의료 해외진출법 개정 2026.05 공포 → 2027.05 시행, 비대면 협진 허용'),
...
d.text((X0 + 34, BY + 54),
       '법 시행(2027.05) 전에 「이미 돌아가는 원격협진 실사례」를 쌓아 둔다   ·   제도가 열리는 날 바로 쓸 수 있는 선행 자산',
