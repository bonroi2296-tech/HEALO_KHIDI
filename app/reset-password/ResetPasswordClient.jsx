...
// 비밀번호 규칙 — 가입폼(SignupClient)과 동일 (8자 + 대/소문자 + 숫자)
...
const PW_ERROR = {
  ...
  lowercase: { ko: "영문 소문자를 포함해야 합니다", en: "Must include a lowercase letter", ru: "Должен содержать строчную букву", kz: "Кіші латын әрпі болуы керек", zh: "必须包含一个小写字母", ja: "小文字を含める必要があります" },
  uppercase: { ko: "영문 대문자를 포함해야 합니다", en: "Must include an uppercase letter", ru: "Должен содержать заглавную букву", kz: "Бас латын әрпі болуы керек", zh: "必须包含一个大写字母", ja: "大文字を含める必要があります" },
