  ...
  return (
    <div className="bg-white">
          ...
          <div className="space-y-4 md:space-y-5">
            {c.products.items.map((p, i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 shadow-sm">
                ...
                <p className="mt-1.5 text-sm md:text-base text-gray-500 leading-relaxed">{p.desc}</p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <p className="text-sm text-gray-500 leading-relaxed max-w-3xl mb-5">{c.whyKorea.hospitals.caption}</p>
      ...
      {/* FAQ — 네이티브 details */}
      <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">{c.faq.title}</h2>
        ...
        <div className="mt-10 border-t border-gray-200 pt-6">
          ...
          <p className="text-xs text-gray-500 leading-relaxed max-w-3xl">{c.disclaimer.body}</p>
        </div>
      </section>
      ...
      <section className="bg-teal-700">
        <div className="max-w-4xl mx-auto px-4 py-14 md:py-20 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">{c.closing.title}</h2>
          <p className="text-teal-50 text-sm md:text-base mb-8 max-w-xl mx-auto leading-relaxed">{c.closing.body}</p>
          <Link
            href="/inquiry"
