...
export const COPY = {
  ...
  "ja": {
    ...
    "partner": {
      ...
      "body": "healwithは、保険会社・アシスタンス会社との協業を歓迎し、各ケースの韓国側の工程をまとめて担います。大韓民国保健福祉部に登録された外国人患者受け入れ事業者です（登録番号 A-2026-01-02-06761）。提携ネットワークは、大学病院4か所（梨花女子大学ソウル病院・梨花女子大学木洞病院・高麗大学九老病院・新村セブランス病院）と、韓方の Immune Hospital4院（江西〈カンソ〉・新村〈シンチョン〉・光明〈クァンミョン〉・城東〈ソンドン〉）。病院の選定、医療通訳、ビザ招へい状、入院中の付き添い、退院後の遠隔フォローまで、6言語で手配します。"
    },
    "faq": {
      "title": "よくあるご質問",
      "items": [
