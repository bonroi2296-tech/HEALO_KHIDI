...
const L = {
  consortium: {
    ...
    name: { ko: '면력한방병원', en: 'Immunehospital of Korean Medicine', ru: 'Клиника Мёнрёк', kz: 'Мёнрёк клиникасы', zh: '免力韩方医院', ja: '免力韓方病院' },
    ...
    desc: { ko: '면력한방병원은 서울 강서구에 본원을 두고 신촌·광명에 분원을 운영하며, 성동점을 준비 중인 한방 면역치료 전문 의료기관입니다. 암 환자의 면역력 강화, 항암 부작용 완화, 체력 회복을 위한 통합 한방 프로그램을 제공합니다.', en: 'Immunehospital is a Korean Medicine institution headquartered in Gangseo-gu, Seoul, with branches in Sinchon and Gwangmyeong, and a Seongdong branch coming soon. We provide integrated Korean Medicine programs for cancer patients including immune enhancement, chemotherapy side-effect relief, and physical recovery.', ru: 'Иммуногоспиталь — учреждение корейской медицины с главным офисом в Кансо-гу, Сеул, филиалами в Синчоне и Кванмёне. Мы предоставляем комплексные программы для онкопациентов.', kz: 'Иммуногоспиталь — Кансо-гудағы бас кеңсесі мен Синчон, Кванмён филиалдары бар корей медицинасы мекемесі.', zh: '免力韩方医院总部位于首尔江西区，在新村和光明设有分院，城东分院即将开业。为癌症患者提供综合韩方项目。', ja: '免力韓方病院はソウル江西区に本院を置き、新村・光明に分院を展開、城東分院は準備中の免疫治療専門韓方医療機関です。' },
  },
  branches: { ko: '지점 네트워크', en: 'Branch Network', ru: 'Сеть филиалов', kz: 'Филиал желісі', zh: '分院网络', ja: '分院ネットワーク' },
  branchesDesc: { ko: '면력한방병원은 서울·경기 4개 지점을 운영하고 있습니다.', en: 'Immunehospital operates 4 branches across Seoul & Gyeonggi.', ru: 'Иммуногоспиталь работает в 4 филиалах.', kz: 'Иммуногоспиталь 4 филиалда жұмыс істейді.', zh: '免力韩方医院在首尔及京畿道运营4家分院。', ja: '免力韓方病院は4拠点で運営しています。' },
  status: {
  ...
  section: {
    career: { ko: '경력', en: 'Career', ru: 'Карьера', zh: '经历', ja: '経歴' },
    education: { ko: '학력', en: 'Education', ru: 'Образование', zh: '学历', ja: '学歴' },
    activities: { ko: '활동', en: 'Activities & Memberships', ru: 'Деятельность', zh: '活动', ja: '活動' },
    publications: { ko: '저서 및 논문', en: 'Publications & Papers', ru: 'Публикации', zh: '著作及论文', ja: '著書・論文' },
  },
...
const DOCTORS = [
  // ── 강서점 (7명) ──
  { id: 2, branch: 'gangseo',
    name: { ko: '황이준', en: 'Hwang Yi-jun', ru: 'Хван Иджун', zh: '黄以准', ja: '黄以準' },
    position: { ko: '강서 대표원장', en: 'Gangseo Chief Director', ru: 'Главный директор (Кансо)', zh: '江西代表院长', ja: '江西代表院長' },
    subspecialty: { ko: '통합면역 대표원장', en: 'Integrative Immuno-Oncology', ru: 'Иммуноонкология', zh: '综合免疫肿瘤学', ja: '統合免疫腫瘍学' },
    role: 'ceo',
  ...
  { id: 3, branch: 'gangseo',
    ...
    position: { ko: '강서 양방대표원장', en: 'Gangseo Western Medicine Chief', ru: 'Гл. врач западной медицины (Кансо)', zh: '江西西医代表院长', ja: '江西洋方代表院長' },
    subspecialty: { ko: '통합면역 부인과', en: 'Gynecologic Oncology', ru: 'Гинекологическая онкология', zh: '妇科肿瘤学', ja: '婦人科腫瘍学' },
    role: 'wm',
  ...
  { id: 34, branch: 'gangseo',
    ...
    position: { ko: '강서 의무원장', en: 'Gangseo CMO', ru: 'Медицинский директор (Кансо)', zh: '江西医务院长', ja: '江西医務院長' },
    subspecialty: { ko: '통증재활 한방재활의학과', en: 'Pain Rehab · KM Rehabilitation', ru: 'Реабилитация · Корейская медицина', zh: '疼痛康复·韩方康复医学科', ja: '疼痛リハビリ・韓方リハ科' },
    role: 'cmo',
  ...
  { id: 6, branch: 'gangseo',
    ...
    position: { ko: '강서 진료원장', en: 'Gangseo Attending Physician', ru: 'Лечащий врач (Кансо)', zh: '江西诊疗院长', ja: '江西診療院長' },
  ...
  { id: 11, branch: 'gangseo',
    ...
    position: { ko: '강서 양방원장', en: 'Gangseo Western Medicine Director', ru: 'Врач западной медицины (Кансо)', zh: '江西西医院长', ja: '江西洋方院長' },
    subspecialty: { ko: '통합면역 가정의학', en: 'Family Medicine', ru: 'Семейная медицина', zh: '家庭医学', ja: '家庭医学' },
    role: 'wm',
  ...
  { id: 25, branch: 'sinchon',
    name: { ko: '유형진', en: 'Yu Hyung-jin', ru: 'Ю Хёнджин', zh: '刘炯镇', ja: '兪炯鎭' },
    position: { ko: '신촌 대표원장', en: 'Sinchon Chief Director', ru: 'Главный директор (Синчон)', zh: '新村代表院长', ja: '新村代表院長' },
    subspecialty: { ko: '통합면역 대표원장', en: 'Integrative Immuno-Oncology', ru: 'Иммуноонкология', zh: '综合免疫肿瘤学', ja: '統合免疫腫瘍学' },
    role: 'ceo',
  ...
  { id: 37, branch: 'sinchon',
    ...
    position: { ko: '신촌 양방대표원장', en: 'Sinchon Western Medicine Chief', ru: 'Гл. врач западной медицины (Синчон)', zh: '新村西医代表院长', ja: '新村洋方代表院長' },
    subspecialty: { ko: '통합면역 부인과', en: 'OB/GYN · Integrative Medicine', ru: 'Гинекология · Интегративная медицина', zh: '妇产科·综合医学', ja: '産婦人科・統合医学' },
    role: 'wm',
  ...
  { id: 24, branch: 'sinchon',
    ...
    position: { ko: '신촌 진료원장', en: 'Sinchon Attending Physician', ru: 'Лечащий врач (Синчон)', zh: '新村诊疗院长', ja: '新村診療院長' },
  ...
  { id: 15, branch: 'gwangmyeong',
    name: { ko: '배길준', en: 'Bae Gil-jun', ru: 'Пэ Кильджун', zh: '裴吉准', ja: '裴吉準' },
    position: { ko: '광명 대표원장', en: 'Gwangmyeong Chief Director', ru: 'Главный директор (Кванмён)', zh: '光明代表院长', ja: '光明代表院長' },
    subspecialty: { ko: '통합면역 한방재활의학과', en: 'KM Rehabilitation · Immuno-Oncology', ru: 'Реабилитация · Иммуноонкология', zh: '韩方康复·免疫肿瘤学', ja: '韓方リハ・免疫腫瘍学' },
    role: 'ceo',
  ...
  { id: 38, branch: 'gwangmyeong',
    ...
    position: { ko: '광명 양방대표원장', en: 'Gwangmyeong Western Medicine Chief', ru: 'Гл. врач западной медицины (Кванмён)', zh: '光明西医代表院长', ja: '光明洋方代表院長' },
    subspecialty: { ko: '통합면역 마취통증의학과', en: 'Anesthesiology & Pain Medicine', ru: 'Анестезиология и лечение боли', zh: '麻醉疼痛医学科', ja: '麻酔疼痛医学科' },
    role: 'wm',
  ...
  { id: 16, branch: 'gwangmyeong',
    ...
    position: { ko: '광명 진료원장', en: 'Gwangmyeong Attending Physician', ru: 'Лечащий врач (Кванмён)', zh: '光明诊疗院长', ja: '光明診療院長' },
...
const BRANCH_CONFIG = [
  ...
  { id: 'seongdong', name: { ko: '성동점', en: 'Seongdong', ru: 'Сондон', kz: 'Сондон', zh: '城东分院', ja: '城東分院' }, addr: { ko: '서울 성동구 (상세주소 확정 예정)', en: 'Seongdong-gu, Seoul (TBD)', ru: 'Сондон-гу (уточняется)', kz: 'Сондон-гу (нақтыланады)', zh: '首尔城东区（待定）', ja: 'ソウル城東区（確定予定）' }, status: 'upcoming', tel: null },
];
