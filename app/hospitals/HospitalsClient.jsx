...
const DOCTORS = [
  ...
  { id: 2, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-hwang-ijun.png',
  ...
  { id: 3, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-lee-useok.jpg',
  ...
  { id: 34, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-im-jisung.jpg',
  ...
  { id: 6, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-kim-jiyoung.jpg',
    keywords: { ko: ['#꼼꼼한','#친절한','#예리한','#이성적인','#정확한'], en: ['#Thorough','#Friendly','#Sharp','#Rational','#Precise'] },
  ...
  { id: 7, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-kim-eunji.jpg',
  ...
  { id: 11, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-bae-sanggeun.jpg',
  ...
  { id: 39, branch: 'gangseo',
    ...
    thumb: '/immune/doctor/gangeo-dr-kim-junghyun.jpg',
  ...
  { id: 41, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-kang-juan.png',
    keywords: { ko: ['#꼼꼼한','#친절한','#예리한','#이성적인','#정확한'], en: ['#Thorough','#Friendly','#Sharp','#Rational','#Precise'] },
    ...
    활동: { ko: ['임상통합의학암학회(CSIO) 이사', 'Swiss Arlesheim Klinik (스위스 알레하임클리닉)', 'Germany BioMed-klinik (독일 비오메드클리닉)', '한국암재활병원 협회 회원', '대한한의학회 회원', '기능영양 한의학회'], en: ['Director, CSIO (Clinical Society of Integrative Oncology)', 'Swiss Arlesheim Klinik', 'Germany BioMed-klinik', 'Korean Cancer Rehabilitation Hospital Association Member', 'Korean Medicine Society Member', 'Functional Nutrition KM Society'] },
  ...
  { id: 42, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-seung-hyeonsuk.jpg',
  ...
  { id: 43, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-im-gyeongsu.jpg',
  ...
  { id: 44, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-lee-munseong.jpg',
  ...
  { id: 45, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-go-eunsang.jpg',
  ...
  { id: 47, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-park-jeonghyang.jpg',
    ...
    활동: { ko: ['대한암한의학회 정회원', '대한한방내과학회 정회원'], en: ['Korean Cancer KM Society Regular Member', 'Korean KM Internal Medicine Society Regular Member'] },
    논문: { ko: ['Genome-wide Analysis Identified SEMA4D, Novel Candidate Gene for Temperature Sensitivity in Patients With Non-Small Cell Lung Cancer (Integrative Cancer Therapies, 2024)', 'Cachexia를 동반한 확장기 소세포폐암 환자의 한의기반 통합암치료 증례보고 (대한한방내과학회지 2025)', '아로마타제 억제제 관련 근골격 증후군에서 부착형 경피신경전기자극 기기의 예비 RCT 프로토콜 (대한암한의학회지 2025)', '소시호탕 투여를 통해 호전된 항문직장암 환자의 수술부위 감염 이후 신경병성 통증 1례 (대한암한의학회지 2023)', '유방암 및 부인암 환자들의 의·한 협진 유효성 및 안전성 분석: 차트 리뷰 (대한암한의학회지 2024)', '췌장암 환자의 IL-6 수치와 암 진행의 상관 관계 3례 (대한한방내과학회지 2024)', 'Short-Term Pain Relief from Electroacupuncture and Electroceutical Stimulation at ST36 and SP9 in Cancer Patients (대한한방내과학회지 2025)'], en: ['Genome-wide Analysis Identified SEMA4D as Candidate Gene for Temperature Sensitivity in NSCLC (Integrative Cancer Therapies, 2024)', 'KM-based integrative cancer care for extensive-stage SCLC with cachexia: case report (J Internal KM, 2025)', 'Preliminary RCT protocol of wearable TENS for aromatase inhibitor-associated musculoskeletal syndrome (J Cancer KM, 2025)', 'Neuropathic pain after surgical site infection in anorectal cancer improved by Sosiho-tang: case report (J Cancer KM, 2023)', 'Efficacy & safety of medical-KM collaboration in breast and gynecologic cancer: chart review (J Cancer KM, 2024)', 'Correlation between IL-6 levels and cancer progression in pancreatic cancer: 3 cases (J Internal KM, 2024)', 'Short-Term Pain Relief from Electroacupuncture and Electroceutical Stimulation at ST36 and SP9 in Cancer Patients (J Internal KM, 2025)'] },
  },
  { id: 48, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-noh-hyeonmin.jpg',
    ...
    활동: { ko: ['동국대학교 한의과대학 총동창회 이사', '대한한의약해외의료봉사단(KOMSTA) 이사', '대한안이비인후피부과학회 정회원', '동의방약학회 정회원', '대한통합레이저의학회 정회원', '더마v라인(실리프팅)마스터 과정 수료'], en: ['Director, Dongguk University KM Alumni Association', 'Director, KOMSTA (Korea KM Overseas Medical Service)', 'Korean Society of KM Ophthalmology/ENT/Dermatology Regular Member', 'Dong-Eui Herbal Medicine Society Regular Member', 'Korean Integrative Laser Medicine Society Regular Member', 'Derma V-line (Thread Lifting) Master Course Completed'] },
  ...
  { id: 51, branch: 'seongdong',
    ...
    thumb: '/immune/doctor/seongdong-dr-lee-jinyeong.jpg',
    ...
    활동: { ko: ['대한한방안이비인후피부과학회 정회원', '대한통합레이저학회 정회원'], en: ['Korean Society of KM Ophthalmology/ENT/Dermatology Regular Member', 'Korean Integrative Laser Society Regular Member'] },
  },
];
