...
const L = {
  consortium: {
    ...
    desc: { ko: '면력한방병원은 서울 강서구에 본원을 두고 신촌·광명에 분원을 운영하며, 성동점을 준비 중인 한방 면역치료 전문 의료기관입니다. 암 환자의 면역력 강화, 항암 부작용 완화, 체력 회복을 위한 통합 한방 프로그램을 제공합니다.', en: 'Immune Hospital is a Korean Medicine institution headquartered in Gangseo-gu, Seoul, with branches in Sinchon and Gwangmyeong, and a Seongdong branch coming soon. We provide integrated Korean Medicine programs for cancer patients including immune enhancement, chemotherapy side-effect relief, and physical recovery.', ru: 'Иммун Госпиталь — учреждение корейской медицины с главным офисом в Кансо-гу, Сеул, филиалами в Синчоне и Кванмёне. Мы предоставляем комплексные программы для онкопациентов.', kz: 'Иммун Госпиталь — Кансо-гудағы бас кеңсесі мен Синчон, Кванмён филиалдары бар корей медицинасы мекемесі.', zh: '免疫医院总部位于首尔江西区，在新村和光明设有分院，城东分院即将开业。为癌症患者提供综合韩方项目。', ja: '免疫病院はソウル江西区に本院を置き、新村・光明に分院を展開、城東分院は準備中の免疫治療専門韓方医療機関です。' },
  },
  branches: { ko: '지점 네트워크', en: 'Branch Network', ru: 'Сеть филиалов', kz: 'Филиал желісі', zh: '分院网络', ja: '分院ネットワーク' },
  branchesDesc: { ko: '면력한방병원은 서울·경기 4개 지점을 운영하고 있습니다.', en: 'Immune Hospital operates 4 branches across Seoul & Gyeonggi.', ru: 'Иммун Госпиталь работает в 4 филиалах.', kz: 'Иммун Госпиталь 4 филиалда жұмыс істейді.', zh: '免疫医院在首尔及京畿道运营4家分院。', ja: '免疫病院は4拠点で運営しています。' },
  status: {
