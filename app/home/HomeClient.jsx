...
const PARTNERS_DATA = [
  ...
  { slug: "immunehospital-seongdong", badge: "partner", name: { ko: "면력한방병원 성동점", en: "Immune Hospital Seongdong", ru: "Иммунная Клиника Сондон", kz: "Иммунная Клиника Сондон", zh: "免疫医院 城东院", ja: "免疫病院 城東院" }, desc: { ko: "서울 성동구 소재 신규 분원", en: "New branch in Seongdong-gu, Seoul", ru: "Новый филиал в Сондон-гу, Сеул", kz: "Сеул Сондон-гудағы жаңа филиал", zh: "首尔城东区新分院", ja: "ソウル城東区の新分院" }, img: "/images/hospitals/immune-seongdong.jpg" },
  // 협진 대학병원 4곳
