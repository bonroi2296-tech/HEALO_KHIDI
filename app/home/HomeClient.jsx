...
const PARTNERS_DATA = [
  ...
  { slug: "immunehospital-magok", badge: "partner", name: { ko: "면력한방병원 강서 (본원)", en: "Immune Hospital Gangseo (HQ)", ru: "Иммунная Клиника Кансо (главный)", kz: "Иммунная Клиника Кансо (бас)", zh: "免疫医院 江西本院", ja: "免疫病院 江西本院" }, desc: { ko: "마곡 소재 한방 면역치료 본원", en: "Korean Medicine Immunotherapy Headquarters in Magok", ru: "Главный офис иммунотерапии в Магоке", kz: "Магоктағы иммунотерапия бас кеңсесі", zh: "麻谷韩方免疫治疗本院", ja: "麻谷の韓方免疫治療本院" }, img: "https://immunehospital.com/uploads/banners/6895825b600130.26433858.jpg" },
  ...
  { slug: "immunehospital-seongdong", badge: "partner", name: { ko: "면력한방병원 성동점", en: "Immune Hospital Seongdong", ru: "Иммунная Клиника Сондон", kz: "Иммунная Клиника Сондон", zh: "免疫医院 城东院", ja: "免疫病院 城東院" }, desc: { ko: "서울 성동구 소재 신규 분원", en: "New branch in Seongdong-gu, Seoul", ru: "Новый филиал в Сондон-гу, Сеул", kz: "Сеул Сондон-гудағы жаңа филиал", zh: "首尔城东区新分院", ja: "ソウル城東区の新分院" }, img: "https://immunehospital.com/uploads/banners/6895edb5901f81.40373525.jpg" },
  // 협진 대학병원 4곳
