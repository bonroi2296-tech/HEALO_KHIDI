...
const DOCTORS_DATA = [
  { name: { ko: "황이준 대표원장", en: "Dr. Hwang Yi-jun", ru: "Д-р Хван Иджун", kz: "Д-р Хван Иджун", zh: "黄以准 代表院长", ja: "黄以準 代表院長" }, title: { ko: "면력한방병원 강서 대표원장", en: "Chief Director, Immune Hospital Gangseo", ru: "Главный директор, Иммун Госпиталь Кансо", kz: "Бас директор, Иммун Госпиталь Кансо", zh: "免疫医院 江西 代表院长", ja: "免疫病院 江西 代表院長" }, specialty: { ko: "한방 면역 종양학 · 통합 암 케어", en: "Korean Medicine Immuno-Oncology", ru: "Иммуноонкология корейской медицины", kz: "Корей медицинасы иммуноонкологиясы", zh: "韩方免疫肿瘤学", ja: "韓方免疫腫瘍学" }, exp: "", img: "https://immunehospital.com/uploads/doctors/68a674036de695.54364290.png" },
  { name: { ko: "유형진 대표원장", en: "Dr. Yu Hyung-jin", ru: "Д-р Ю Хёнджин", kz: "Д-р Ю Хёнджин", zh: "柳炯进 代表院长", ja: "柳炯進 代表院長" }, title: { ko: "면력한방병원 신촌 대표원장", en: "Chief Director, Immune Hospital Sinchon", ru: "Главный директор, Иммун Госпиталь Синчхон", kz: "Бас директор, Иммун Госпиталь Синчхон", zh: "免疫医院 新村 代表院长", ja: "免疫病院 新村 代表院長" }, specialty: { ko: "한방 면역 치료 · 암 통합 케어", en: "Korean Medicine Immunotherapy · Cancer Care", ru: "Иммунотерапия · Онкологическая помощь", kz: "Иммунотерапия · Онкологиялық көмек", zh: "韩方免疫治疗 · 癌症综合护理", ja: "韓方免疫治療 · がん統合ケア" }, exp: "", img: "https://immunehospital.com/uploads/doctors/68ac46bd439598.83386960.png" },
...
const PARTNERS_DATA = [
  ...
  { slug: "immunehospital-magok", badge: "partner", name: { ko: "면력한방병원 강서 (본원)", en: "Immune Hospital Gangseo (HQ)", ru: "Иммун Госпиталь Кансо (главный)", kz: "Иммун Госпиталь Кансо (бас)", zh: "免疫医院 江西本院", ja: "免疫病院 江西本院" }, desc: { ko: "마곡 소재 한방 면역치료 본원", en: "Korean Medicine Immunotherapy Headquarters in Magok", ru: "Главный офис иммунотерапии в Магоке", kz: "Магоктағы иммунотерапия бас кеңсесі", zh: "麻谷韩方免疫治疗本院", ja: "麻谷の韓方免疫治療本院" }, img: "https://immunehospital.com/uploads/banners/6895825b600130.26433858.jpg" },
  { slug: "immunehospital-sinchon", badge: "partner", name: { ko: "신촌면력한방병원", en: "Immune Hospital Sinchon", ru: "Иммун Госпиталь Синчхон", kz: "Иммун Госпиталь Синчон", zh: "新村免疫医院", ja: "新村免疫病院" }, desc: { ko: "연세로 소재 신촌 분원", en: "Sinchon branch on Yonsei-ro", ru: "Филиал Синчхон на Ёнсе-ро", kz: "Ёнсе-родағы Синчон филиалы", zh: "位于延世路的新村分院", ja: "延世路の新村分院" }, img: "https://immunehospital.com/uploads/banners/6895825b600130.26433858.jpg" },
  { slug: "immunehospital-gwangmyeong", badge: "partner", name: { ko: "면력한방병원 광명점", en: "Immune Hospital Gwangmyeong", ru: "Иммун Госпиталь Кванмён", kz: "Иммун Госпиталь Кванмён", zh: "免疫医院 光明院", ja: "免疫病院 光明院" }, desc: { ko: "광명역 소재 광명 분원", en: "Gwangmyeong branch near Gwangmyeong Station", ru: "Филиал Кванмён у станции Кванмён", kz: "Кванмён стансасындағы филиал", zh: "光明站附近光明分院", ja: "光明駅の光明分院" }, img: "https://immunehospital.com/uploads/banners/68ad73ce876dc6.84077341.jpg" },
  // 협진 대학병원 4곳
