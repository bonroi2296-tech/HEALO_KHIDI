  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', 'Pretendard', -apple-system, BlinkMacSystemFont, sans-serif", lineHeight: "1.65" }}>
      ...
      {/* ══════════════════════════════════════════
          FOOTER — 연락처 + 법인 정보
          ══════════════════════════════════════════ */}
      <footer style={{ background: "#0f172a", color: "rgba(255,255,255,0.65)", padding: "64px 24px 40px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 48 }}>
            {/* 브랜드 */}
            <div>
              <div style={{ fontWeight: 800, fontSize: "1.375rem", color: "#fff", letterSpacing: "0.04em", marginBottom: 12 }}>HEALO</div>
              <p style={{ fontSize: "0.8125rem", lineHeight: 1.7, color: "rgba(255,255,255,0.45)", maxWidth: 260 }}>
                {l({ ko: "CIS·중앙아시아 암환자를 위한 한국 의료관광 컨시어지", en: "Medical concierge for CIS/Central Asia patients seeking treatment in Korea.", ru: "Медицинский консьерж для пациентов из СНГ", kz: "Орталық Азия пациенттеріне арналған медициналық консьерж" })}
              </p>
            </div>

            {/* 연락처 */}
            <div>
              <div style={{ fontSize: "0.6875rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2dd4bf", marginBottom: 16 }}>
                {l({ ko: "연락처", en: "Contact", ru: "Контакты", kz: "Байланыс" })}
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: "0.875rem" }}>
                <a href="tel:07075007795" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                  <Phone size={13} style={{ color: "#2dd4bf", flexShrink: 0 }} strokeWidth={2} />
                  070-7500-7795 {l({ ko: "(대표)", en: "(main)", ru: "(основной)", kz: "(негізгі)" })}
                </a>
                <a href="tel:+821047721075" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                  <Phone size={13} style={{ color: "#2dd4bf", flexShrink: 0 }} strokeWidth={2} />
                  +82 10 4772 1075 {l({ ko: "(국제)", en: "(intl)", ru: "(межд.)", kz: "(халықаралық)" })}
                </a>
                <a href="mailto:healo.consult@gmail.com" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                  <Mail size={13} style={{ color: "#2dd4bf", flexShrink: 0 }} strokeWidth={2} />
                  healo.consult@gmail.com
                </a>
                <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.75rem", paddingLeft: 21 }}>
                  {l({ ko: "평일 09:00-18:00 KST", en: "Mon–Fri 09:00–18:00 KST", ru: "Пн–Пт 09:00–18:00 KST", kz: "Дс–Жм 09:00–18:00 KST" })}
                </span>
              </div>
            </div>
            ...
            <div>
              <div style={{ fontSize: "0.6875rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2dd4bf", marginBottom: 16 }}>
                {l({ ko: "서비스", en: "Services", ru: "Услуги", kz: "Қызметтер" })}
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: "0.875rem" }}>
                {[
                  { href: "/intake", label: l({ ko: "상담 신청", en: "Request Consultation", ru: "Запросить консультацию", kz: "Кеңес сұрау" }) },
                  { href: "/hospitals", label: l({ ko: "파트너 병원", en: "Hospitals", ru: "Больницы", kz: "Ауруханалар" }) },
                  { href: "/treatments", label: l({ ko: "치료 프로그램", en: "Treatments", ru: "Лечение", kz: "Емдеу" }) },
                  { href: "/inquiry", label: l({ ko: "문의하기", en: "General Inquiry", ru: "Общий запрос", kz: "Жалпы сұрақ" }) },
                ].map((item) => (
                  <a key={item.href} href={item.href} style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none" }}>
                    {item.label}
                  </a>
                ))}
              </div>
            ...
            <div>
              <div style={{ fontSize: "0.6875rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2dd4bf", marginBottom: 16 }}>
                {l({ ko: "법인 정보", en: "Legal", ru: "Юридическое", kz: "Заңдық" })}
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 6, fontSize: "0.75rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>
                <span>{l({ ko: "상호: 본로이 (BONROI) · 개인사업자", en: "Trade name: BONROI · Sole proprietorship", ru: "Торговое название: BONROI", kz: "Сауда атауы: BONROI" })}</span>
                <span>{l({ ko: "대표자: 강주영", en: "Representative: JUYOUNG KANG", ru: "Представитель: JUYOUNG KANG", kz: "Өкіл: JUYOUNG KANG" })}</span>
                <span>{l({ ko: "사업자등록번호: 463-35-00902", en: "Biz Reg. 463-35-00902", ru: "Рег. 463-35-00902", kz: "Рег. 463-35-00902" })}</span>
                <span style={{ color: "#2dd4bf" }}>A-2026-01-02-06761 (Seoul)</span>
                <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
                  <a href="/privacy" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.75rem" }}>Privacy</a>
                  <span style={{ color: "rgba(255,255,255,0.2)" }}>·</span>
                  <a href="/terms" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.75rem" }}>Terms</a>
                  <span style={{ color: "rgba(255,255,255,0.2)" }}>·</span>
                  <a href="/contact" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.75rem" }}>Contact</a>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* 하단 바 */}
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 12, fontSize: "0.6875rem", color: "rgba(255,255,255,0.3)" }}>
            <span>© 2026 BONROI · HEALO Platform</span>
            <span>{l({ ko: "서울특별시 강서구 강서로 385, 613호 (마곡동, 우성에스비타워)", en: "Room 613, 385 Gangseo-ro, Gangseo-gu, Seoul", ru: "Сеул, Кансо-гу, 385 Кансо-ро, 613", kz: "Сеул, Кансо-гу, 385 Кансо-ро, 613" })}</span>
          </div>
        </div>
      </footer>
    </div>
