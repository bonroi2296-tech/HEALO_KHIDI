...
const FAQ_DATA = {
  female: [
    ...
    { q: { ko: "통역 서비스가 제공되나요?", ru: "Есть ли услуги переводчика?" }, a: { ko: "healwith 코디네이터가 러시아어·카자흐어 통역을 지원합니다. 진료 동행도 가능합니다.", ru: "Координатор healwith обеспечивает перевод на русский и казахский языки, включая сопровождение на приём." } },
  ...
  digest: [
    ...
    { q: { ko: "통역 및 코디네이터 서비스가 있나요?", ru: "Есть ли переводчик и координатор?" }, a: { ko: "healwith 전담 코디네이터가 러시아어·카자흐어로 지원하며 병원 동행, 문서 번역, 일정 조율 모두 포함됩니다.", ru: "Координатор healwith сопровождает на всех визитах, переводит документы и организует расписание." } },
  ],
  liver: [
    ...
    { q: { ko: "러시아에서 진단서를 번역해도 되나요?", ru: "Можно ли перевести документы из России?" }, a: { ko: "네, 러시아어 진단서·검사 결과를 healwith가 번역·검토하여 한국 의료진에게 전달합니다.", ru: "Да, healwith переводит и передаёт российские медицинские документы и результаты анализов корейским врачам." } },
