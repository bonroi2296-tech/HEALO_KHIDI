...
export const TREATMENTS_L = {
  ...
  easternTitle: { ko: '한방 통합 케어 (면력한방병원)', en: 'Korean Medicine Care (Immune Hospital)', ru: 'Корейская медицина (Иммун Госпиталь)', kz: 'Корей медицинасы (Иммун Госпиталь)', zh: '韩方综合护理（免疫医院）', ja: '韓方統合ケア（免疫病院）' },
