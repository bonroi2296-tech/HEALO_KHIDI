 ...
 * 법적 근거: 의료해외진출법 제8조제2항제2호(유치의료기관의 진료계약서·예상 진료비 안내 의무).
 *   ⚠️ 제15조가 아니다 — §15 는 "의료광고에 관한 특례"다(2026-08-04 법령 원문 대조).
 *   ⚠️ 의무 주체는 유치의료기관(병원)이며, healwith 는 유치사업자로서 전달·확인을 돕는 위치다.
 */
    ...
    return Response.json({
      ...
      data: {
        ...
        total_if_full_course: includePhases
          ...
          : null,
        disclaimer:
          "본 금액은 KHIDI 공식 통계 및 과거 병원 견적 기반 '예상 범위' 입니다. 실제 비용은 진료 후 의료기관 청구서에 따릅니다. 의료해외진출법 제8조제2항에 따라 유치의료기관은 진료계약 전 진료계약서와 예상 진료비를 안내해야 합니다 — 정식 견적서를 수령해 확인하시기 바랍니다.",
        tier: 1,
      },
    });
  } catch (error: any) {
    ...
    return Response.json({
      ...
      data: {
        ...
        tier2_refined_krw: suggestedBand
          ...
          : null,
        disclaimer:
          "본 금액은 통계 기반 예상 범위이며 AI 보정은 참고용입니다. 정식 견적서는 진료 전 병원·healwith 를 통해 수령하셔야 합니다 (의료해외진출법 제8조제2항).",
