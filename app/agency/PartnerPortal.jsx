...
const TR_PROGRESS = {
  en: {
    ...
    progressNotePh: "Findings / note (optional)", progressFile: "Choose file (PDF / image / DICOM, max 2GB)",
  ...
  ko: {
    ...
    progressNotePh: "소견 / 메모 (선택)", progressFile: "파일 선택 (PDF / 이미지 / DICOM, 최대 2GB)",
  ...
  ru: {
    ...
    progressNotePh: "Заключение / заметка (необязательно)", progressFile: "Выбрать файл (PDF / изображение / DICOM, до 2ГБ)",
  ...
  kz: {
    ...
    progressNotePh: "Қорытынды / жазба (міндетті емес)", progressFile: "Файл таңдау (PDF / сурет / DICOM, 2ГБ дейін)",
  ...
  zh: {
    ...
    progressNotePh: "意见 / 备注（选填）", progressFile: "选择文件（PDF / 图片 / DICOM，最大 2GB）",
  ...
  ja: {
    ...
    progressNotePh: "所見 / メモ（任意）", progressFile: "ファイルを選択（PDF / 画像 / DICOM、最大2GB）",
...
const TR_FORM2 = {
  ko: {
    ...
    docsHint: "환자 차트·진단서·검사결과 등 — PDF·이미지·Word, 각 2GB",
  ...
  en: {
    ...
    docsHint: "Patient chart, diagnosis, test results — PDF / image / Word, 2GB each",
  ...
  ru: {
    ...
    docsHint: "Карта пациента, диагноз, результаты анализов — PDF / изображение / Word, до 2ГБ каждый",
  ...
  kz: {
    ...
    docsHint: "Науқас картасы, диагноз, талдау нәтижелері — PDF / сурет / Word, әрқайсысы 2ГБ",
  ...
  zh: {
    ...
    docsHint: "患者病历、诊断书、检查结果 — PDF / 图片 / Word，每个 2GB",
  ...
  ja: {
    ...
    docsHint: "患者カルテ・診断書・検査結果など — PDF / 画像 / Word、各2GB",
