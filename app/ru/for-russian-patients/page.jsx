...
export const metadata = {
  ...
  description:
    "Лечение онкологии в Южной Корее: иммунотерапия, корейская медицина, онкология. Клиника Immune Hospital — 51 823 случая лечения. Полный консьерж-сервис от healwith. Бесплатная консультация.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Онкологическое лечение в Южной Корее. Immune Hospital: 51 823 случаев, протокол ITCR, иммунотерапия корейской медицины. Поддержка на русском языке.",
    type: "website",
    locale: "ru_RU",
  },
};
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2 text-gray-700 mb-6">
            <li>✓ 51 823 случая лечения онкологических пациентов</li>
