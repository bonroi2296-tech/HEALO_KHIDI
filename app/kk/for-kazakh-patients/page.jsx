...
export const metadata = {
  title: "Кореядағы онкологиялық емдеу | Медициналық туризм — HEALO",
  description:
    "Оңтүстік Кореядағы онкологиялық емдеу: иммунотерапия, корей медицинасы. Immune Hospital — 50 000+ науқас. HEALO толық консьерж қызметі. Тегін кеңес.",
  keywords: [
  ...
  openGraph: {
    title: "Кореядағы рак емдеу | HEALO медициналық консьерж",
    description:
...
const jsonLd = {
  ...
  "@type": "MedicalWebPage",
  name: "Кореядағы онкологиялық емдеу — HEALO",
  description:
...
const FAQ = [
  {
    ...
    a: "Иә. HEALO барлық кезеңдерде — алғашқы кеңестен шығарылымға дейін қазақ және орыс тіліндегі аударманы қамтамасыз етеді.",
  },
  {
  ...
  },
  {
    ...
    a: "Медициналық C-3-3 визасы 5–7 жұмыс күнінде ресімделеді. HEALO барлық құжаттарды дайындауға көмектеседі.",
  },
  {
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
        ...
        <section className="mb-12">
          ...
          <ol className="space-y-4">
            {[
              { step: "1", title: "Онлайн кеңес", desc: "Нысанды толтырып, медициналық құжаттарды жүктеңіз. HEALO ауру тарихын тегін талдайды." },
              ...
              { step: "3", title: "Виза мен логистика", desc: "HEALO C-3-3 медициналық визасын рәсімдеуге, клиника жанындағы тұрғын үйді брондауға және трансферді ұйымдастыруға көмектеседі." },
              { step: "4", title: "Кореядағы емдеу", desc: "Жеке менеджер барлық визиттерде ілеседі. Қазақ/орыс тіліндегі аудармашы 24/7 қолжетімді." },
              { step: "5", title: "Кетуден кейінгі қолдау", desc: "Дәрігермен телемедициналық кеңестер, HEALO қосымшасы арқылы онлайн мониторинг." },
            ].map(({ step, title, desc }) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border rounded-xl p-6">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                ...
                <li>• HEALO құжаттар пакетін дайындайды</li>
              </ul>
            ...
            <div className="border rounded-xl p-6">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                ...
                <li>• HEALO ұшуды брондауға кеңес береді</li>
              </ul>
            </div>
          </div>
        </section>
