...
export const metadata = {
  ...
  description:
    "Оңтүстік Кореядағы онкологиялық емдеу: иммунотерапия, корей медицинасы. Immune Hospital — 51 823 науқас. healwith толық консьерж қызметі. Тегін кеңес.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Оңтүстік Кореядағы онкологиялық емдеу. Immune Hospital: 51 823 науқас, ITCR хаттамасы. Қазақ тілінде қолдау.",
    type: "website",
    locale: "kk_KZ",
  },
};
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2 text-gray-700 mb-6">
            <li>✓ 51 823 онкологиялық науқасты емдеу жағдайлары</li>
