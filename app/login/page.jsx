...
// 로그인 — 이 판에서 **가장 많이 보게 되는 화면**이다. /patient/* 는 전부 로그인 벽 뒤라
// 코디가 보낸 링크를 누른 환자는 여기로 튕겨 온다(실측: /patient/visa → 307 → /login).
// 2026-08-31 전까지 본문은 러시아어인데 탭 제목만 "Sign in" 이었다.
...
export async function generateMetadata() {
  return localizedMeta(baseMeta, "seo.login.title", "seo.login.desc");
}
