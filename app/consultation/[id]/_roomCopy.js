...
export const COPY = {
  ko: {
    ...
    connectFailed: "연결에 실패했어요. 인터넷 상태를 확인하고 다시 시도해 주세요.",
    retryConnect: "다시 연결",
  ...
  ru: {
    ...
    connectFailed: "Не удалось подключиться. Проверьте интернет и повторите попытку.",
  ...
  kz: {
    ...
    connectFailed: "Қосылу мүмкін болмады. Интернетті тексеріп, қайталап көріңіз.",
  ...
  ja: {
    ...
    connectFailed: "接続できませんでした。通信環境を確認して再度お試しください。",
    retryConnect: "再接続",
