...
export const COPY = {
  ko: {
    ...
    langSwap: "언어 방향 바꾸기",
    listenModeLabel: "듣기 통역 (상대방 음성 자막)",
    listenModeHint: "상대방이 통역을 켜지 않아도, 들리는 음성을 이쪽에서 인식해 내 언어 자막으로 보여줍니다. 마이크·스피커를 꺼도 동작해요.",
    listenModeOn: "켜짐",
    listenModeOff: "꺼짐",
  ...
  en: {
    ...
    listenModeLabel: "Listen mode (subtitles for others' speech)",
    listenModeHint: "Transcribes and translates what other participants say into your language, even if they don't turn on interpretation. Works with your mic and speaker off.",
    listenModeOn: "On",
    listenModeOff: "Off",
  ...
  ru: {
    ...
    listenModeLabel: "Режим прослушивания (субтитры речи собеседников)",
    listenModeHint: "Распознаёт и переводит речь других участников на ваш язык, даже если они не включили перевод. Работает при выключенных микрофоне и динамике.",
    listenModeOn: "Вкл.",
    listenModeOff: "Выкл.",
  ...
  kz: {
    ...
    listenModeLabel: "Тыңдау режимі (әңгімелесушілер сөзінің субтитрі)",
    listenModeHint: "Басқа қатысушылардың сөзін олар аударманы қоспаса да, осы жақта танып, сіздің тіліңізге аударып көрсетеді. Микрофон мен динамик өшірулі болса да жұмыс істейді.",
    listenModeOn: "Қосулы",
    listenModeOff: "Өшірулі",
  ...
  zh: {
    ...
    langSwap: "交换方向",
    listenModeLabel: "收听模式（对方语音字幕）",
    listenModeHint: "即使对方没有开启翻译，也会在本端识别对方语音并翻译成您的语言显示字幕。麦克风和扬声器关闭时也可使用。",
    listenModeOn: "开",
    listenModeOff: "关",
  ...
  ja: {
    ...
    langSwap: "方向を入れ替え",
    listenModeLabel: "リスニングモード（相手の音声字幕）",
    listenModeHint: "相手が通訳をオンにしていなくても、聞こえてくる音声をこちら側で認識し、自分の言語の字幕で表示します。マイク・スピーカーがオフでも動作します。",
    listenModeOn: "オン",
    listenModeOff: "オフ",
