...
export const COPY = {
  ko: {
    ...
    retryLabel: "다시 시도",
    enableMediaBtn: "🎤 탭해서 마이크·카메라 켜기",
    enableMediaHint: "권한을 물으면 '허용'을 눌러주세요",
    noMediaNotice: "이 기기엔 카메라·마이크가 없어요. 듣기·보기로만 참여합니다.",
    joinListenOnly: "듣기만 참여하기",
  ...
  en: {
    ...
    enableMediaBtn: "🎤 Tap to turn on mic & camera",
    enableMediaHint: "If asked, tap 'Allow'",
    noMediaNotice: "No camera or mic on this device. You'll join in listen-only mode.",
    joinListenOnly: "Join (listen-only)",
  ...
  ru: {
    ...
    enableMediaBtn: "🎤 Нажмите, чтобы включить микрофон и камеру",
    enableMediaHint: "Если спросит — нажмите «Разрешить»",
    noMediaNotice: "На этом устройстве нет камеры и микрофона. Вы присоединитесь только для просмотра.",
    joinListenOnly: "Войти (только просмотр)",
  ...
  kz: {
    ...
    retryLabel: "Қайталау",
    enableMediaBtn: "🎤 Микрофон мен камераны қосу үшін түртіңіз",
    enableMediaHint: "Сұраса — «Рұқсат ету» түртіңіз",
    noMediaNotice: "Бұл құрылғыда камера мен микрофон жоқ. Тек көру режимінде қосыласыз.",
    joinListenOnly: "Кіру (тек көру)",
  ...
  zh: {
    ...
    retryLabel: "重试",
    enableMediaBtn: "🎤 点按开启麦克风和摄像头",
    enableMediaHint: "如果提示，请点按“允许”",
    noMediaNotice: "此设备没有摄像头或麦克风。您将以仅收听模式加入。",
    joinListenOnly: "仅收听加入",
  ...
  ja: {
    ...
    retryLabel: "再試行",
    enableMediaBtn: "🎤 タップしてマイクとカメラをオン",
    enableMediaHint: "許可を求められたら「許可」を押してください",
    noMediaNotice: "この端末にはカメラ・マイクがありません。視聴のみで参加します。",
    joinListenOnly: "視聴のみで参加",
