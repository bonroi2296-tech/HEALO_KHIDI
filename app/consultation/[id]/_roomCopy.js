...
export const COPY = {
  ko: {
    ...
    captionsLabel: "자막",
    voiceLabel: "통역",
    voiceComingSoon: "음성 통역은 준비 중이에요",
    captionsOn: "자막 켜기",
    captionsOff: "자막 끄기",
    ctrlMic: "마이크",
    ctrlCam: "카메라",
  ...
  en: {
    ...
    voiceLabel: "Voice",
    voiceComingSoon: "Voice interpretation is coming soon",
  ...
  ru: {
    ...
    voiceLabel: "Озвучка",
    voiceComingSoon: "Голосовой перевод скоро появится",
  ...
  kz: {
    ...
    voiceLabel: "Дауыс",
    voiceComingSoon: "Дауыстық аударма жақында қосылады",
