...
export const COPY = {
  ko: {
    ...
    preflightOk: "✅ 영상 연결 준비 완료 — 이 네트워크에서 통화할 수 있어요.",
  ...
  en: {
    ...
    preflightOk: "✅ Ready for video — this network supports the call.",
  ...
  ru: {
    ...
    preflightOk: "✅ Видеосвязь готова — эта сеть поддерживает звонок.",
  ...
  kz: {
    ...
    preflightOk: "✅ Бейне дайын — бұл желі қоңырауды қолдайды.",
  ...
  ja: {
    ...
    preflightOk: "✅ ビデオ準備完了 — このネットワークで通話できます。",
