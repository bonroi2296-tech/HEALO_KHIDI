...
export const COPY = {
  ko: {
    ...
    openExternalGuide: "버튼이 안 먹으면: 링크가 복사돼 있어요. 크롬 등 브라우저를 직접 열고 주소창에 붙여넣어 입장하세요.",
    copyLinkBtn: "링크 다시 복사",
    attachFile: "자료 첨부",
    sharedFiles: "공유 자료",
  ...
  en: {
    ...
    openExternalGuide: "If nothing happens: the link is already copied. Open Chrome (or any browser) and paste it into the address bar to join.",
    copyLinkBtn: "Copy link again",
  ...
  ru: {
    ...
    openExternalGuide: "Если ничего не произошло: ссылка уже скопирована. Откройте Chrome (или другой браузер) и вставьте её в адресную строку.",
    copyLinkBtn: "Скопировать ещё раз",
  ...
  kz: {
    ...
    openExternalGuide: "Ештеңе болмаса: сілтеме көшірілген. Chrome (немесе басқа браузерді) ашып, мекенжай жолағына қойып кіріңіз.",
    copyLinkBtn: "Қайта көшіру",
  ...
  zh: {
    ...
    openExternalGuide: "如果没有反应：链接已复制。请直接打开 Chrome 等浏览器，粘贴到地址栏进入。",
    copyLinkBtn: "再次复制链接",
    attachFile: "附加文件",
    sharedFiles: "共享资料",
    newSharedDoc: "收到新文件",
  ...
  ja: {
    ...
    openExternalGuide: "反応がない場合：リンクはコピー済みです。Chrome などのブラウザを直接開き、アドレスバーに貼り付けて入室してください。",
    copyLinkBtn: "リンクを再コピー",
    attachFile: "ファイル添付",
    sharedFiles: "共有資料",
