...
const T = {
  ...
  consentThirdParty: {
    ko: "[필수] 한국 협력 의료기관·의뢰 에이전시에 정보 제공", en: "[Required] Provision of data to Korean partner hospitals and the referring agency", ru: "[Обязательно] Передача данных корейским больницам-партнёрам и направившему агентству", kz: "[Міндетті] Деректерді Корея серіктес ауруханаларына және жолдаған агенттікке беру", zh: "[必填] 向韩国合作医院及转介机构提供信息", ja: "[必須] 韓国の提携医療機関・紹介エージェンシーへの情報提供",
  },
  consentCrossBorder: {
    ko: "[필수] 개인정보 국외 이전 (대한민국 ↔ 환자 소재국 에이전시)", en: "[Required] Cross-border transfer of data (to Korea ↔ referring agency in your country)", ru: "[Обязательно] Трансграничная передача данных (в Корею ↔ агентству в стране проживания)", kz: "[Міндетті] Деректерді шекарадан тыс беру (Кореяға ↔ тұрғылықты еліңіздегі агенттікке)", zh: "[必填] 个人信息跨境转移（至韩国 ↔ 所在国转介机构）", ja: "[必須] 個人情報の国外移転（韓国 ↔ 居住国の紹介エージェンシー）",
  },
  consentMarketing: {
