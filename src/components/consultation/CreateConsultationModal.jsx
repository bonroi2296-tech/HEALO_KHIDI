...
const TR = {
  ko: {
    ...
    linkBoxDescPrefix: "상담을 만들면 ", linkBoxDescBold: "참여 링크 1개", linkBoxDescSuffix: "가 생성됩니다. 환자·의사·통역 등 모든 참여자에게 이 링크 하나만 공유하세요. 각자 이름을 입력하고 입장합니다 (만료 72시간).",
  ...
  en: {
    ...
    linkBoxDescPrefix: "Creating the consultation generates ", linkBoxDescBold: "one join link", linkBoxDescSuffix: ". Share this single link with all participants — patient, doctor, interpreter, etc. Each enters their name to join (expires in 72 hours).",
  ...
  ru: {
    ...
    linkBoxDescPrefix: "При создании консультации формируется ", linkBoxDescBold: "одна ссылка для входа", linkBoxDescSuffix: ". Отправьте эту единственную ссылку всем участникам — пациенту, врачу, переводчику и т.д. Каждый вводит своё имя при входе (истекает через 72 часа).",
  ...
  kz: {
    ...
    linkBoxDescPrefix: "Кеңесті жасағанда ", linkBoxDescBold: "бір кіру сілтемесі", linkBoxDescSuffix: " жасалады. Осы жалғыз сілтемені барлық қатысушыларға — науқас, дәрігер, аудармашы т.б. — жіберіңіз. Әрқайсысы өз атын енгізіп кіреді (72 сағаттан кейін жарамсыз болады).",
  ...
  zh: {
    ...
    linkBoxDescPrefix: "创建会诊后将生成", linkBoxDescBold: "一个加入链接", linkBoxDescSuffix: "。请将这唯一的链接分享给所有参与者 — 患者、医生、翻译等。各自输入姓名后即可进入（72小时后过期）。",
  ...
  ja: {
    ...
    linkBoxDescPrefix: "相談を作成すると", linkBoxDescBold: "参加リンク1つ", linkBoxDescSuffix: "が生成されます。患者・医師・通訳など全参加者にこの1つのリンクだけを共有してください。各自名前を入力して入室します（72時間で失効）。",
