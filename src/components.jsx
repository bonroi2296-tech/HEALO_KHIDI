...
export const FloatingInquiryBtn = ({ onClick }) => {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-50 flex flex-col items-end gap-2 group cursor-pointer pb-safe-area" onClick={onClick}>
      ...
      <button aria-label={t("floatingHelp", langCode)} className="w-14 h-14 min-w-[56px] min-h-[56px] bg-teal-600 hover:bg-teal-700 text-white rounded-full shadow-2xl flex items-center justify-center transition-transform transform hover:scale-110 active:scale-95 relative touch-target">
