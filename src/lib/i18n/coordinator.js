...
const CT = {
  ...
  ibStaffUploadHint: { ko: "메일·왓츠앱 등으로 따로 받은 자료를 여기에 올리면 문의에 함께 보관됩니다. PDF·이미지·Word, 각 50MB.", en: "Files received by email or WhatsApp can be attached here. PDF / image / Word, 50MB each.", ru: "Файлы, полученные по почте или WhatsApp, можно прикрепить здесь. PDF / изображение / Word, до 50 МБ.", kz: "Поштамен немесе WhatsApp арқылы алынған файлдарды осында тіркеңіз. PDF / сурет / Word, әрқайсысы 50МБ.", zh: "可在此上传通过邮件或 WhatsApp 收到的资料。PDF / 图片 / Word，每个 50MB。", ja: "メールや WhatsApp で受け取った資料をここに添付できます。PDF・画像・Word、各50MB。" },
  ...
  ibStaffUploadTooLarge: { ko: "파일은 각 50MB 이하여야 합니다.", en: "Each file must be under 50MB.", ru: "Каждый файл — до 50 МБ.", kz: "Әр файл 50МБ-тан аз болуы керек.", zh: "每个文件需小于50MB。", ja: "各ファイルは50MB未満にしてください。" },
  ...
  soAuthorPhOpt: { ko: "소견 주신 분 (예: ○○대병원 종양내과 김○○) — 필요 시 메모", en: "Who gave the opinion (e.g. Dr. Kim, Oncology, ○○ University Hospital) — optional note", ru: "Кто дал заключение (напр.: д-р Ким, онкология, больница ○○) — при необходимости", kz: "Қорытынды берген адам (мыс.: д-р Ким, онкология, ○○ ауруханасы) — қажет болса", zh: "提供意见的人（例：○○大学医院肿瘤内科 金医生）— 可选备注", ja: "所見をくださった方（例: ○○大学病院 腫瘍内科 金先生）— 必要ならメモ" },
  ...
  soPublish: { ko: "에이전시에 공개", en: "Share with the agency", ru: "Открыть агентству", kz: "Агенттікке ашу", zh: "向代理机构公开", ja: "エージェンシーに公開" },
  ...
  soPublished: { ko: "에이전시 공개됨", en: "Shared with the agency", ru: "Открыто агентству", kz: "Агенттікке ашылған", zh: "已向代理机构公开", ja: "エージェンシーに公開済み" },
  ...
  soOriginalInternal: { ko: "원장님 원문 (내부용, 에이전시에 안 보임)", en: "Doctor's original text (internal — not visible to the agency)", ru: "Оригинал от врача (внутренний — агентству не виден)", kz: "Дәрігердің түпнұсқасы (ішкі — агенттікке көрінбейді)", zh: "医生原文（内部用，代理机构不可见）", ja: "先生の原文（内部用・エージェンシーには見えません）" },
  soOriginalDraft: { ko: "원장님 원문 — AI 번역 초안(내부용, 에이전시에 안 보임)", en: "Doctor's original — AI draft translation (internal, not visible to the agency)", ru: "Оригинал врача — черновой перевод ИИ (внутренний, агентству не виден)", kz: "Дәрігер түпнұсқасы — AI аударма жобасы (ішкі, агенттікке көрінбейді)", zh: "医生原文 — AI 翻译草稿（内部用，代理机构不可见）", ja: "先生の原文 — AI翻訳の下書き（内部用・エージェンシーには見えません）" },
  ...
  atErrFormat: { ko: "이 형식(doc·docx 등)은 자동 번역이 안 돼요. 원본을 직접 확인해 주세요.", en: "This format (doc, docx…) cannot be translated automatically. Please open the original.", ru: "Этот формат (doc, docx…) не переводится автоматически. Откройте оригинал.", kz: "Бұл пішім (doc, docx…) автоматты аударылмайды. Түпнұсқаны ашып қараңыз.", zh: "该格式（doc·docx 等）无法自动翻译，请直接查看原件。", ja: "この形式（doc・docxなど）は自動翻訳できません。原本をご確認ください。" },
