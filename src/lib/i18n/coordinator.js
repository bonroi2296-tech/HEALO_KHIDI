...
const CT = {
  ...
  soPublish: { ko: "환자·에이전시에 공개", en: "Share with patient & agency", ru: "Открыть пациенту и агентству", kz: "Науқас пен агенттікке ашу", zh: "向患者与代理机构公开", ja: "患者・エージェンシーに公開" },
  // 누르기 전 확인 — 환자 «본인»이 바로 읽는다는 사실을 그 자리에서 알린다.
  soPublishConfirm: { ko: "이 글이 환자 본인에게도 그대로 보입니다(진행상황 링크). 공개할까요?", en: "The patient will read this text as-is on their progress link. Share it?", ru: "Пациент увидит этот текст как есть по ссылке хода дела. Открыть доступ?", kz: "Науқас бұл мәтінді істің барысы сілтемесінде сол күйінде оқиды. Ашасыз ба?", zh: "患者将在进度链接中原样看到这段文字。确定公开吗？", ja: "この文章は患者本人にもそのまま表示されます（進捗リンク）。公開しますか？" },
  ...
  soPublished: { ko: "환자·에이전시 공개됨", en: "Shared with patient & agency", ru: "Открыто пациенту и агентству", kz: "Науқас пен агенттікке ашылған", zh: "已向患者与代理机构公开", ja: "患者・エージェンシーに公開済み" },
