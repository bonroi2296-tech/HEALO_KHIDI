...
const CT = {
  ...
  // 길이 상한에 걸려 «잘린 번역»을 완역처럼 보여주면 안 된다 — 아예 안 보여주고 이유를 말한다.
  atErrTooLong: { ko: "문서가 너무 길어 번역이 중간에 끊겼습니다. 원본을 직접 확인해 주세요.", en: "The document is too long and the translation was cut off. Please open the original.", ru: "Документ слишком длинный, перевод оборвался. Откройте оригинал.", kz: "Құжат тым ұзын, аударма үзілді. Түпнұсқаны қараңыз.", zh: "文档过长，翻译被截断，请查看原件。", ja: "文書が長すぎて翻訳が途中で切れました。原本をご確認ください。" },
