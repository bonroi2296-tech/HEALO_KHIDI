...
const CT = {
  ...
  ibStaffCompressing: { ko: "파일 줄이는 중", en: "Shrinking", ru: "Сжимаем", kz: "Кішірейтілуде", zh: "压缩中", ja: "圧縮中" },
  ibStaffUploading: { ko: "올리는 중", en: "Uploading", ru: "Загрузка", kz: "Жүктелуде", zh: "上传中", ja: "アップロード中" },
