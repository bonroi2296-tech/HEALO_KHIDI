...
const CT = {
  ...
  // 종료(안 옴) — 결과=이탈. 소견까지 주고 «안 온다»고 한 케이스를 목록·상세에서 가른다(2026-09-06 PO).
  inboxFilterClosed: { ko: "종료", en: "Closed", ru: "Закрыто", kz: "Жабылды", zh: "已结束", ja: "終了" },
  inboxClosedBadge: { ko: "종료 · 안 옴", en: "Closed · not coming", ru: "Закрыто · не приедет", kz: "Жабылды · келмейді", zh: "已结束 · 不来", ja: "終了 · 来院なし" },
  ibCloseBtn: { ko: "종료 (환자가 안 온다고 함)", en: "Close (patient not coming)", ru: "Закрыть (пациент не приедет)", kz: "Жабу (науқас келмейді)", zh: "结束（患者不来）", ja: "終了（患者は来院しない）" },
  ibCloseHint: { ko: "결과는 «이탈», 단계는 «보류»로 기록되고 식은 문의 알림에서 빠집니다. 되돌릴 수 있습니다.", en: "Recorded as lost, stage set to On hold, removed from cold-lead alerts. Can be reopened.", ru: "Записывается как отказ, этап — «Приостановлено», заявка уходит из напоминаний об остывших заявках. Можно возобновить.", kz: "Бас тартты деп жазылады, кезең «Кейінге қалдырылды» болады, суыған өтінім ескертулерінен шығады. Қайта ашуға болады.", zh: "记为流失，阶段改为暂缓，不再出现在冷却咨询提醒中。可恢复。", ja: "離脱として記録し、段階は保留になり、放置アラートから外れます。再開できます。" },
  ibCloseReasonPrompt: { ko: "이 문의를 종료합니다(환자가 안 옴). 이유를 적어 주세요 — 비워도 됩니다. 취소를 누르면 종료하지 않습니다.", en: "Close this inquiry (patient not coming). Enter the reason — may be left empty. Cancel keeps it open.", ru: "Закрыть заявку (пациент не приедет). Укажите причину — можно оставить пустым. «Отмена» оставит заявку открытой.", kz: "Өтінімді жабу (науқас келмейді). Себебін жазыңыз — бос қалдыруға болады. «Болдырмау» өтінімді ашық қалдырады.", zh: "结束此咨询（患者不来）。请填写原因，可留空。点“取消”则不结束。", ja: "この問い合わせを終了します（患者は来院しない）。理由を入力してください（空でも可）。キャンセルで終了しません。" },
  ibCloseArrived: { ko: "이미 입국·치료 이후 단계라 «안 옴»으로 종료할 수 없습니다. 단계를 «완료»로 옮기거나 어드민 「유치 전환」에서 처리하세요.", en: "This case is already past arrival, so it cannot be closed as \"not coming\". Move the stage to Completed or handle it in the admin Conversion screen.", ru: "Кейс уже на этапе после прибытия — закрыть как «не приедет» нельзя. Переведите этап в «Завершено» или обработайте на экране «Конверсия».", kz: "Кейс келгеннен кейінгі кезеңде — «келмейді» деп жабуға болмайды. Кезеңді «Аяқталды» етіңіз немесе әкімшінің «Конверсия» экранында өңдеңіз.", zh: "该案例已进入入境后的阶段，无法按“不来”结束。请将阶段改为“已完成”或在管理员“转化”页面处理。", ja: "このケースはすでに入国後の段階なので「来院しない」で終了できません。段階を「完了」にするか、管理者の「転換」画面で処理してください。" },
  ibClosedBanner: { ko: "종료됨 (환자가 안 옴)", en: "Closed (patient not coming)", ru: "Закрыто (пациент не приедет)", kz: "Жабылды (науқас келмейді)", zh: "已结束（患者不来）", ja: "終了（患者は来院しない）" },
  ibReopenBtn: { ko: "되돌리기 (다시 진행)", en: "Reopen", ru: "Возобновить", kz: "Қайта ашу", zh: "重新打开", ja: "再開する" },
  ibReopenHint: { ko: "되돌린 뒤 위에서 단계를 다시 고르세요(«보류»로 남아 있습니다).", en: "After reopening, pick the stage above again (it stays \"On hold\").", ru: "После возобновления заново выберите этап выше (пока остаётся «Приостановлено»).", kz: "Қайта ашқан соң жоғарыдан кезеңді қайта таңдаңыз («Кейінге қалдырылды» күйінде қалады).", zh: "恢复后请在上方重新选择阶段（目前仍为“暂缓”）。", ja: "再開後は上で段階を選び直してください（「保留」のままです）。" },
  ibOutcomeAdmitted: { ko: "유치 확정", en: "Admitted", ru: "Пациент принят на лечение", kz: "Науқас емге қабылданды", zh: "已确定来院治疗", ja: "受け入れ確定" },
  ibCloseFailed: { ko: "처리하지 못했습니다. 잠시 뒤 다시 눌러주세요.", en: "Could not save. Please try again shortly.", ru: "Не удалось сохранить. Попробуйте ещё раз чуть позже.", kz: "Сақталмады. Сәл кейін қайталап көріңіз.", zh: "保存失败，请稍后重试。", ja: "保存できませんでした。しばらくしてからもう一度お試しください。" },
  ...
  chMarkReviewed: { ko: "정확함 · 검수완료", en: "Accurate · Mark reviewed", ru: "Верно · Проверено", kz: "Дұрыс · Тексерілді", zh: "准确 · 审核完成", ja: "正確 · 検収完了" },
  chStartCorrect: { ko: "정정해서 환자에게 보내기", en: "Correct and send to patient", ru: "Исправить и отправить пациенту", kz: "Түзетіп науқасқа жіберу", zh: "更正后发送给患者", ja: "訂正して患者に送る" },
  chSendToPatient: { ko: "환자에게 보내기", en: "Send to patient", ru: "Отправить пациенту", kz: "Науқасқа жіберу", zh: "发送给患者", ja: "患者に送る" },
  chCancel: { ko: "취소", en: "Cancel", ru: "Отмена", kz: "Болдырмау", zh: "取消", ja: "キャンセル" },
  chCorrectPlaceholder: { ko: "환자에게 보낼 정정된 소견을 적으세요. AI 초안을 다듬어 보내면 됩니다.", en: "Write the corrected opinion to send to the patient. Editing the AI draft is fine.", ru: "Напишите исправленное заключение для пациента. Можно отредактировать черновик ИИ.", kz: "Науқасқа жіберілетін түзетілген қорытындыны жазыңыз. ЖИ жобасын өңдесеңіз болады.", zh: "请填写要发送给患者的更正意见，可在AI草稿基础上修改。", ja: "患者に送る訂正済みの所見を記入してください。AIの下書きを整えて送れば構いません。" },
  chToastReviewed: { ko: "검수완료로 표시했습니다.", en: "Marked as reviewed.", ru: "Отмечено как проверенное.", kz: "Тексерілді деп белгіленді.", zh: "已标记为审核完成。", ja: "検収完了として記録しました。" },
  chToastReviewFail: { ko: "검수 표시 실패", en: "Could not mark as reviewed", ru: "Не удалось отметить проверку", kz: "Тексеруді белгілеу сәтсіз", zh: "审核标记失败", ja: "検収の記録に失敗しました" },
  chToastCorrectionSent: { ko: "정정 소견을 환자에게 보냈습니다.", en: "Corrected opinion sent to the patient.", ru: "Исправленное заключение отправлено пациенту.", kz: "Түзетілген қорытынды науқасқа жіберілді.", zh: "更正意见已发送给患者。", ja: "訂正した所見を患者に送りました。" },
  chToastSendFail: { ko: "전송 실패", en: "Send failed", ru: "Ошибка отправки", kz: "Жіберу сәтсіз", zh: "发送失败", ja: "送信に失敗しました" },
  // 어드민 채팅 화면에만 있던 표시 3종(환자 현지 시각·메신저 채널·미전달) — 2026-09-07 화면 통합 때 옮김
  chLocalTime: { ko: "현지", en: "Local", ru: "Местное", kz: "Жергілікті", zh: "当地", ja: "現地" },
  chNight: { ko: "심야", en: "night", ru: "ночь", kz: "түн", zh: "深夜", ja: "深夜" },
  chLocalTimeTitle: { ko: "환자 현지 시각", en: "Patient's local time", ru: "Местное время пациента", kz: "Науқастың жергілікті уақыты", zh: "患者当地时间", ja: "患者の現地時刻" },
  chTzBrowser: { ko: "브라우저 확인", en: "from browser", ru: "по браузеру", kz: "браузер бойынша", zh: "浏览器确认", ja: "ブラウザ確認" },
  chTzGuess: { ko: "추정", en: "estimated", ru: "предположительно", kz: "шамамен", zh: "推测", ja: "推定" },
  chNightHint: { ko: "심야(22~08시)라 지금 답장하면 알림으로 깨울 수 있어요", en: "It's night (22:00–08:00) there — replying now may wake the patient", ru: "Сейчас ночь (22:00–08:00) — ответ может разбудить пациента", kz: "Қазір түн (22:00–08:00) — жауап науқасты оятып жіберуі мүмкін", zh: "当地为深夜（22~08点），现在回复可能会吵醒患者", ja: "深夜（22〜08時）のため、今返信すると通知で起こす可能性があります" },
  chChannelOut: { ko: "발신", en: "outbound", ru: "исходящие", kz: "шығыс", zh: "发送", ja: "送信" },
  chChannelTgTitle: { ko: "이 스레드의 답장은 환자의 텔레그램으로 전송됩니다", en: "Replies in this thread go to the patient's Telegram", ru: "Ответы в этой беседе отправляются в Telegram пациента", kz: "Бұл сөйлесудегі жауаптар науқастың Telegram-ына жіберіледі", zh: "此对话的回复将发送到患者的 Telegram", ja: "このスレッドの返信は患者の Telegram に送信されます" },
  chChannelWaTitle: { ko: "이 스레드의 답장은 환자의 왓츠앱으로 전송됩니다 (마지막 환자 메시지 후 24시간이 지나면 전송이 막힐 수 있어요)", en: "Replies go to the patient's WhatsApp (sending may be blocked 24h after the patient's last message)", ru: "Ответы отправляются в WhatsApp пациента (через 24 ч после последнего сообщения пациента отправка может быть заблокирована)", kz: "Жауаптар науқастың WhatsApp-ына жіберіледі (науқастың соңғы хабарынан 24 сағат өткен соң жіберу бөгелуі мүмкін)", zh: "回复将发送到患者的 WhatsApp（患者最后一条消息 24 小时后可能无法发送）", ja: "返信は患者の WhatsApp に送信されます（患者の最終メッセージから24時間経過すると送信できない場合があります）" },
  chDeliveryWindowExpired: { ko: "미전달 — 24시간 창 만료 (환자가 다시 메시지를 보내면 답장 가능)", en: "Not delivered — 24h window expired (reply becomes possible when the patient writes again)", ru: "Не доставлено — окно 24 ч истекло (ответ станет возможен, когда пациент напишет снова)", kz: "Жеткізілмеді — 24 сағаттық терезе аяқталды (науқас қайта жазса жауап беруге болады)", zh: "未送达 — 24 小时窗口已过期（患者再次发送消息后可回复）", ja: "未配信 — 24時間ウィンドウ終了（患者が再度メッセージを送ると返信可能）" },
  chDeliveryFailed: { ko: "미전달 — 메신저 발신 실패", en: "Not delivered — messenger send failed", ru: "Не доставлено — ошибка отправки в мессенджер", kz: "Жеткізілмеді — мессенджерге жіберу сәтсіз", zh: "未送达 — 消息发送失败", ja: "未配信 — メッセンジャー送信失敗" },
  ...
  ibStaffUploadHint: { ko: "메일·왓츠앱 등으로 따로 받은 자료를 여기에 올리면 문의에 함께 보관됩니다. PDF·이미지·Word, 각 2GB.", en: "Files received by email or WhatsApp can be attached here. PDF / image / Word, 2GB each.", ru: "Файлы, полученные по почте или WhatsApp, можно прикрепить здесь. PDF / изображение / Word, до 2 ГБ.", kz: "Поштамен немесе WhatsApp арқылы алынған файлдарды осында тіркеңіз. PDF / сурет / Word, әрқайсысы 2ГБ.", zh: "可在此上传通过邮件或 WhatsApp 收到的资料。PDF / 图片 / Word，每个 2GB。", ja: "メールや WhatsApp で受け取った資料をここに添付できます。PDF・画像・Word、各2GB。" },
  ...
  ibStaffUploadTooLarge: { ko: "파일은 각 2GB 이하여야 합니다.", en: "Each file must be under 2GB.", ru: "Каждый файл — до 2 ГБ.", kz: "Әр файл 2ГБ-тан аз болуы керек.", zh: "每个文件需小于2GB。", ja: "各ファイルは2GB未満にしてください。" },
  ...
  // 🛑 placeholder 는 글자를 치는 순간 사라져서, «이미 적어둔 메모를 고치러» 들어오면 경고를 한 번도 못 본다.
  //    2026-09-09 에 이 칸에 내부 메모를 적었다가 환자 링크 화면에 그대로 나가는 것을 뒤늦게 발견했다.
  //    그래서 같은 경고를 «항상 보이는 라벨»로 한 줄 더 세운다. (placeholder 는 예시 때문에 그대로 둔다)
  ibCaseNoteVisible: { ko: "이 메모는 환자·에이전시 화면에 그대로 표시됩니다", en: "This note is shown to the patient and agency as written", ru: "Эта заметка отображается пациенту и агентству в том виде, как написана", kz: "Бұл ескертпе пациент пен агенттікке жазылған күйінде көрінеді", zh: "此备注将原样显示给患者和代理机构", ja: "このメモは患者・代理店にそのまま表示されます" },
  ...
  atErrTooLong: { ko: "문서가 너무 길어 번역이 중간에 끊겼어요. 쪽을 나눠 다시 올려 주세요.", en: "The document is too long and the translation was cut off. Split it into parts and upload again.", ru: "Документ слишком длинный, перевод оборвался. Разделите его на части и загрузите снова.", kz: "Құжат тым ұзын, аударма үзіліп қалды. Бөліктерге бөліп қайта жүктеңіз.", zh: "文档过长，翻译中途中断。请分页拆分后重新上传。", ja: "文書が長すぎて翻訳が途中で切れました。ページを分けて再アップロードしてください。" },
  atErrSession: { ko: "로그인이 풀렸어요. 새로고침 후 다시 시도해 주세요.", en: "Your session expired. Refresh the page and try again.", ru: "Сессия истекла. Обновите страницу и повторите.", kz: "Сеанс аяқталды. Бетті жаңартып, қайталаңыз.", zh: "登录已过期，请刷新页面后重试。", ja: "ログインが切れました。ページを再読み込みして再試行してください。" },
