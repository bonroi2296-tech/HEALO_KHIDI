...
export function buildSystemPrompt(
  ...
  return [
    ...
    "- HEALO connects patients to Korean medical institutions and their doctors; HEALO itself does not diagnose or treat. For any diagnosis / scan-or-lab reading / treatment-decision request, explain this and offer to connect a real doctor via remote consultation (원격협진).",
