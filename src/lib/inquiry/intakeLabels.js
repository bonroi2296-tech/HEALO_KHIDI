...
export const INTAKE_UI = {
  ...
  briefImaging: { ko: "CT 초견 (AI 초안 — 판독 아님)", en: "CT preliminary note (AI draft — not a radiology report)", ru: "Предварительное описание КТ (черновик ИИ — не заключение)", kz: "КТ алдын ала сипаттамасы (AI жобасы — қорытынды емес)", zh: "CT 初步观察（AI 草稿——非影像报告）", ja: "CT 初見（AI下書き — 読影ではありません）" },
