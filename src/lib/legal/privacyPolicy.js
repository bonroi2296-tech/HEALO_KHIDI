...
const KO = {
  ...
  user_rights: {
    ...
    body: [
      ...
      "· 손해배상 청구권 (§39)",
      "",
      "권리 행사는 contact@healo.com 또는 본 방침 제15조 개인정보보호책임자 연락처로 요청할 수 있으며, 회사는 10일 이내 조치합니다.",
      "",
  ...
  automated_decisions: {
    ...
    body: [
      ...
      "· 위 요청은 privacy@healo.com 또는 제14조 DPO 연락처로 신청",
      "",
...
const EN = {
  ...
  user_rights: {
    ...
    body: [
      ...
      "",
      "To exercise these rights, contact privacy@healo.com or our DPO (Section 14). We respond within 10 business days.",
      "",
