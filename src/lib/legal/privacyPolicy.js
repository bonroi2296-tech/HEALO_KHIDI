 ...
 *     src/lib/account/deleteAccount.ts · i18n patientAccount.delDesc · app/account-deletion/
 */
// ⚠️ 시행일은 §19 의 약속(중요한 변경 = 최소 7일 전 공지)을 지켜서 잡아라.
//    2.5.0 은 «사실 정정»(우리가 영상을 보관한다)과 «새 약속»(3년 뒤 파기)이 섞여 있어,
//    즉시 시행이 아니라 7일 뒤로 뒀다. 2026-09-08 작성 → 2026-09-16 시행.
...
const KO = {
  ...
  changes: {
    ...
    body: [
      ...
      "현재 버전: 2.5.0 (시행일: 2026-09-16) · 직전 버전 2.4.0 (2026-08-21)",
...
const EN = {
  ...
  changes: {
    ...
    body: [
      ...
      "Current version: 2.5.0 (effective 2026-09-16). Previous version 2.4.0 (2026-08-21).",
...
const RU = {
  ...
  changes: {
    ...
    body: [
      ...
      "Текущая версия: 2.5.0 (вступает в силу 2026-09-16). Предыдущая версия 2.4.0 (2026-08-21).",
...
const KZ = {
  ...
  changes: {
    ...
    body: [
      ...
      "Ағымдағы нұсқа: 2.5.0 (2026-09-16 күшіне енеді). Алдыңғы нұсқа 2.4.0 (2026-08-21).",
...
const ZH = {
  ...
  changes: {
    ...
    body: [
      ...
      "当前版本：2.5.0（生效日 2026-09-16）。上一版本 2.4.0（2026-08-21）。",
...
const JA = {
  ...
  changes: {
    ...
    body: [
      ...
      "現在のバージョン：2.5.0（施行日 2026-09-16）。前バージョン 2.4.0（2026-08-21）。",
