 ...
 *   ✅ 반영 언어: KO(지배본)·EN·RU·KZ·ZH·JA 6개 전부 (ZH·JA 는 2026-07-24 완성).
 *
...
const ZH = {
  ...
  processors: {
    ...
    body: [
      ...
      "· 转介患者的海外招揽机构 —— 以当地语言传递专科医生意见书与治疗指引、口译，以及诊前·诊后管理联络；仅限转介该患者的机构（受托方所在国：患者居住国，如哈萨克斯坦、俄罗斯；依据处理委托合同进行的跨境转移）",
      "· [支付代理 — 待定] — 支付处理",
      "",
...
const JA = {
  ...
  processors: {
    ...
    body: [
      ...
      "· 患者を紹介した海外の誘致エージェンシー — 専門医所見・治療案内の現地語での伝達、通訳、事前・事後管理の連絡（受託者所在国：患者の居住国、例：カザフスタン・ロシア。処理委託契約に基づく国外移転であり、当該患者を紹介したエージェンシーに限る）",
      "· [決済代行会社 — 未定] — 決済処理",
      "",
