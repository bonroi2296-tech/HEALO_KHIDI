  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. 회사의 책임이 인정되는 경우에도, 회사의 총 배상책임은 해당 이용자의 건과 관련하여 회사가 제휴 의료기관으로부터 수령한 유치 수수료의 총액을 초과하지 않습니다. 단, 회사의 고의 또는 중과실로 인한 손해는 제외합니다.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. Even where the Company's liability is established, the Company's total liability for compensation shall not exceed the total attraction commission the Company received from the partner medical institution in connection with the relevant user's case. However, this shall not apply to damages caused by the Company's willful misconduct or gross negligence.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. Даже в случае установления ответственности Компании совокупная сумма возмещения Компании не превышает общей суммы комиссии за привлечение, полученной Компанией от партнёрского медицинского учреждения в связи со случаем соответствующего пользователя. Это не распространяется на ущерб, причинённый умыслом или грубой неосторожностью Компании.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. Компанияның жауапкершілігі белгіленген жағдайда да Компанияның жалпы өтемақысы тиісті пайдаланушының ісіне байланысты Компания серіктес медициналық мекемеден алған тарту комиссиясының жалпы сомасынан аспайды. Бұл Компанияның қасақаналығы немесе өрескел абайсыздығы салдарынан келтірілген залалға қолданылмайды.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. 即使公司的责任成立，公司的赔偿责任总额亦不超过公司就该用户的案件从合作医疗机构所收取的招揽佣金总额。但因公司故意或重大过失造成的损害除外。",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "3. 当社の責任が認められる場合であっても、当社の賠償責任の総額は、当該利用者の案件に関して当社が提携医療機関から受領した誘致手数料の総額を超えないものとします。ただし、当社の故意または重過失による損害はこの限りではありません。",
