  ...
  sections: [
    {
      ...
      title: "제1조 (목적)",
      body: [
        "본 약관은 주식회사 HEALO(이하 '회사')가 제공하는 의료 컨시어지 서비스(이하 '서비스')의 이용과 관련하여 회사와 이용자 간의 권리·의무·책임사항, 기타 필요한 사항을 정함을 목적으로 합니다.",
      ],
    },
    {
      id: "definitions",
    ...
    },
    {
      ...
      title: "제16조 (연락처)",
      body: [
        "· 고객 지원: contact@healo.com",
        "· 법률 문의: legal@healo.com",
        "· 개인정보 관련: privacy@healo.com / DPO: dpo@healo.com",
        "· 주소: [서울시 …]",
        "· 대표번호: +82 (0)2-XXXX-XXXX",
        "· 외국인환자 유치업자 등록번호: [보건복지부 등록번호 기입]",
      ],
    },
  ],
};
