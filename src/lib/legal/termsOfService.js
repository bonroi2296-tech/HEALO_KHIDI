  ...
  sections: [
    {
      ...
      title: "제1조 (목적)",
      body: [
        "본 약관은 본로이(BONROI, 이하 '회사')가 제공하는 메디컬 컨시어지 서비스 'HEALO'(이하 '서비스')의 이용과 관련하여 회사와 이용자 간의 권리·의무·책임사항, 기타 필요한 사항을 정함을 목적으로 합니다.",
      ],
    },
    {
      id: "definitions",
    ...
    },
    {
      ...
      body: [
        ...
        "· 이메일 (고객/법률/개인정보 통합): roiimmunelab@immunelab.co.kr",
