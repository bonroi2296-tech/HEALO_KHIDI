...
export const HOME_CONTENT = {
  hero: {
    // 히어로 배경 사진의 대체 문구. 배경은 어두운 그라데이션에 거의 덮이지만
    // 검색엔진은 alt 로 맥락을 읽는다(네이버 서치어드바이저 「Alt 속성 누락」 6건 = 6개 언어 홈, 2026-09-11).
    imageAlt: {
      ko: "회복 중인 암 환자가 공원을 산책하는 모습",
      en: "A recovering cancer patient walking in a park",
      ru: "Выздоравливающий онкопациент на прогулке в парке",
      kz: "Сауығып келе жатқан онкологиялық науқас саябақта серуендеуде",
      zh: "康复中的癌症患者在公园散步",
      ja: "回復中のがん患者が公園を散歩する様子",
    },
    badge: {
