...
export const STORIES = [
  {
    ...
    quote: {
      en: "From the first video call to the day I flew home, healwith's coordinator knew exactly what I was worried about. The language barrier disappeared. I felt seen.",
      ko: "첫 화상 통화부터 귀국하는 날까지, healwith 코디네이터는 제가 무엇을 걱정하는지 정확히 알고 있었습니다. 언어 장벽이 사라졌어요. 저 자신이 보이는 느낌이었습니다.",
      ru: "От первого видеозвонка до дня отъезда координатор healwith точно знал, что меня тревожит. Языковой барьер исчез. Я чувствовала себя увиденной.",
      kz: "Алғашқы бейнеқоңыраудан бастап үйге ұшу күніне дейін healwith үйлестірушісі не туралы алаңдайтынымды дәл білді. Тілдік кедергі жоғалды.",
      zh: "从第一次视频通话到回国那天，healwith协调员清楚地知道我担心什么。语言障碍消失了，我感到被看见。",
      ja: "最初のビデオ通話から帰国の日まで、healwithのコーディネーターは私が何を心配しているか正確に理解していました。言葉の壁が消え、本当に寄り添ってもらえたと感じました。",
    },
    body: {
      en: "After diagnosis in Almaty, I researched cancer centers across Asia for three weeks. Seoul came up often but the logistics felt impossible — visa, interpreter, where to stay. healwith's intake form took 12 minutes. The next morning I had a call with Dr. Kim (in Russian, via simultaneous interpretation). Surgery was scheduled for two weeks later. My husband and I stayed near the hospital for a month. Everything — visa, airport pickup, groceries — was handled quietly.",
      ko: "알마티에서 진단받은 후 3주 동안 아시아 전역의 암센터를 조사했습니다. 서울이 자주 나왔지만 비자·통역·숙소 같은 현실적인 문제가 불가능해 보였어요. healwith 인테이크 폼은 12분 걸렸습니다. 다음 날 아침 Kim 박사와 러시아어 실시간 통역으로 상담했고, 2주 후 수술 일정이 잡혔습니다. 남편과 저는 병원 근처에서 한 달 머물렀어요. 비자·공항 픽업·장보기 모든 것이 조용히 처리됐습니다.",
      ru: "После диагноза в Алматы я три недели изучала онкоцентры Азии. Сеул упоминался часто, но логистика казалась невозможной — виза, переводчик, жильё. Анкета healwith заняла 12 минут. На следующее утро у меня был звонок с доктором Кимом на русском через синхронный перевод. Операцию назначили через две недели.",
      kz: "Алматыда диагноз қойғаннан кейін үш апта бойы Азиядағы онкоцентрлерді зерттедім. Сеул жиі аталды, бірақ виза, аудармашы, тұрғын үй мәселесі шешілмес болып көрінді. healwith сауалнамасы 12 минут алды. Келесі күні Ким докторымен орыс тілінде бейнекеңес өткіздім.",
      zh: "在阿拉木图确诊后，我花了三周时间研究亚洲各地的癌症中心。首尔经常出现，但签证、翻译、住宿这些看起来不可能解决。healwith问诊表用了12分钟。第二天早上我和Kim医生通过俄英同声传译通话。两周后安排了手术。",
      ja: "アルマトイで診断を受けた後、3週間アジア各地のがんセンターを調べました。ソウルはよく出てきましたが、ビザ・通訳・滞在先という現実的な壁が不可能に見えました。healwithの問診フォームは12分で終わりました。翌朝、Kim医師とロシア語同時通訳で通話しました。",
    },
  ...
  },
  {
    ...
    body: {
      en: "Liver cancer with hepatitis B background. My local doctor said the waiting list was 4 months. healwith matched me with Asan and Samsung — both responded with full treatment plans within two days. I chose Asan for the surgical team. Recovery was faster than predicted.",
      ko: "B형 간염 기반 간암. 현지 의사는 대기 명단 4개월이라고 했어요. healwith가 아산병원과 삼성병원을 매칭해줬고, 두 병원 모두 이틀 내 완전한 치료 계획으로 응답했습니다. 저는 수술팀 때문에 아산을 선택했고, 회복은 예상보다 빨랐습니다.",
      ru: "Рак печени на фоне гепатита B. Местный врач сказал, что в очереди 4 месяца. healwith подобрал Асан и Самсунг — оба ответили полным планом лечения за два дня. Выбрал Асан из-за хирургической команды.",
      kz: "В гепатитімен байланысты бауыр обыры. Жергілікті дәрігер кезек 4 ай деді. healwith Asan және Samsung-ты ұсынды — екеуі де екі күн ішінде толық ем жоспарымен жауап берді.",
      zh: "乙肝相关肝癌。当地医生说要等4个月。healwith为我匹配了峨山和三星医院——两家都在两天内给出了完整治疗方案。我因手术团队选择了峨山。",
      ja: "B型肝炎を背景とした肝がん。地元の医師は待機4ヶ月と言いました。healwithがAsanとSamsungをマッチングしてくれ、両方が2日以内に完全な治療計画で応答。Asanを選びました。",
    },
