...
export const RATE_LIMITS = {
  ...
  //    ⚠️ 2026-09-08 상향(20→60): 실제 암환자 의무기록은 한 벌이 40~50장이다(유방암 케이스 44장).
  //    올리기 창구가 먼저 막혀 드러나지 않았을 뿐 여기도 같은 벽이었다. 돈은 분당 상한이 아니라
  //    aiGuard 의 «일일» 상한이 지키므로 여기를 올려도 요금 위험은 늘지 않는다.
  DOC_CLASSIFY: {
    windowMs: 60 * 1000,
    maxRequests: 60,
