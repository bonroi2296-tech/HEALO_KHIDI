...
export const IMMUNE_SITE = {
  ...
  /* ══ 연혁 — 판이 이미 그릴 줄 아는데 **비어 있어서 통째로 안 뜨던 칸** (2026-07-29 채움) ══
     출처: immunehospital.com/pages/hospital/about.php 「오랜시간, 수많은 환자들의 면역회복을 함께했습니다」
     병원이 자기 사이트에 적어 둔 연혁을 **그대로** 옮겼다. 해외 환자에게 «언제부터 해 온 병원인가»는
     사진 열 장보다 먼저 오는 질문인데, 우리 화면엔 그 답이 한 줄도 없었다.
     ⚠️ 성동점은 병원 연혁표에 **연도가 안 적혀 있다** → 지어내지 않고 뺐다(지점 안내에는 이미 나온다). */
  credentialsTitle: {
    ko: "언제부터 해 온 병원인가",
    en: "How long we have been doing this",
    ru: "Сколько лет мы этим занимаемся",
    kz: "Бұл істі қашаннан бері жасаймыз",
    zh: "这家医院走过的路",
    ja: "いつから続けてきた病院か",
  },
  credentials: [
    {
      year: "2017",
      title: { ko: "면력한방병원 개원", en: "Immune Hospital opens", ru: "Открытие Иммунной Клиники", kz: "Иммундық клиниканың ашылуы", zh: "免力韩方医院开院", ja: "免力韓方病院 開院" },
      desc: {
        ko: "재활 치료 전문 병원으로 시작해 신경계 치료 경험을 쌓았습니다.",
        en: "Started as a rehabilitation hospital, building experience in nervous-system care.",
        ru: "Начали как реабилитационная клиника, накапливая опыт в лечении нервной системы.",
        kz: "Оңалту клиникасы ретінде бастап, жүйке жүйесін емдеу тәжірибесін жинадық.",
        zh: "以康复治疗专科医院起步，积累神经系统治疗经验。",
        ja: "リハビリ専門病院として出発し、神経系治療の経験を重ねました。",
      },
    },
    {
      year: "2019",
      title: { ko: "면역병동 오픈", en: "Immunity ward opens", ru: "Открытие иммунного отделения", kz: "Иммундық бөлімшенің ашылуы", zh: "免疫病房开设", ja: "免疫病棟オープン" },
      desc: {
        ko: "통합 면역 치료 프로그램을 접목하고, 5원칙(면역·체온·순환·저항성·영양)에 따른 개인 맞춤 치료를 적용하기 시작했습니다.",
        en: "Integrated immunity programmes began, with care planned around five principles — immunity, body temperature, circulation, resistance and nutrition.",
        ru: "Появились интегративные иммунные программы: лечение строится вокруг пяти принципов — иммунитет, температура тела, кровообращение, сопротивляемость и питание.",
        kz: "Интегративті иммундық бағдарламалар енгізілді: ем бес қағида — иммунитет, дене температурасы, қанайналым, төзімділік және тамақтану — бойынша құрылады.",
        zh: "引入整合免疫治疗方案，并依据五原则（免疫·体温·循环·抵抗力·营养）制定个人化治疗。",
        ja: "統合免疫治療プログラムを取り入れ、5原則（免疫・体温・循環・抵抗力・栄養）に基づく個別治療を始めました。",
      },
    },
    {
      year: "2020",
      title: { ko: "면역센터 오픈", en: "Immunity centre opens", ru: "Открытие центра иммунитета", kz: "Иммунитет орталығының ашылуы", zh: "免疫中心开设", ja: "免疫センターオープン" },
      desc: {
        ko: "암 치료 후 면역 회복을 위한 한·양방 통합 치료 체계를 갖추고, 대상포진·안면마비 등 항암 부작용 관리 경험을 쌓았습니다.",
        en: "Built a joint Korean-and-Western system for immune recovery after cancer treatment, and accumulated experience in managing side effects such as shingles and facial palsy.",
        ru: "Создали совместную систему корейской и западной медицины для восстановления иммунитета после лечения рака и накопили опыт ведения побочных эффектов — опоясывающего лишая, паралича лицевого нерва.",
        kz: "Обырды емдеуден кейінгі иммундық қалпына келу үшін корей және батыс медицинасының бірлескен жүйесін құрып, белдемше мен бет невритін басқару тәжірибесін жинадық.",
        zh: "建立癌症治疗后免疫恢复的韩西医整合体系，积累带状疱疹、面瘫等抗癌副作用管理经验。",
        ja: "がん治療後の免疫回復のため韓方・西洋の統合治療体制を整え、帯状疱疹・顔面麻痺など抗がん副作用の管理経験を積みました。",
      },
    },
    {
      year: "2021",
      title: { ko: "광명면력한방병원 개원", en: "Gwangmyeong branch opens", ru: "Открытие филиала Кванмён", kz: "Кванмён филиалының ашылуы", zh: "光明院区开院", ja: "光明院 開院" },
    },
    {
      year: "2023",
      title: { ko: "광명 병동 확장 · 신촌면력한방병원 개원", en: "Gwangmyeong ward expanded · Sinchon branch opens", ru: "Расширение отделения в Кванмёне · открытие филиала Синчон", kz: "Кванмён бөлімшесі кеңейтілді · Синчон филиалы ашылды", zh: "光明病房扩建·新村院区开院", ja: "光明の病棟拡張・新村院 開院" },
      desc: {
        ko: "「병원이 아닌 집처럼 편안한 공간」을 목표로 병동을 고쳤고, 면역 치료 사례 5,000명을 넘겼습니다.",
        en: "Wards were rebuilt around the idea of a home rather than a hospital, and immune-treatment cases passed 5,000 patients.",
        ru: "Отделения перестроили по принципу «дом, а не больница»; число пациентов иммунного лечения превысило 5 000.",
        kz: "Бөлімшелер «аурухана емес, үй» қағидасымен қайта жасалды; иммундық ем алған науқастар саны 5 000-нан асты.",
        zh: "以「不像医院、像家一样」为目标改造病房，免疫治疗病例突破5,000人。",
        ja: "「病院ではなく家のように」を目標に病棟を改装し、免疫治療のケースが5,000名を超えました。",
      },
    },
  ],
  ...
  labels: {
    ...
    // ⚠️ 원래 "Certifications"(인증) 였다. 이 칸이 **비어 있어서 화면에 안 뜨는 동안** 아무도 몰랐는데,
    //    막상 채워 넣은 내용은 인증이 아니라 **연혁**이라 띠지 이름이 내용과 어긋났다.
    //    (2026-07-29: 여기 `credentials` 를 하나 더 적었다가 **중복 키**가 됐고 뒤엣것이 이겨
    //     내가 넣은 줄이 죽은 코드가 됐다 — `npm run lint` 의 `no-dupe-keys` 가 잡아 줬다.)
  ...
  gallery: [
    {
      /* 2026-07-30 추가 — 신촌 1인 수액실. 출처: 드라이브 `신촌_수액실/저화질(웹:블로그용)/4V6A0426.jpg`
         (원본은 13MB인데 **「저화질(웹:블로그용)」 하위 폴더**가 따로 있었다 — 이 병원 드라이브의 공통 패턴이다).
         원래 「주요 치료 프로그램」 수액 칸에 넣으려던 것인데, 그 줄은 세 칸 중 한 칸만 사진이 있으면
         어긋나 보여서 이리로 옮겼다. 여기선 캡션이 붙어 «수액실»이라는 게 정확히 전달된다.
         ⚠️ 사람이 안 나온다 = 환자 초상권 문제 없음. */
      src: "/immune/facility/facility-iv-room-1.jpg",
      caption: { ko: "1인 수액실", en: "Private IV room", ru: "Одноместный кабинет для капельниц", kz: "Жеке тамшылатқыш бөлмесі", zh: "单人输液室", ja: "個室の点滴ルーム" },
    },
    {
      src: "/immune/life/rest-pods-1.jpg",
      /* ⚠️ 처음엔 「정원을 마주한 휴식 좌석 / Rest pods」이라 적었다. 사진만 보고 «둥근 의자»로 짐작한 것.
         2026-07-29 성동점 사이트(`sd.immunehospital.com` 시설안내)의 시설 목록에 **「이뮨포레스트_안마의자」**가
         있고, 사진 오른쪽 안내판도 안마의자 사용법이었다 → **병원이 부르는 이름으로** 고쳤다.
         교훈: 사진 캡션은 «내 눈에 보이는 대로»가 아니라 **«병원이 뭐라고 부르는지»**를 먼저 찾아야 한다. */
      caption: { ko: "정원을 마주한 안마의자", en: "Massage chairs facing the indoor garden", ru: "Массажные кресла напротив зимнего сада", kz: "Ішкі бақшаға қараған массаж креслолары", zh: "面向室内花园的按摩椅", ja: "屋内庭園に面したマッサージチェア" },
    },
    {
  ...
  /* 🔴 2026-07-30 전면 교체 — PO: *"이거 콘텐츠 내용이랑 이미지가 너무 안어울리지 않냐?"*
     맞는 지적이었다. 세 장 다 글과 안 맞았고, 특히 **「한약 처방」 자리에 족욕 세면대 줄**이 있었다.
       · 면역·영양 수액  ← `facility-treatment-room-1`(파란 온열 장비 침대). 수액이 아니다.
       · 재생·회복 치료  ← `facility-treatment-room-4`(도수치료 베드 + 모니터 데스크). 재생치료가 아니다.
       · 한약 처방      ← `facility-healing-space-6`(족욕 세면대 줄). **완전히 다른 것.**
     왜 이렇게 됐나: 시설 사진 폴더에서 «빈자리를 채우려고» 아무 사진이나 골라 붙였기 때문이다.
     사진이 글과 안 맞으면 **글까지 못 믿게 된다** — 병원 사이트에서 이건 치명적이다.

     ⚠️ 다음에 여기 사진을 바꿀 때 지킬 것:
       ① 사진을 **눈으로 열어 보고** 고른다. 파일명만 보고 고르지 마라(위 세 건이 전부 그 결과다).
       ② 그 사진이 **글에 적힌 바로 그 것**을 보여주는지 묻는다. «병원스러운 사진»은 기준이 아니다.
       ③ 맞는 사진이 없으면 **비워 둔다.** 판은 `{p.image && ...}` 라서 없으면 그 자리를 안 그린다.
          틀린 사진을 채우는 것보다 안 그리는 게 낫다. */
  programs: [
    {
      // 🔴 2026-07-30 **이 줄은 세 칸 다 사진을 뺐다.** 처음엔 수액 칸에만 맞는 사진(수액실)을 넣었는데,
      //    화면으로 보니 **한 칸만 사진이 있어 줄이 어긋나 보였다**(나머지 두 칸 아래가 텅 빔).
      //    「한 칸만 맞는 사진」은 「세 칸 다 틀린 사진」만큼이나 나쁘다 — 줄이 고르지 않으면 덜 만든 티가 난다.
      //    → 셋 다 비워 줄을 고르게 하고, 확보한 수액실 사진은 **아래 시설 사진 줄로 옮겼다**
      //      (거기선 캡션이 붙어 «이게 수액실이다»가 정확히 전달된다).
      //    ⚠️ 병원이 재생치료·한약 사진을 주면 **세 칸을 한꺼번에** 채워라. 한 칸씩 채우면 다시 어긋난다.
    ...
    },
    {
      ...
      // 🔴 2026-07-30 **사진을 뺐다.** 여기 있던 `facility-treatment-room-4` 는 도수치료 베드+모니터 데스크라
      //    pDRN 신경주사·냉각치료(CRYO)·자가재생(GFC) 와 아무 상관이 없었다.
      //    ⚠️ 대신 넣을 사진이 **없다.** 저장소 278장을 다 훑었고 남은 후보는 둘뿐이었는데 둘 다 아니다:
      //      · `facility-treatment-room-1` = 파란 온열 치료대(광선 램프) — 재생치료가 아니다
      //      · `treatment-recliner-1` = 리클라이너에서 **수액 맞는 장면** — 이건 위 「수액」 칸 것이다
      //    한 번 더 «비슷해 보이는 것»을 넣으면 PO 가 지적한 그 상태로 돌아간다. → 비워 둔다.
    ...
    {
      // 🔴 2026-07-30 **사진을 뺐다.** 여기 있던 `facility-healing-space-6` 은 **족욕 세면대 줄**이라
      //    「한약 처방」과 아무 상관이 없었다(PO 가 이 장면을 보고 지적했다).
      //    ⚠️ 대신 넣을 사진이 **없다.** 찾아본 곳과 결과:
      //      · 우리 저장소 사진 278장 — 한약·약재·탕전 사진 0장 (`tea-cups` 는 식사 코스의 찻잔이라 아니다)
      //      · 병원 사이트 한약 페이지(`/pages/herb/*`) — 사진 0장(문진표만 있다)
      //      · 드라이브 `한약/항암플러스·면역플러스` — 있는데 **장당 16~17MB**라 이 경로로 못 받는다
      //        (「저용량」 하위 폴더도 없다). 드라이브 `공진단` 폴더도 4.8~28MB.
      //    → **PO 가 웹용으로 내보내 주면 그때 채운다.** 그전까진 비워 둔다 —
      //      틀린 사진을 채우면 글까지 못 믿게 된다.
  ...
  faq: [
    ...
    /* ↓ 2026-07-29 추가 — 병원 FAQ(`/pages/hospital/faq.php`)를 직접 읽고 옮겼다.
       우리 FAQ 는 3개뿐이었고 전부 «오기 전» 질문(통역·비용·기간)이었다. 그런데 이 병원은
       **2~4주 입원** 프로그램이라, 해외 환자가 실제로 더 많이 묻는 건 «들어간 다음»이다 —
       몇 시에 밥이 나오나 / 내 케모포트를 여기서 뽑을 수 있나 / 밤에 나갔다 올 수 있나.
       병원은 그 답을 이미 다 적어 뒀는데 우리 화면엔 한 줄도 없었다.
       ⚠️ 전부 병원 FAQ 문장 그대로다. 없는 편의를 만들어 붙이지 않았다. */
    {
      q: {
        ko: "식사는 몇 시에 나오나요?",
        en: "What time are meals served?",
        ru: "Во сколько подают еду?",
        kz: "Тамақ сағат нешеде беріледі?",
        zh: "用餐时间是几点？",
        ja: "食事は何時に出ますか？",
      },
      a: {
        ko: "하루 세 번입니다. 아침 07:30–08:30 · 점심 12:30–13:30 · 저녁 17:30–18:30. 변경이나 취소가 필요하면 식사 시간 2시간 전까지 알려주세요.",
        en: "Three times a day: breakfast 07:30–08:30, lunch 12:30–13:30, dinner 17:30–18:30. If you need to change or cancel a meal, please tell us at least two hours beforehand.",
        ru: "Три раза в день: завтрак 07:30–08:30, обед 12:30–13:30, ужин 17:30–18:30. Об изменении или отмене сообщите не позже чем за два часа.",
        kz: "Күніне үш рет: таңғы ас 07:30–08:30, түскі ас 12:30–13:30, кешкі ас 17:30–18:30. Өзгерту немесе бас тарту қажет болса, кемінде екі сағат бұрын хабарлаңыз.",
        zh: "一日三餐：早餐 07:30–08:30、午餐 12:30–13:30、晚餐 17:30–18:30。如需变更或取消，请于用餐时间前2小时告知。",
        ja: "1日3回です。朝食 07:30–08:30・昼食 12:30–13:30・夕食 17:30–18:30。変更・キャンセルは食事時間の2時間前までにお知らせください。",
      },
    },
    {
      q: {
        ko: "제 병에 맞는 식사가 나오나요?",
        en: "Will the food suit my condition?",
        ru: "Будет ли питание подходить моему состоянию?",
        kz: "Тамақ менің жағдайыма сай бола ма?",
        zh: "会提供适合我病情的餐食吗？",
        ja: "私の状態に合った食事が出ますか？",
      },
      a: {
        ko: "영양사 상담 후 암종별·질환별로 맞춰 나갑니다. 예를 들어 위암으로 위 절제술을 받으신 분은 일정 기간 하루 6식으로 진행하고, 의료진·영양사 상담을 거쳐 저잔사식·당뇨식·저요오드식 등으로 조정합니다.",
        en: "Meals are adjusted to your cancer type and condition after a session with the dietitian. For example, someone who has had a gastrectomy for stomach cancer eats six smaller meals a day for a period, and the plan may shift to low-residue, diabetic or low-iodine meals after review by the doctors and dietitian.",
        ru: "Питание подбирается под тип опухоли и состояние после беседы с диетологом. Например, после гастрэктомии при раке желудка какое-то время назначают шесть небольших приёмов пищи в день; далее план может стать низкошлаковым, диабетическим или низкойодным — по решению врачей и диетолога.",
        kz: "Тамақ диетологпен кеңескеннен кейін ісік түріне және жағдайға қарай реттеледі. Мысалы, асқазан обыры бойынша гастрэктомиядан кейін біраз уақыт күніне алты рет аз-аздан беріледі; кейін жоспар аз қалдықты, диабеттік немесе аз йодты болып өзгеруі мүмкін.",
        zh: "经营养师面谈后，按癌种与病情调整。例如胃癌行胃切除术者，一段时间内采用每日6餐；经医疗团队与营养师评估后，可调整为低渣饮食、糖尿病饮食、低碘饮食等。",
        ja: "栄養士の面談後、がん種・疾患に合わせて調整します。たとえば胃がんで胃切除を受けた方は一定期間1日6食とし、医療陣・栄養士の相談を経て低残渣食・糖尿食・低ヨード食などに調整します。",
      },
    },
    {
      q: {
        ko: "케모포트 제거 같은 처치도 여기서 되나요?",
        en: "Can you do procedures like removing my chemo port?",
        ru: "Можно ли у вас, например, удалить порт для химиотерапии?",
        kz: "Химиотерапия портын алу сияқты процедуралар сізде жасала ма?",
        zh: "像取出化疗港这类处置，贵院可以做吗？",
        ja: "ケモポートの抜去などの処置もできますか？",
      },
      a: {
        ko: "기본적으로 케모포트 제거, 회음부 소독, 자가 약 주사가 가능합니다. 드레싱이나 실밥 제거는 처치 재료와 수술 부위에 따라 달라질 수 있어, 오시기 전에 미리 알려주시면 확인해 드립니다.",
        en: "Chemo-port removal, perineal antisepsis and self-administered injections are generally possible. Dressing changes and suture removal depend on the materials and the surgical site, so tell us in advance and we will check before you come.",
        ru: "Как правило, возможны удаление порта для химиотерапии, обработка промежности и самостоятельные инъекции. Перевязки и снятие швов зависят от материалов и области операции — сообщите заранее, и мы уточним до вашего приезда.",
        kz: "Әдетте химиотерапия портын алу, шап аймағын өңдеу және өзіңіз салатын инъекциялар мүмкін. Таңу мен тігіс алу материал мен ота аймағына байланысты — алдын ала хабарлаңыз, келгенге дейін нақтылаймыз.",
        zh: "通常可进行化疗港取出、会阴部消毒、自行注射用药。更换敷料或拆线视处置材料与手术部位而定，请提前告知，我们会先行确认。",
        ja: "基本的にケモポートの抜去、会陰部の消毒、自己注射が可能です。ドレッシングや抜糸は処置材料や手術部位によって異なるため、事前にお知らせいただければ確認します。",
      },
    },
    {
      q: {
        ko: "밤에 밖에 나갔다 올 수 있나요?",
        en: "Can I go out in the evening and come back?",
        ru: "Можно ли выйти вечером и вернуться?",
        kz: "Кешке сыртқа шығып қайта оралуға бола ма?",
        zh: "晚上可以外出后再回来吗？",
        ja: "夜に外出して戻れますか？",
      },
      a: {
        ko: "가능하지만 시간을 지켜주셔야 합니다. 환자 안전과 보안을 위해 밤 10시 30분부터 비상구와 엘리베이터가 잠기고 출입이 통제됩니다. 외출하실 때는 10시 30분 전에 돌아오시길 권합니다.",
        en: "Yes, but within hours. For patient safety and security the fire exits and lifts are locked from 22:30 and entry is controlled. If you go out, please return before 22:30.",
        ru: "Да, но с учётом времени. Ради безопасности пациентов с 22:30 запасные выходы и лифты запираются, вход ограничен. Если выходите — вернитесь до 22:30.",
        kz: "Иә, бірақ уақытты сақтау керек. Науқастардың қауіпсіздігі үшін 22:30-дан бастап апаттық шығу мен лифт жабылып, кіру шектеледі. Сыртқа шықсаңыз, 22:30-ға дейін оралыңыз.",
        zh: "可以，但请注意时间。为了患者安全与保安，晚上10点30分起消防通道与电梯会上锁并管制出入。外出时请于10点30分前返回。",
        ja: "可能ですが時間を守ってください。患者さんの安全と保安のため、22時30分から非常口とエレベーターが施錠され出入りが制限されます。外出の際は22時30分までにお戻りください。",
      },
    },
  ],
  ...
  /* ══ 치료 메뉴 — 「내 경우엔 뭘 받나」를 골라 보는 자리 ══
     ...
     💰 **금액(`priceNote`) 은 채워져 있다** — 옛 주석은 「전부 비어 있음」이라 적혀 있었는데 그 사이에
        채워졌고 주석만 안 고쳐져 있었다(2026-07-29 정정). 값은 병원이 자기 사이트에 고지한
        비급여표(`/pages/hospital/nonpayment.php`, 최종변경일 2026.06.16)에서 온 것이다.
        ✅ 2026-07-29 원본을 다시 긁어 **적힌 16개 금액을 한 줄씩 대조 — 전부 일치**했다.
        그 표를 `content/immunePrices.js` 에 스냅숏으로 떠 두고, 자동 검사가
        «화면에 적힌 금액이 고지표에 실제로 있는 값인지»를 매번 대조한다(오타·창작 차단).
        ⚠️ 병원이 가격을 바꾸면 스냅숏도 같이 갱신해야 한다 — 자동 검사는 인터넷을 안 본다. */
  menu: {
    title: {
      ko: "내 경우엔 무엇을 받게 되나",
    ...
    items: [
      ...
      },
      {
        ...
        /* ⚠️ 2026-07-29 — 이 카드엔 상급병실 하루 20~60만원이 붙어 있는데 **방에 뭐가 있는지는 없었다.**
           하룻밤 값을 보고 판단하는 사람에게 그건 «구매 정보»가 빠진 것이다.
           특히 2~4주 머무는 해외 환자는 Wi-Fi 와 «병실 안에 샤워실이 있느냐»를 실제로 묻는다.
           출처: 병원 시설안내(`/pages/hospital/facility.php`) 「VIP 입원실」 항목 그대로. */
        includes: { ko: "모션베드 · 개인 냉장고 · Smart TV · 안마의자 · Wi-Fi · 병실 내 샤워실 · 보호자 동반", en: "Motion bed · fridge · smart TV · massage chair · Wi-Fi · en-suite shower · companion stay", ru: "Кровать с регулировкой · холодильник · смарт-ТВ · массажное кресло · Wi-Fi · душ в палате · место для сопровождающего", kz: "Реттелетін төсек · тоңазытқыш · смарт ТВ · массаж креслосы · Wi-Fi · палатадағы душ · серіктеске орын", zh: "电动护理床 · 独立冰箱 · 智能电视 · 按摩椅 · Wi-Fi · 病房内淋浴 · 可陪同", ja: "モーションベッド · 個人冷蔵庫 · スマートTV · マッサージチェア · Wi-Fi · 病室内シャワー · 付き添い可" },
        stay: { ko: "입원", en: "Inpatient", ru: "Стационар", kz: "Стационар", zh: "住院", ja: "入院" },
        priceNote: {
