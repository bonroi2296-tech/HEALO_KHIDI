 ...
 *   · 누적 치료사례 51,823건(2026-08) = 병원 자체 표기
...
export const IMMUNE_SITE = {
  ...
  hero: {
    eyebrow: {
      ko: "양·한방 협진 · 누적 치료 51,823건",
      en: "Korean & Western Medicine · 51,823 Treatments",
      ru: "Корейская и западная медицина · 51 823 случая",
      kz: "Корей және батыс медицинасы · 51 823 емдеу",
