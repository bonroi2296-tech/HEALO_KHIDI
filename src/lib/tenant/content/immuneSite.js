...
export const IMMUNE_SITE = {
  ...
  menu: {
    ...
    lead: {
      ko: "암종을 누르면 해당하는 것만 남습니다. 기간과 포함 내역을 먼저 보고 상담하세요.",
      en: "Tap your diagnosis to filter. Check the duration and what's included before you ask.",
    ...
    note: {
      ko: "※ 금액을 적지 않은 이유: 암 치료비는 병기·전신 상태·동반 질환에 따라 달라져 미리 확정할 수 없습니다. 진단서와 검사 결과를 보내주시면 병원이 확인한 예상 범위를 회신드립니다.",
      en: "※ Why no prices: cancer treatment cost depends on stage, general condition and comorbidities, so it cannot be fixed in advance. Send your records and the hospital replies with a confirmed estimate range.",
      ru: "※ Почему нет цен: стоимость лечения зависит от стадии, общего состояния и сопутствующих заболеваний, поэтому её нельзя назвать заранее. Пришлите документы — клиника ответит с подтверждённым диапазоном.",
      kz: "※ Неге баға жоқ: ем құны сатыға, жалпы жағдайға және қосалқы ауруларға байланысты, сондықтан алдын ала белгіленбейді. Құжаттарыңызды жіберіңіз — клиника расталған баға аралығын жібереді.",
      zh: "※ 未标价的原因：癌症治疗费用取决于分期、全身状态与合并症，无法事先确定。发送诊断与检查结果后，医院将回复确认的预估范围。",
      ja: "※ 金額を記載しない理由：がん治療費は病期・全身状態・併存疾患により変わるため、事前に確定できません。診断書と検査結果をお送りいただければ、病院が確認した概算範囲をお返しします。",
    },
    items: [
      {
        image: "/immune/facility/treatment-iv-inprogress.jpg",
        tags: [
          { key: "solid", label: { ko: "고형암", en: "Solid tumors", ru: "Солидные опухоли", kz: "Қатты ісіктер", zh: "实体瘤", ja: "固形がん" } },
          { key: "during", label: { ko: "항암 중", en: "During chemo", ru: "Во время химиотерапии", kz: "Химиотерапия кезінде", zh: "化疗期间", ja: "抗がん剤治療中" } },
        ],
        ...
        priceNote: "", // ✅ 병원 확인 필요 — 비어 있으면 이 줄이 화면에 안 뜬다
      },
      {
        image: "/immune/facility/treatment-device-inprogress.jpg",
        tags: [
          { key: "nerve", label: { ko: "신경 손상", en: "Nerve damage", ru: "Повреждение нервов", kz: "Жүйке зақымы", zh: "神经损伤", ja: "神経障害" } },
          { key: "after", label: { ko: "항암 후", en: "After chemo", ru: "После химиотерапии", kz: "Химиотерапиядан кейін", zh: "化疗后", ja: "抗がん剤治療後" } },
        ],
      ...
      },
      {
        ...
        tags: [
          { key: "after", label: { ko: "항암 후", en: "After chemo", ru: "После химиотерапии", kz: "Химиотерапиядан кейін", zh: "化疗后", ja: "抗がん剤治療後" } },
          { key: "surgery", label: { ko: "수술 후", en: "After surgery", ru: "После операции", kz: "Оталардан кейін", zh: "术后", ja: "術後" } },
        ],
      ...
      },
      {
        ...
        tags: [
          { key: "during", label: { ko: "항암 중", en: "During chemo", ru: "Во время химиотерапии", kz: "Химиотерапия кезінде", zh: "化疗期间", ja: "抗がん剤治療中" } },
          { key: "stay", label: { ko: "입원 생활", en: "Inpatient life", ru: "Жизнь в стационаре", kz: "Стационар өмірі", zh: "住院生活", ja: "入院生活" } },
        ],
