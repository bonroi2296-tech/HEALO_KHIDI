...
export const IMMUNE_SITE = {
  ...
  videosNote: {
    ko: "의료진이 직접 설명하는 수술 후 관리, 그리고 병원에서 실제로 진행하는 식단과 프로그램입니다. 영상은 한국어로 제작되었습니다 — 내용이 궁금하시면 상담 때 통역과 함께 설명드립니다.",
    en: "Doctors explaining post-surgery care, plus the meals and programmes that actually run at the hospital. The videos are in Korean — we will walk you through them with an interpreter during your consultation.",
    ru: "Врачи рассказывают о ведении пациента после операции, а также питание и программы, которые действительно проводятся в клинике. Видео на корейском языке — на консультации разберём их с переводчиком.",
    kz: "Дәрігерлер операциядан кейінгі күтімді түсіндіреді, сондай-ақ клиникада шынымен өткізілетін тағам мен бағдарламалар. Бейнелер корей тілінде — кеңес кезінде аудармашымен бірге түсіндіреміз.",
    zh: "由医疗团队亲自讲解术后管理，以及医院实际进行的餐食与项目。视频为韩语制作——咨询时我们会安排口译为您讲解。",
    ja: "医療陣が直接説明する術後管理と、病院で実際に行っている食事・プログラムです。動画は韓国語です — 相談時に通訳とともにご説明します。",
  },
  /* ⚠️ 2026-07-29 — PO: *"영상도 잇자나"*. 병원 유튜브(@면력한방병원)를 통째로 훑어보니 **47개**가 있었고
     그중 판에 실린 건 6개(전부 요리·공예)였다. **의료 정보 영상 11개가 하나도 안 실려 있었다.**
     해외 암환자용 화면인데 «수술 후에 팔이 왜 붓는가»(림프부종)를 병원이 이미 영상으로 갖고 있으면서
     보여주지 않고 요리 영상만 띄우고 있었던 것 — 이 병원이 스스로 말하는 «치료의 사이를 맡는다»의
     실제 증거가 그 영상들이다. 그래서 의료 영상을 **맨 앞에** 놓고 생활 영상을 뒤로 돌렸다.
     ✅ 썸네일은 전부 눈으로 확인함 — 의료진이 카메라에 말하는 장면뿐이고 **환자 얼굴·환부는 없다.**
     🔴 환자 치료후기 영상(드라이브 `01_환자후기`)은 **쓰지 않는다** — 의료법 제56조가 «치료경험담 광고»를
        금지한다. 병원이 촬영해 뒀어도 병원 홈페이지에 싣는 건 다른 문제다. */
  videos: [
    {
      id: "InkQxJr3XXA",
      thumb: "/immune/video/InkQxJr3XXA.jpg",
      tag: { ko: "수술 후 관리", en: "After Surgery", ru: "После операции", kz: "Операциядан кейін", zh: "术后管理", ja: "術後ケア" },
      title: {
        ko: "유방암 수술 후 겪을 수 있는 대표적인 부작용 5가지",
        en: "Five common side effects after breast cancer surgery",
        ru: "Пять частых осложнений после операции по поводу рака груди",
        kz: "Сүт безі обыры операциясынан кейінгі бес жиі асқыну",
        zh: "乳腺癌手术后可能出现的5种常见副作用",
        ja: "乳がん手術後に起こりうる代表的な副作用5つ",
      },
    },
    {
      id: "OIlhT_6qxxk",
      thumb: "/immune/video/OIlhT_6qxxk.jpg",
      portrait: true,
      tag: { ko: "수술 후 관리", en: "After Surgery", ru: "После операции", kz: "Операциядан кейін", zh: "术后管理", ja: "術後ケア" },
      title: {
        ko: "유방암 수술했는데 팔이 붓는 이유",
        en: "Why your arm swells after breast cancer surgery",
        ru: "Почему после операции по поводу рака груди отекает рука",
        kz: "Сүт безі обыры операциясынан кейін қол неге ісінеді",
        zh: "乳腺癌术后手臂为何会肿",
        ja: "乳がん手術後に腕がむくむ理由",
      },
    },
    {
      id: "mppBaYcptds",
      thumb: "/immune/video/mppBaYcptds.jpg",
      portrait: true,
      tag: { ko: "수술 후 관리", en: "After Surgery", ru: "После операции", kz: "Операциядан кейін", zh: "术后管理", ja: "術後ケア" },
      title: {
        ko: "유방암 수술 후 부작용 TOP 3",
        en: "Top three side effects after breast cancer surgery",
        ru: "Три главных осложнения после операции по поводу рака груди",
        kz: "Сүт безі обыры операциясынан кейінгі үш негізгі асқыну",
        zh: "乳腺癌术后副作用 TOP3",
        ja: "乳がん手術後の副作用 TOP3",
      },
    },
    {
      id: "PRk6xeAD4M8",
      thumb: "/immune/video/PRk6xeAD4M8.jpg",
      portrait: true,
      tag: { ko: "수술 후 관리", en: "After Surgery", ru: "После операции", kz: "Операциядан кейін", zh: "术后管理", ja: "術後ケア" },
      title: {
        ko: "반지가 갑자기 잘 안 빠진다면 의심해볼 것",
        en: "When a ring suddenly stops coming off — what to suspect",
        ru: "Если кольцо вдруг перестало сниматься — на что обратить внимание",
        kz: "Егер сақина кенет шықпай қалса — неге күдіктену керек",
        zh: "戒指突然摘不下来时该怀疑什么",
        ja: "指輪が急に抜けにくくなったら疑うこと",
      },
    },
    {
      id: "GluaM_eVCPw",
      thumb: "/immune/video/GluaM_eVCPw.jpg",
      portrait: true,
      tag: { ko: "신경 증상", en: "Nerve Symptoms", ru: "Неврологические симптомы", kz: "Жүйке белгілері", zh: "神经症状", ja: "神経症状" },
      title: {
        ko: "대상포진이 얼굴에 생기면 벌어지는 일",
        en: "What happens when shingles reaches the face",
        ru: "Что происходит, когда опоясывающий лишай доходит до лица",
        kz: "Белдемше бет аймағына жеткенде не болады",
        zh: "带状疱疹长在面部会发生什么",
        ja: "帯状疱疹が顔に出たときに起きること",
      },
    },
    /* ⚠️ 대상포진 영상이 하나 더 있었는데(`RTGo9vgjM3Y`) 뺐다 — 썸네일 글자가
       「우리 병원은 포기할게요… 앰뷸런스 타고 가야합니다」다. ①내가 붙인 번역 제목과 그림이 안 맞고
       ②병원 화면에 «우리는 포기한다»가 뜨는 건 역효과다. 한국어를 못 읽는 방문자에겐 더더욱
       그림만 남는다 — **썸네일은 글자까지 읽고 골라야 한다.** */
    {
      id: "IWmJCs_mW8w",
    ...
    {
      id: "VusSsI65NQQ",
      thumb: "/immune/video/VusSsI65NQQ.jpg",
      tag: { ko: "셰프특식", en: "Chef's Table", ru: "Шеф-меню", kz: "Шеф мәзірі", zh: "主厨特餐", ja: "シェフ特食" },
      title: {
        ko: "항암 치료 중에도 맛있게 — 쭈꾸미 파스타와 꽃갈비 루꼴라 피자",
        en: "Eating well during chemotherapy — octopus pasta and rocket pizza",
        ru: "Есть с удовольствием во время химиотерапии — паста с осьминогом и пицца с рукколой",
        kz: "Химиотерапия кезінде де дәмді — сегізаяқ пастасы мен рукколалы пицца",
        zh: "化疗期间也能吃得香——短爪章鱼意面与火箭菜披萨",
        ja: "抗がん治療中でもおいしく — イイダコパスタとルッコラピザ",
      },
    },
    {
      id: "ZmyL9Rujwb8",
      thumb: "/immune/video/ZmyL9Rujwb8.jpg",
      tag: { ko: "셰프특식", en: "Chef's Table", ru: "Шеф-меню", kz: "Шеф мәзірі", zh: "主厨特餐", ja: "シェフ特食" },
      title: {
        ko: "환자만을 위한 스페인 미식 코스",
        en: "A Spanish tasting course made for patients",
        ru: "Испанский гастрономический сет для пациентов",
        kz: "Науқастарға арналған испан асы курсы",
        zh: "专为患者准备的西班牙美食套餐",
        ja: "患者さんのためのスペイン美食コース",
      },
    },
    {
      id: "SbaJqMEXVtY",
      thumb: "/immune/video/SbaJqMEXVtY.jpg",
      tag: { ko: "면역밥상", en: "Immune Table", ru: "Иммунный стол", kz: "Иммундық дастархан", zh: "免疫餐桌", ja: "免疫ごはん" },
      title: {
        ko: "여름의 시원함을 담다 — 수박물김치",
        en: "Summer in a bowl — watermelon water kimchi",
        ru: "Летняя прохлада — водяное кимчи с арбузом",
        kz: "Жаздың салқыны — қарбызды су кимчи",
        zh: "盛夏的清爽——西瓜水泡菜",
        ja: "夏の涼しさを一皿に — スイカの水キムチ",
      },
    },
    {
      id: "G3WGvr3zcE4",
      thumb: "/immune/video/G3WGvr3zcE4.jpg",
      tag: { ko: "원데이클래스", en: "One-day Class", ru: "Мастер-класс", kz: "Шеберлік сабақ", zh: "一日课程", ja: "ワンデイクラス" },
      title: {
        ko: "병원 속 작은 꽃집 — 센터피스 원데이 클래스",
        en: "A small flower shop inside the hospital — centrepiece class",
        ru: "Маленькая цветочная мастерская в клинике — мастер-класс по композициям",
        kz: "Клиника ішіндегі шағын гүл шеберханасы — композиция сабағы",
        zh: "医院里的小花店——桌花一日课程",
        ja: "病院の中の小さな花屋 — センターピース教室",
      },
    },
  ],
