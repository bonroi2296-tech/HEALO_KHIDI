 ...
 * en·ru 번역본을 그대로 뒀다**. 코디(아셀)는 화면 언어를 러시아어/영어로 볼 수 있어서
...
const 핵심표현 = [
  ...
  // 2026-08-19: 의뢰서 카드·문구 편집 — 코디(아셀)가 러시아어로 본다. 여기 없으면 새 기능을 설명 못 받는다.
  { 기능: "의뢰서 카드", ko: "의뢰서 카드", en: "Referral card", ru: "Карточка «Направление»" },
  { 기능: "의뢰서 문구 편집", ko: "의뢰서 문구 고치기", en: "Editing referral-form wording", ru: "Правка текстов формы направления" },
];
