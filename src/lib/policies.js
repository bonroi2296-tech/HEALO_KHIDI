...
export const PRIVACY_SECTIONS_KO = [
  { title: "소개", content: ["HEALO는 해외 환자가 한국 의료기관을 찾고 연결할 수 있도록 돕는 AI 메디컬 컨시어지 플랫폼입니다. HEALO는 의료기관이 아니며 진단·치료를 제공하지 않습니다.", "본 개인정보처리방침은 수집하는 정보, 이용 방법, 이용자 선택에 대해 설명합니다."] },
...
export const TERMS_SECTIONS_KO = [
  { title: "서비스 내용", content: ["HEALO는 이용자가 의료 옵션을 탐색하고 의료기관과 연결할 수 있도록 돕는 AI 메디컬 컨시어지 서비스를 제공합니다. HEALO는 의료기관이 아닙니다.", "진단·치료·의료 상담을 제공하지 않습니다."] },
  { title: "이용자 책임", content: ["문의 시 정확하고 최신 정보를 제공하는 것에 동의합니다.", "의료기관이 제공한 정보를 바탕으로 한 결정에 대한 책임은 이용자에게 있습니다.", "관련 법령 및 병원 정책을 준수해야 합니다."] },
  { title: "의료 면책", content: ["HEALO는 이용자와 의료기관 간 소통을 중개하는 플랫폼입니다.", "진료·진단·치료는 전적으로 의료기관이 제공하며 HEALO가 제공하지 않습니다.", "의료 결과는 개인에 따라 다를 수 있으며 HEALO가 보장하지 않습니다."] },
  { title: "책임 제한", content: ["HEALO는 의료 결과, 부작용, 의료기관의 과실에 대해 책임지지 않습니다.", "이용자와 의료기관 간 분쟁에 대해 HEALO는 책임지지 않습니다.", "법이 허용하는 최대 범위 내에서 간접·파생 손해에 대한 책임을 부인합니다."] },
  { title: "지적재산권", content: ["HEALO 플랫폼의 콘텐츠·브랜드·소프트웨어는 HEALO 또는 라이선스 제공자에게 귀속됩니다.", "허가 없이 복제·수정·배포할 수 없습니다."] },
