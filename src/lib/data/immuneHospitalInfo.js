...
export const IMMUNE_HOSPITAL = {
  ...
  doctors: [
    ...
    },
    {
      ...
      role: { ko: "양방 대표원장", en: "Chief (Western Medicine)" },
      specialty: { ko: "통합면역 · 마취통증의학과", en: "Integrative Immunology · Anesthesiology & Pain Medicine" },
    ...
    },
    {
      ...
      role: { ko: "진료원장", en: "Attending Director" },
      specialty: { ko: "통증재활 · 한방신경정신과", en: "Pain Rehab · KM Neuropsychiatry" },
    ...
    },
    {
      ...
      role: { ko: "진료원장", en: "Attending Director" },
      specialty: { ko: "한방내과 전문의", en: "KM Internal Medicine Specialist" },
    ...
    },
    {
      ...
      specialty: { ko: "진료부", en: "Clinical Department" },
    ...
    },
    {
      ...
      role: { ko: "의무원장", en: "Medical Director" },
      specialty: { ko: "통합면역센터 · 한방내과", en: "Integrative Immunity · KM Internal Medicine" },
    ...
    },
    {
      ...
      specialty: { ko: "통합면역센터 · 정형외과", en: "Integrative Immunity · Orthopedics" },
    ...
    },
    {
      ...
      role: { ko: "진료원장", en: "Attending Director" },
      specialty: { ko: "항노화센터 · 한방피부과", en: "Anti-Aging · KM Dermatology" },
