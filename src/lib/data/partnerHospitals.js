...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-gwangmyeong": {
    ...
    highlights: {
      ko: ["외국인환자 유치의료기관 등록", "7명 전문의 상주 (한방 + 양방)", "스위스 정부 장학생 출신 면역학 연구원 보유", "통합암치료 인정의 다수", "광명역 직결 — KTX 접근성 우수", "양방 마취통증의학과 협진"],
      en: ["Registered for International Patient Care", "7 Resident Specialists (Korean + Western Medicine)", "Former Swiss Government Scholar in Immunology", "Multiple Certified Integrative Oncology Specialists", "Direct KTX access via Gwangmyeong Station", "Western Anesthesiology & Pain Medicine Cooperation"],
      ru: ["Зарегистрировано для иностранных пациентов", "7 штатных специалистов (корейская + западная медицина)", "Бывший стипендиат правительства Швейцарии по иммунологии", "Несколько сертифицированных онкологов", "Прямой доступ к KTX через станцию Кванмён", "Сотрудничество с западной анестезиологией"],
      kz: ["Шетелдік пациенттерге тіркелген", "7 штаттық маман (корей + батыс медицинасы)", "Швейцария үкіметінің иммунология бойынша бұрынғы стипендиаты", "Бірнеше сертификатталған онколог", "Кванмён стансасы арқылы тікелей KTX қолжетімділігі", "Батыс анестезиологиясымен бірлескен ем"],
      zh: ["外国患者诊疗机构注册", "7名专科医师常驻（韩方+西医）", "拥有瑞士政府奖学金免疫学研究员", "多名综合肿瘤治疗认证医师", "光明站直达 — KTX交通便利", "西医麻醉疼痛科协诊"],
