...
const PARTNER_HOSPITALS = {
  ...
  "ewha-seoul": {
    ...
    highlights: {
      ...
      kz: ["2019 жылы ашылды, 756 төсек-орын", "Онкологиялық орталық — мультидисциплинарлық ем", "Магоктағы Immune Hospital Кансоға жақын", "Шетелдік пациенттерге арналған бөлім", "Заманауи бейнелеу және хирургиялық жабдық"],
  ...
  "severance-sinchon": {
    ...
    highlights: {
      ...
      kz: ["Ёнсе онкологиялық ауруханасы — 12 рак түрі бойынша MDT ем", "Мультидисциплинарлық кеңес (MDT)", "Протонды терапия орталығы", "Immune Hospital Синчонға жақын — бірлескен ем", "JCI аккредитациясы — халықаралық сапа стандарттары", "Пациенттерге арналған халықаралық орталық"],
