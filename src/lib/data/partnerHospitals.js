...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-magok": {
    ...
    badge: "partner",
    name: { ko: "면력한방병원 강서 (본원)", en: "Immunehospital Gangseo (HQ)", ru: "Иммуногоспиталь Кансо (главный)", kz: "Иммуногоспиталь Кансо (бас)", zh: "免力韩方医院 江西本院", ja: "免力韓方病院 江西本院" },
    ...
    description: {
      ...
      en: "Immunehospital Gangseo is the headquarters located in Magok, Seoul, specializing in Korean Medicine immunotherapy. With 8 expert doctors including certified integrative oncology specialists, we offer personalized immune enhancement programs based on Sasang constitutional diagnosis, combined herbal medicine, acupuncture, and pharmacopuncture treatments for cancer patients.",
      ru: "Иммуногоспиталь Кансо — главный офис в Магоке, Сеул, специализирующийся на иммунотерапии корейской медицины. 8 специалистов, включая сертифицированных онкологов, обеспечивают персонализированные программы укрепления иммунитета.",
      kz: "Иммуногоспиталь Кансо — Сеул Магоктағы бас кеңсе, корей медицинасы иммунотерапиясына маманданған. 8 маман дәрігер қызмет көрсетеді.",
      zh: "免力韩方医院江西本院位于首尔麻谷，是韩方免疫治疗专科总院。拥有8名专家医生，包括获认证的综合肿瘤治疗专家，提供基于四象体质诊断的个性化免疫增强方案。",
      ja: "免力韓方病院江西本院はソウル麻谷に位置する韓方免疫治療専門の本院です。統合がん治療認定医を含む8名の専門医が在籍し、四象体質診断に基づく個別化された免疫プログラムを提供しています。",
    },
  ...
  "immunehospital-sinchon": {
    ...
    badge: "partner",
    name: { ko: "신촌면력한방병원", en: "Immunehospital Sinchon", ru: "Иммуногоспиталь Синчхон", kz: "Иммуногоспиталь Синчон", zh: "新村免力韩方医院", ja: "新村免力韓方病院" },
    type: { ko: "제휴 병원", en: "Partner Hospital", ru: "Больница-партнёр", kz: "Серіктес аурухана", zh: "合作医院", ja: "提携病院" },
    description: {
      ...
      en: "Immunehospital Sinchon is located on Yonsei-ro, Seodaemun-gu, Seoul, occupying floors 8-14 of Fidelia Tower. With 3 specialist doctors including the chief director, it provides Korean Medicine immunotherapy, rehabilitation medicine, and internal medicine. Its proximity to Sinchon Severance Hospital facilitates integrated Western-Korean Medicine cooperation.",
      ru: "Иммуногоспиталь Синчхон расположен на Ёнсе-ро, Содэмун-гу, Сеул, на 8-14 этажах башни Фиделия. 3 специалиста обеспечивают иммунотерапию корейской медицины, реабилитацию и внутреннюю медицину.",
      kz: "Иммуногоспиталь Синчон Ёнсе-рода, Содэмун-гуда, Сеулде, Фиделия мұнарасының 8-14 қабаттарында орналасқан. 3 маман дәрігер қызмет көрсетеді.",
      zh: "新村免力韩方医院位于首尔西大门区延世路，占据Fidelia大厦8-14层。3名专家医生提供韩方免疫治疗、康复医学和内科诊疗。毗邻新村世福兰斯医院，便于中西医协诊。",
      ja: "新村免力韓方病院はソウル西大門区延世路のフィデリアタワー8-14階に位置する分院です。代表院長を含む3名の専門医が韓方免疫治療、リハビリ医学、内科を担当。新村セブランス病院に隣接し洋韓方協診が容易です。",
    },
  ...
  "immunehospital-gwangmyeong": {
    ...
    badge: "partner",
    name: { ko: "면력한방병원 광명점", en: "Immunehospital Gwangmyeong", ru: "Иммуногоспиталь Кванмён", kz: "Иммуногоспиталь Кванмён", zh: "免力韩方医院 光明院", ja: "免力韓方病院 光明院" },
    type: { ko: "제휴 병원", en: "Partner Hospital", ru: "Больница-партнёр", kz: "Серіктес аурухана", zh: "合作医院", ja: "提携病院" },
    description: {
      ...
      en: "Immunehospital Gwangmyeong is located in M Cluster at Gwangmyeong Station, featuring 7 specialist doctors including the chief director. The team provides comprehensive care in immunotherapy, pain rehabilitation, Korean neuropsychiatry, and anesthesiology. The staff includes doctors with international research experience, including a former Swiss government scholar at the University of Geneva immunology lab.",
      ru: "Иммуногоспиталь Кванмён расположен в M Cluster у станции Кванмён. 7 специалистов обеспечивают иммунотерапию, реабилитацию, нейропсихиатрию и анестезиологию.",
      kz: "Иммуногоспиталь Кванмён Кванмён стансасындағы M Cluster-де орналасқан. 7 маман дәрігер қызмет көрсетеді.",
      zh: "免力韩方医院光明院位于光明站M Cluster，7名专家医生提供免疫治疗、疼痛康复、韩方神经精神科、麻醉疼痛医学科等全面诊疗。",
      ja: "免力韓方病院光明院は光明駅Mクラスターに位置し、代表院長を含む7名の専門医が免疫治療、疼痛リハビリ、韓方神経精神科、麻酔疼痛医学科など幅広い診療を提供しています。",
    },
  ...
  "ewha-seoul": {
    ...
    description: {
      ...
      en: "Ewha Seoul Hospital opened in 2019 in Magok, Seoul, as a 756-bed state-of-the-art university hospital under Ewha Womans University Medical Center. It operates specialized centers including a Cancer Center, Cardiovascular Center, and Organ Transplant Center. Located in the same Magok area as Immunehospital Gangseo, enabling seamless Western-Korean Medicine cooperation.",
      ...
      kz: "Ихва Сеул ауруханасы 2019 жылы Магокта ашылды — 756 төсек-орын, онкологиялық, жүрек-қантамыр орталықтары бар. Иммуногоспиталь Кансомен бірлесіп жұмыс істейді.",
      zh: "梨大首尔医院于2019年在首尔麻谷开院，拥有756张床位的最新大学医院。设有癌症中心、心血管中心、器官移植中心等专科中心。与免力韩方医院江西本院同处麻谷地区，中西医协诊便利。",
      ja: "梨大ソウル病院は2019年にソウル麻谷に開院した756床の最新大学病院です。がんセンター、心臓血管センター、臓器移植センターなどの専門センターを運営。免力韓方病院江西本院と同じ麻谷地域に位置し、洋韓方協診がスムーズです。",
    },
    ...
    highlights: {
      ...
      en: ["Opened 2019 with 756 Beds", "Cancer Center — Multidisciplinary Integrated Care", "Adjacent to Immunehospital Gangseo in Magok", "Dedicated International Patient Department", "State-of-the-art Imaging & Surgical Equipment"],
    },
    bedCount: 756,
  ...
  "korea-guro": {
    ...
    type: { ko: "협진 대학병원", en: "University Hospital", ru: "Университетская больница", kz: "Университеттік аурухана", zh: "大学医院", ja: "大学病院" },
    description: {
      ko: "고려대학교 구로병원은 고려대학교 의과대학 부속 병원으로, 특히 암센터를 중심으로 한 종합적인 암 치료 체계를 갖추고 있습니다. 간암, 폐암, 위암 등에서 높은 수술 성공률을 기록하고 있으며, 로봇수술센터와 방사선종양학과를 통한 정밀 치료로 국내외 환자들에게 신뢰를 얻고 있습니다. 외국인환자 유치의료기관으로 등록되어 국제진료센터를 운영합니다.",
      en: "Korea University Guro Hospital features a comprehensive cancer treatment system centered around its Cancer Center. It records high surgical success rates for liver, lung, and stomach cancers, earning trust through precision treatments via its Robotic Surgery Center and Radiation Oncology department. Registered as an international patient care facility with a dedicated International Medical Center.",
      ru: "Больница Куро Корёского университета — с комплексной системой лечения рака, высокими показателями успешности операций при раке печени, лёгких и желудка. Центр роботизированной хирургии и радиотерапии.",
      kz: "Корё университеті Куро ауруханасы — бауыр, өкпе, асқазан обырында жоғары хирургиялық табыс көрсеткіштерімен ерекшеленеді. Робот-хирургия орталығы мен радиотерапия бөлімі бар.",
      zh: "高丽大学九老医院以癌症中心为核心，构建了全面的癌症治疗体系。在肝癌、肺癌、胃癌手术方面保持高成功率，通过机器人手术中心和放射肿瘤学科的精准治疗赢得国内外患者信赖。设有国际诊疗中心。",
      ja: "高麗大学九老病院はがんセンターを中心に総合的ながん治療体制を備えています。肝がん・肺がん・胃がんで高い手術成功率を記録し、ロボット手術センターと放射線腫瘍科による精密治療で信頼を得ています。",
    },
    ...
    highlights: {
      ko: ["간암·폐암·위암 수술 높은 성공률", "로봇수술센터 운영", "국제진료센터 — 외국인환자 전담", "다학제 암 진료 체계 (Tumor Board)", "첨단 방사선치료 (IMRT, SBRT)"],
      en: ["High Surgical Success Rates for Liver, Lung & Stomach Cancer", "Robotic Surgery Center", "International Medical Center for Foreign Patients", "Multidisciplinary Tumor Board", "Advanced Radiation Therapy (IMRT, SBRT)"],
    },
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&h=500&fit=crop",
  },
  ...
  "severance-sinchon": {
    ...
    type: { ko: "협진 대학병원", en: "University Hospital", ru: "Университетская больница", kz: "Университеттік аурухана", zh: "大学医院", ja: "大学病院" },
    description: {
      ko: "신촌세브란스병원은 연세대학교 의과대학 세브란스병원의 본원으로, 국내 최고 수준의 연세암병원을 운영합니다. 연세암병원은 2022년 기준 12개 암종에 대해 국내 최상위 5년 생존율을 기록하고 있으며, 다학제 통합 진료(MDT)를 통해 각 환자에게 최적화된 치료 계획을 제시합니다. 신촌면력한방병원과 인접하여 항암 치료 후 한방 면역 관리 협진이 원활합니다.",
      en: "Sinchon Severance Hospital is the main campus of Yonsei University's Severance Hospital, operating the Yonsei Cancer Hospital — one of Korea's top cancer treatment facilities. As of 2022, it records the nation's highest 5-year survival rates across 12 cancer types. Multidisciplinary team (MDT) consultations ensure optimized treatment plans for each patient. Adjacent to Immunehospital Sinchon for seamless post-chemo Korean Medicine immune care.",
      ru: "Больница Северанс Синчхон — главный кампус с Онкобольницей Ёнсе, одной из лучших в Корее. Наивысшие показатели 5-летней выживаемости по 12 типам рака. Мультидисциплинарные консилиумы. Рядом с Иммуногоспиталем Синчхон для послехимиотерапевтической поддержки.",
      kz: "Синчон Северанс ауруханасы — Ёнсе университетінің бас кампусы, Ёнсе онкологиялық ауруханасы бар. 12 рак түрі бойынша ең жоғары 5 жылдық тірі қалу көрсеткіштері.",
      zh: "新村世福兰斯医院是延世大学世福兰斯医院本院，运营延世癌症医院——韩国顶级癌症治疗机构。截至2022年，在12种癌症中录得全国最高5年生存率。毗邻新村免力韩方医院，化疗后韩方免疫管理协诊便利。",
      ja: "新村セブランス病院は延世大学セブランス病院の本院で、延世がん病院を運営しています。2022年基準で12のがん種について国内最高水準の5年生存率を記録。新村免力韓方病院に隣接し、化学療法後の韓方免疫ケア協診がスムーズです。",
    },
    ...
    highlights: {
      ko: ["연세암병원 — 12개 암종 국내 최상위 생존율", "다학제 통합 진료 (MDT) 운영", "양성자치료센터 보유 (국내 최초급)", "신촌면력한방병원 인접 — 양·한방 협진", "JCI 인증 — 국제 의료 품질 기준 충족", "외국인환자 전담 국제진료센터"],
      en: ["Yonsei Cancer Hospital — Top Survival Rates in 12 Cancer Types", "Multidisciplinary Team (MDT) Consultations", "Proton Therapy Center (One of Korea's First)", "Adjacent to Immunehospital Sinchon — East-West Cooperation", "JCI Accredited — International Quality Standards", "International Patient Center"],
    },
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&h=500&fit=crop",
  },
};
