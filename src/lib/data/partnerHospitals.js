...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-magok": {
    ...
    description: {
      ...
      ru: "Иммунная Клиника Кансо — главный офис в Магоке, Сеул, специализирующийся на иммунотерапии корейской медицины. 6 специалистов, включая сертифицированных онкологов, обеспечивают персонализированные программы укрепления иммунитета.",
      kz: "Иммунная Клиника Кансо — Сеул Магоктағы бас кеңсе, корей медицинасы иммунотерапиясына маманданған. 6 маман дәрігер қызмет көрсетеді.",
      zh: "免疫医院江西本院位于首尔麻谷，是韩方免疫治疗专科总院。拥有6名专家医生，包括获认证的综合肿瘤治疗专家，提供基于四象体质诊断的个性化免疫增强方案。",
      ja: "免疫病院江西本院はソウル麻谷に位置する韓方免疫治療専門の本院です。統合がん治療認定医を含む6名の専門医が在籍し、四象体質診断に基づく個別化された免疫プログラムを提供しています。",
    },
    ...
    highlights: {
      ...
      kz: ["Шетелдік пациенттерге тіркелген", "Бірнеше сертификатталған онколог", "Сасан диагностикасы негізіндегі иммундық бағдарламалар", "Фитотерапия, акупунктура және фармакопунктура интеграциясы", "6 штаттық маман"],
  ...
  "immunehospital-sinchon": {
    ...
    description: {
      ...
      ru: "Иммунная Клиника Синчхон расположен на Ёнсе-ро, Содэмун-гу, Сеул, на 8-14 этажах башни Фиделия. 6 специалистов обеспечивают иммунотерапию корейской медицины, реабилитацию и внутреннюю медицину.",
      kz: "Иммунная Клиника Синчон Ёнсе-рода, Содэмун-гуда, Сеулде, Фиделия мұнарасының 8-14 қабаттарында орналасқан. 6 маман дәрігер қызмет көрсетеді.",
      zh: "新村免疫医院位于首尔西大门区延世路，占据Fidelia大厦8-14层。6名专家医生提供韩方免疫治疗、康复医学和内科诊疗。毗邻新村世福兰斯医院，便于中西医协诊。",
      ja: "新村免疫病院はソウル西大門区延世路のフィデリアタワー8-14階に位置する分院です。代表院長を含む6名の専門医が韓方免疫治療、リハビリ医学、内科を担当。新村セブランス病院に隣接し洋韓方協診が容易です。",
    },
    ...
    highlights: {
      ...
      kz: ["Шетелдік пациенттерге тіркелген", "Северанс ауруханасына жақын — ыңғайлы бірлескен ем", "Фиделия мұнарасының 8-14 қабаттарындағы кең клиника", "6 штаттық маман"],
  ...
  "immunehospital-seongdong": {
    ...
    description: {
      ...
      ru: "Иммунная Клиника Сондон — новый филиал в Сондон-гу, Сеул. 9 специалистов, центры иммунотерапии, реабилитации и антивозрастной медицины.",
      kz: "Иммунная Клиника Сондон — Сеул Сондон-гудағы жаңа филиал. 9 маман дәрігер, иммунотерапия, оңалту және қартаюға қарсы орталықтар.",
      zh: "免疫医院城东院是首尔城东区新开院的分院，9名专家医生运营综合免疫中心、疼痛康复中心和抗衰老中心。提供中西医结合诊疗。",
      ja: "免疫病院城東院はソウル城東区に新規開院した分院で、9名の専門医が統合免疫センター・疼痛リハビリセンター・抗老化センターを運営しています。",
    },
    ...
    highlights: {
      ...
      kz: ["Шетелдік пациенттерге тіркелген", "9 штаттық маман (корей + батыс медицинасы)", "Иммунитет, оңалту және қартаюға қарсы орталықтар", "Жаңа филиал (Сондон-гу, Сеул)", "Кешенді ем"],
  ...
  "severance-sinchon": {
    ...
    highlights: {
      ...
      ru: ["Онкобольница Ёнсе — MDT-помощь по 12 типам рака", "Мультидисциплинарные консилиумы (MDT)", "Центр протонной терапии", "Рядом с Иммуногоспиталем Синчхон — сотрудничество", "Аккредитация JCI — международные стандарты качества", "Международный центр для пациентов"],
      kz: ["Ёнсе онкологиялық ауруханасы — 12 рак түрі бойынша MDT ем", "Мультидисциплинарлық кеңес (MDT)", "Протонды терапия орталығы", "Иммунная Клиника Синчонға жақын — бірлескен ем", "JCI аккредитациясы — халықаралық сапа стандарттары", "Пациенттерге арналған халықаралық орталық"],
