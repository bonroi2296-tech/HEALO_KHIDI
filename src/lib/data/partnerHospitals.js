...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-magok": {
    ...
    phone: "1522-8850",
    address: { ko: "서울특별시 강서구 마곡중앙6로 93 (마곡동, 열린프라자) 6,7,10층", en: "6F/7F/10F, 93 Magok Jungang 6-ro, Gangseo-gu, Seoul", ru: "Сеул, Кансо-гу, Магокчунан 6-ро, 93 (Магок-дон, Ольрин Плаза), 6, 7 и 10 этажи", kz: "Сеул, Кансо-гу, Магокчунан 6-ро, 93 (Магок-дон, Ольрин Плаза), 6, 7 және 10 қабаттар", zh: "首尔特别市江西区麻谷中央6路93号（麻谷洞，Open Plaza）6、7、10层", ja: "ソウル特別市江西区麻谷中央6路93（麻谷洞、オープンプラザ）6・7・10階" },
  ...
  "ewha-seoul": {
    ...
    highlights: {
      ...
      kz: ["2019 жылы ашылды, 756 төсек-орын", "Онкологиялық орталық — мультидисциплинарлық ем", "Магоктағы Иммунная Клиника Кансоға жақын", "Шетелдік науқастарға арналған бөлім", "Заманауи бейнелеу және хирургиялық жабдық"],
  ...
  "ewha-mokdong": {
    ...
    phone: "1666-5000",
    address: { ko: "서울특별시 양천구 안양천로 1071", en: "1071 Anyangcheon-ro, Yangcheon-gu, Seoul", ru: "Сеул, Янчхон-гу, Аняньчхон-ро, 1071", kz: "Сеул, Янчхон-гу, Аняньчхон-ро, 1071", zh: "首尔特别市阳川区安养川路1071号", ja: "ソウル特別市陽川区安養川路1071" },
  ...
  "severance-sinchon": {
    ...
    highlights: {
      ...
      kz: ["Ёнсе онкологиялық ауруханасы — 12 рак түрі бойынша MDT ем", "Мультидисциплинарлық кеңес (MDT)", "Протонды терапия орталығы", "Иммунная Клиника Синчонға жақын — бірлескен ем", "JCI аккредитациясы — халықаралық сапа стандарттары", "Науқастарге арналған халықаралық орталық"],
