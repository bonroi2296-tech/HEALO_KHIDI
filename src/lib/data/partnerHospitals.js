...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-magok": {
    ...
    badge: "partner",
    name: { ko: "면력한방병원 강서 (본원)", en: "Immune Hospital Gangseo (HQ)", ru: "Иммун Госпиталь Кансо (главный)", kz: "Иммун Госпиталь Кансо (бас)", zh: "免疫医院 江西本院", ja: "免疫病院 江西本院" },
    ...
    description: {
      ...
      ru: "Иммун Госпиталь Кансо — главный офис в Магоке, Сеул, специализирующийся на иммунотерапии корейской медицины. 8 специалистов, включая сертифицированных онкологов, обеспечивают персонализированные программы укрепления иммунитета.",
      kz: "Иммун Госпиталь Кансо — Сеул Магоктағы бас кеңсе, корей медицинасы иммунотерапиясына маманданған. 8 маман дәрігер қызмет көрсетеді.",
  ...
  "immunehospital-sinchon": {
    ...
    badge: "partner",
    name: { ko: "신촌면력한방병원", en: "Immune Hospital Sinchon", ru: "Иммун Госпиталь Синчхон", kz: "Иммун Госпиталь Синчон", zh: "新村免疫医院", ja: "新村免疫病院" },
    type: { ko: "제휴 병원", en: "Partner Hospital", ru: "Больница-партнёр", kz: "Серіктес аурухана", zh: "合作医院", ja: "提携病院" },
    description: {
      ...
      ru: "Иммун Госпиталь Синчхон расположен на Ёнсе-ро, Содэмун-гу, Сеул, на 8-14 этажах башни Фиделия. 3 специалиста обеспечивают иммунотерапию корейской медицины, реабилитацию и внутреннюю медицину.",
      kz: "Иммун Госпиталь Синчон Ёнсе-рода, Содэмун-гуда, Сеулде, Фиделия мұнарасының 8-14 қабаттарында орналасқан. 3 маман дәрігер қызмет көрсетеді.",
  ...
  "immunehospital-gwangmyeong": {
    ...
    badge: "partner",
    name: { ko: "면력한방병원 광명점", en: "Immune Hospital Gwangmyeong", ru: "Иммун Госпиталь Кванмён", kz: "Иммун Госпиталь Кванмён", zh: "免疫医院 光明院", ja: "免疫病院 光明院" },
    type: { ko: "제휴 병원", en: "Partner Hospital", ru: "Больница-партнёр", kz: "Серіктес аурухана", zh: "合作医院", ja: "提携病院" },
    description: {
      ...
      ru: "Иммун Госпиталь Кванмён расположен в M Cluster у станции Кванмён. 7 специалистов обеспечивают иммунотерапию, реабилитацию, нейропсихиатрию и анестезиологию.",
      kz: "Иммун Госпиталь Кванмён Кванмён стансасындағы M Cluster-де орналасқан. 7 маман дәрігер қызмет көрсетеді.",
  ...
  "ewha-seoul": {
    ...
    description: {
      ...
      kz: "Ихва Сеул ауруханасы 2019 жылы Магокта ашылды — 756 төсек-орын, онкологиялық, жүрек-қантамыр орталықтары бар. Иммун Госпиталь Кансомен бірлесіп жұмыс істейді.",
  ...
  "severance-sinchon": {
    ...
    description: {
      ...
      zh: "新村世福兰斯医院是延世大学世福兰斯医院本院，运营延世癌症医院——韩国顶级癌症治疗机构。截至2022年，在12种癌症中录得全国最高5年生存率。毗邻新村免疫医院，化疗后韩方免疫管理协诊便利。",
      ja: "新村セブランス病院は延世大学セブランス病院の本院で、延世がん病院を運営しています。2022年基準で12のがん種について国内最高水準の5年生存率を記録。新村免疫病院に隣接し、化学療法後の韓方免疫ケア協診がスムーズです。",
    },
    ...
    highlights: {
      ...
      en: ["Yonsei Cancer Hospital — Top Survival Rates in 12 Cancer Types", "Multidisciplinary Team (MDT) Consultations", "Proton Therapy Center (One of Korea's First)", "Adjacent to Immune Hospital Sinchon — East-West Cooperation", "JCI Accredited — International Quality Standards", "International Patient Center"],
    },
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&h=500&fit=crop",
  },
};
