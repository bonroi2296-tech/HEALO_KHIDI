...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-gwangmyeong": {
    ...
    highlights: {
      ...
      ru: ["7 штатных специалистов (корейская + западная медицина)", "Бывший стипендиат правительства Швейцарии по иммунологии", "Несколько сертифицированных онкологов", "Прямой доступ к KTX через станцию Кванмён", "Сотрудничество с западной анестезиологией"],
      kz: ["7 штаттық маман (корей + батыс медицинасы)", "Швейцария үкіметінің иммунология бойынша бұрынғы стипендиаты", "Бірнеше сертификатталған онколог", "Кванмён стансасы арқылы тікелей KTX қолжетімділігі", "Батыс анестезиологиясымен бірлескен ем"],
      zh: ["7名专科医师常驻（韩方+西医）", "拥有瑞士政府奖学金免疫学研究员", "多名综合肿瘤治疗认证医师", "光明站直达 — KTX交通便利", "西医麻醉疼痛科协诊"],
