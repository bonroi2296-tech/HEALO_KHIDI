...
const PARTNER_HOSPITALS = {
  ...
  "immunehospital-magok": {
    ...
    highlights: {
      ...
      ru: ["Зарегистрировано для иностранных пациентов", "Несколько сертифицированных онкологов", "Индивидуальные иммунные программы по диагностике Сасан", "Интеграция фитотерапии, акупунктуры и фармакопунктуры", "8 штатных специалистов"],
      kz: ["Шетелдік пациенттерге тіркелген", "Бірнеше сертификатталған онколог", "Сасан диагностикасы негізіндегі иммундық бағдарламалар", "Фитотерапия, акупунктура және фармакопунктура интеграциясы", "8 штаттық маман"],
      zh: ["外国患者诊疗机构注册", "多名综合肿瘤治疗认证医师", "基于四象体质诊断的定制免疫方案", "韩药·针灸·药针综合治疗系统", "8名专科医师常驻"],
  ...
  "immunehospital-sinchon": {
    ...
    highlights: {
      ...
      ru: ["Зарегистрировано для иностранных пациентов", "Рядом с больницей Северанс — удобное сотрудничество", "Большая клиника на этажах 8-14 башни Фиделия", "3 штатных специалиста"],
      kz: ["Шетелдік пациенттерге тіркелген", "Северанс ауруханасына жақын — ыңғайлы бірлескен ем", "Фиделия мұнарасының 8-14 қабаттарындағы кең клиника", "3 штаттық маман"],
      zh: ["外国患者诊疗机构注册", "毗邻新村世福兰斯医院 — 中西医协诊便利", "Fidelia大厦8-14层大型诊疗空间", "3名专科医师常驻"],
  ...
  "immunehospital-gwangmyeong": {
    ...
    description: {
      ...
      ru: "Иммунная Клиника Кванмён расположен в здании Triangle в Чхольсан-доне, Кванмён. 7 специалистов обеспечивают иммунотерапию, реабилитацию, нейропсихиатрию и анестезиологию.",
      kz: "Иммунная Клиника Кванмён Кванмён қаласы Чхольсан-дондағы Triangle ғимаратында орналасқан. 7 маман дәрігер қызмет көрсетеді.",
      zh: "免疫医院光明院位于光明市铁山洞Triangle大厦，7名专家医生提供免疫治疗、疼痛康复、韩方神经精神科、麻醉疼痛医学科等全面诊疗。",
      ja: "免疫病院光明院は光明市鉄山洞のトライアングルビルに位置し、代表院長を含む7名の専門医が免疫治療、疼痛リハビリ、韓方神経精神科、麻酔疼痛医学科など幅広い診療を提供しています。",
    },
    ...
    highlights: {
      ...
      kz: ["Шетелдік пациенттерге тіркелген", "7 штаттық маман (корей + батыс медицинасы)", "Швейцария үкіметінің иммунология бойынша бұрынғы стипендиаты", "Бірнеше сертификатталған онколог", "Батыс анестезиологиясымен бірлескен ем"],
  ...
  "immunehospital-seongdong": {
    ...
    highlights: {
      ko: ["외국인환자 유치의료기관 등록", "8명 전문의 상주 (한방 + 양방)", "통합면역·통증재활·항노화 센터 운영", "신규 개원 (서울 성동구)", "양·한방 통합 진료"],
      en: ["Registered for International Patient Care", "8 Resident Specialists (Korean + Western Medicine)", "Integrative Immunity · Pain Rehab · Anti-Aging Centers", "Newly Opened (Seongdong-gu, Seoul)", "Integrated Western-Korean Medicine Care"],
      ru: ["Зарегистрировано для иностранных пациентов", "8 штатных специалистов (корейская + западная медицина)", "Центры иммунитета, реабилитации и антивозрастной медицины", "Новый филиал (Сондон-гу, Сеул)", "Интегрированная медицина"],
      kz: ["Шетелдік пациенттерге тіркелген", "8 штаттық маман (корей + батыс медицинасы)", "Иммунитет, оңалту және қартаюға қарсы орталықтар", "Жаңа филиал (Сондон-гу, Сеул)", "Кешенді ем"],
      zh: ["外国患者诊疗机构注册", "8名专科医师常驻（韩方+西医）", "综合免疫·疼痛康复·抗衰老中心", "新开院（首尔城东区）", "中西医结合诊疗"],
  ...
  "ewha-seoul": {
    ...
    highlights: {
      ...
      ru: ["Открыт в 2019 году, 756 коек", "Онкоцентр — мультидисциплинарная помощь", "Рядом с Иммуногоспиталем Кансо в Магоке", "Отдел для иностранных пациентов", "Современное визуализационное и хирургическое оборудование"],
      kz: ["2019 жылы ашылды, 756 төсек-орын", "Онкологиялық орталық — мультидисциплинарлық ем", "Магоктағы Иммунная Клиника Кансоға жақын", "Шетелдік пациенттерге арналған бөлім", "Заманауи бейнелеу және хирургиялық жабдық"],
      zh: ["2019年开院最新设施（756张床位）", "癌症中心 — 多学科综合诊疗", "毗邻麻谷免疫医院江西本院", "设有外国患者专属部门", "尖端影像·手术设备"],
  ...
  "korea-guro": {
    ...
    highlights: {
      ...
      kz: ["Бауыр, өкпе, асқазан обырының дәл хирургиясы", "Робот-хирургия орталығы", "Шетелдік пациенттерге арналған халықаралық медцентр", "Мультидисциплинарлық онкоконсилиум", "Заманауи сәулелік ем (IMRT, SBRT)"],
  ...
  "severance-sinchon": {
    ...
    highlights: {
      ko: ["연세암병원 — 12개 암종 다학제 통합 진료", "다학제 통합 진료 (MDT) 운영", "국내 최초 중입자치료센터 (2023년 가동)", "신촌면력한방병원 인접 — 양·한방 협진", "JCI 인증 — 국제 의료 품질 기준 충족", "외국인환자 전담 국제진료센터"],
      en: ["Yonsei Cancer Hospital — MDT Care Across 12 Cancer Types", "Multidisciplinary Team (MDT) Consultations", "Korea's First Heavy Ion (Carbon Ion) Therapy Center — since 2023", "Adjacent to Immune Hospital Sinchon — East-West Cooperation", "JCI Accredited — International Quality Standards", "International Patient Center"],
      ru: ["Онкобольница Ёнсе — MDT-помощь по 12 типам рака", "Мультидисциплинарные консилиумы (MDT)", "Первый в Корее центр углеродно-ионной терапии — с 2023 года", "Рядом с Иммуногоспиталем Синчхон — сотрудничество", "Аккредитация JCI — международные стандарты качества", "Международный центр для пациентов"],
      kz: ["Ёнсе онкологиялық ауруханасы — 12 рак түрі бойынша MDT ем", "Мультидисциплинарлық кеңес (MDT)", "Кореядағы алғашқы ауыр иондық терапия орталығы — 2023 жылдан", "Иммунная Клиника Синчонға жақын — бірлескен ем", "JCI аккредитациясы — халықаралық сапа стандарттары", "Пациенттерге арналған халықаралық орталық"],
      zh: ["延世癌症医院 — 12种癌症多学科综合诊疗", "多学科会诊（MDT）运营", "韩国首个重离子治疗中心（2023年启用）", "毗邻新村免疫医院 — 中西医协诊", "JCI认证 — 符合国际医疗质量标准", "外国患者专属国际诊疗中心"],
      ja: ["延世がん病院 — 12がん種の多職種統合診療", "多職種統合診療（MDT）運営", "韓国初の重粒子線治療センター（2023年稼働）", "新村免疫病院に隣接 — 洋韓方協診", "JCI認証 — 国際医療品質基準を充足", "外国人患者専門の国際診療センター"],
    },
