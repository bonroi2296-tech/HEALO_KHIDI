...
export const IMMUNE_THERAPIES = {
  ...
  nkCell: {
    ...
    description: {
      ...
      zh: "通过激活自然杀伤细胞（NK细胞）直接攻击癌细胞的免疫疗法。对术后残留癌细胞的管理效果显著。",
  ...
  glutamine: {
    ...
    description: {
      ...
      zh: "直接补充免疫细胞的主要能量来源——谷氨酰胺，强化黏膜免疫功能。对化疗期间的口腔炎和肠黏膜损伤效果显著。",
  ...
  hyperthermia: {
    ...
    description: {
      ...
      kz: "Жоғары жиілікті токты ісік аймағына шоғырландырып, жергілікті 42–43°C-қа дейін қыздырады. Қатерлі ісік жасушалары қалыпты жасушаларға қарағанда ыстыққа сезімтал болғандықтан жойылады; химиотерапиямен бірге қолданғанда синергиялық әсер береді.",
  ...
  infraredHeat: {
    ...
    description: {
      ...
      zh: "利用近红外线的全身温热疗法。对缓解支气管炎症、改善血液循环和消除疲劳效果显著，也用于肺癌术后的呼吸康复。",
  ...
  lowIodideDiet: {
    ...
    description: {
      ...
      kz: "Қалқанша безі обыры отасынан кейін радиоактивті йодпен емдеу алдында қолданылатын аз йодты диета. Емнің тиімділігін барынша арттыру үшін йод қабылдауды шектейді.",
