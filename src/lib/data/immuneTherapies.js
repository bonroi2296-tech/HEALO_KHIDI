...
export const IMMUNE_THERAPIES = {
  ...
  thymosin: {
    ...
    description: {
      ...
      kz: "Тимус безі бөлетін пептидті гормон, Т-жасушалар мен NK-жасушаларды тікелей белсендіріп, ісік жасушаларына шабуыл жасайды. Химиотерапиядан кейін төмендеген иммундық қызметті қалпына келтіруде негізгі рөл атқарады.",
      zh: "由胸腺产生的肽类激素，可直接激活T细胞和NK细胞攻击癌细胞。在化疗后恢复受损的免疫功能方面起关键作用。",
      ja: "胸腺で産生されるペプチドホルモンで、T細胞とNK細胞を直接活性化してがん細胞を攻撃します。抗がん剤治療後に低下した免疫機能の回復に重要な役割を果たします。",
    ...
    evidence: {
      ...
      ru: "Международные клинические исследования подтверждают механизм активации Т-клеток и НК-клеток",
      kz: "Халықаралық клиникалық зерттеулер Т-жасушалар мен NK-жасушалардың белсендірілу механизмін растайды",
      zh: "国际临床研究证实了T细胞与NK细胞的激活机制",
      ja: "国際的な臨床研究でT細胞・NK細胞の活性化メカニズムが確認されています",
    },
  ...
  mistletoe: {
    ...
    description: {
      ...
      kz: "Еуропалық омела (Viscum album) сығындысынан жасалған қосымша инъекциялық препарат. NK-жасушалар мен Т-лимфоциттерді белсендіріп иммунитетті көтереді және химиотерапияның жанама әсерлерін азайтады.",
      zh: "以欧洲槲寄生（Viscum album）提取物制成的抗癌辅助注射剂。通过激活NK细胞和T淋巴细胞提高免疫力，并减轻化疗副作用。",
      ja: "ヨーロッパヤドリギ（Viscum album）エキスから作られた抗がん補助注射剤。NK細胞とTリンパ球を活性化して免疫力を高め、抗がん剤の副作用を軽減します。",
  ...
  immunocyanin: {
    ...
    description: {
      ...
      kz: "Теңіз моллюскаларынан алынған, күшті иммуностимуляциялық әсері бар жоғары молекулалы ақуыз. Бейспецификалық иммунитетті күшейту үшін және онкологиялық емге қосымша ретінде қолданылады.",
      zh: "从海洋软体动物中提取的高分子蛋白，具有强效免疫刺激作用，用于非特异性免疫增强及癌症治疗辅助。",
      ja: "海洋軟体動物から抽出した高分子タンパク質で、強力な免疫刺激作用を持ちます。非特異的免疫の強化とがん治療の補助に用いられます。",
    },
    type: "injection",
  },
  ...
  nkCell: {
    ...
    description: {
      ...
      kz: "Табиғи киллер жасушаларды (Natural Killer Cell) белсендіріп, ісік жасушаларына тікелей шабуыл жасайтын иммундық ем. Отадан кейін қалған ісік жасушаларын бақылауда тиімді.",
      zh: "通过激活自然杀伤细胞（NK细胞）直接攻击癌细胞的免疫疗法。对术后残留癌细胞的管理有效。",
      ja: "ナチュラルキラー細胞（NK細胞）を活性化し、がん細胞を直接攻撃する免疫療法。手術後の残存がん細胞の管理に有効です。",
  ...
  immunoPlus: {
    ...
    description: {
      ...
      ru: "Иммуноукрепляющий рецепт корейской медицины: индивидуальная комбинация астрагала (Astragalus) и других иммуностимулирующих трав для укрепления гуморального иммунитета и восстановления сил.",
      kz: "Корей медицинасының иммунитетті нығайтатын рецепті: астрагал (Astragalus) және басқа иммунитетті күшейтетін шөптердің жеке қоспасы — гуморальдық иммунитетті нығайтып, әл-қуатты қалпына келтіруге көмектеседі.",
      zh: "韩医免疫增强处方。以黄芪（Astragalus）等免疫增强药材配伍的定制处方，帮助强化体液免疫并恢复体力。",
      ja: "韓方の免疫強化処方。黄耆（Astragalus）などの免疫増強生薬を組み合わせたオーダーメイド処方で、液性免疫の強化と体力回復を助けます。",
    },
    type: "herbal",
  },
  ...
  glutamine: {
    ...
    description: {
      ...
      ru: "Напрямую восполняет глутамин — основной источник энергии иммунных клеток — и укрепляет иммунитет слизистых. Эффективен при стоматите и повреждении слизистой кишечника во время химиотерапии.",
      kz: "Иммундық жасушалардың негізгі энергия көзі болып табылатын глутаминді тікелей жеткізіп, шырышты қабат иммунитетін нығайтады. Химиотерапия кезіндегі стоматит пен ішек шырышты қабатының зақымдануына тиімді.",
      zh: "直接补充免疫细胞的主要能量来源谷氨酰胺，强化黏膜免疫功能。对化疗期间的口腔炎、肠黏膜损伤有效。",
      ja: "免疫細胞の主要なエネルギー源であるグルタミンを直接補給し、粘膜免疫を強化します。抗がん剤治療中の口内炎や腸粘膜の損傷に有効です。",
    },
    type: "injection",
  },
  ...
  anticancerImmune: {
    ...
    description: {
      ...
      ru: "Вспомогательное средство, восполняющее сниженный во время химиотерапии иммунитет. Максимизирует эффект противоопухолевых препаратов при минимальных побочных эффектах.",
      kz: "Химиотерапия кезінде төмендеген иммундық қызметті толықтыратын қосымша ем. Ісікке қарсы дәрілердің әсерін барынша арттырып, жанама әсерлерін азайтады.",
      zh: "补充化疗期间下降的免疫功能的辅助治疗剂。在最大化抗癌药效果的同时，将副作用降至最低。",
      ja: "抗がん剤治療中に低下した免疫機能を補う補助治療薬。抗がん剤の効果を最大化しつつ、副作用を最小限に抑えます。",
    },
    type: "injection",
  },
  ...
  hyperthermia: {
    ...
    description: {
      ...
      kz: "8MHz жоғары жиілікті токты ісік аймағына шоғырландырып, оны 42-43°C дейін жергілікті қыздырады. Ісік жасушалары қалыпты жасушаларға қарағанда ыстыққа осал болғандықтан жойылады, ал химиотерапиямен қатар қолданғанда синергиялық әсер береді.",
      zh: "将8MHz高频电流集中于癌细胞部位，局部加热至42-43°C。癌细胞比正常细胞更不耐热，从而诱导其死亡；与抗癌药并用时有协同效果。",
      ja: "8MHzの高周波電流をがん細胞部位に集中させ、42-43°Cまで局所加温します。がん細胞は正常細胞より熱に弱いため死滅が誘導され、抗がん剤と併用すると相乗効果があります。",
    ...
    evidence: {
      ...
      ru: "Значимое увеличение продолжительности жизни при сочетании высокочастотной гипертермии с химиотерапией (зарубежные клинические данные)",
      kz: "Жоғары жиілікті гипертермияны химиотерапиямен қатар қолданғанда өмір сүру ұзақтығының елеулі артуы (шетелдік клиникалық деректер)",
      zh: "高频热疗与抗癌药并用时生存期显著延长（海外临床数据）",
      ja: "高周波温熱と抗がん剤の併用で生存期間が有意に延長（海外臨床データ）",
    },
  ...
  infraredHeat: {
    ...
    description: {
      ...
      kz: "Жақын инфрақызыл сәулені пайдаланатын жалпы термотерапия. Бронх қабынуын басуға, қан айналымын жақсартуға және шаршаудан айығуға тиімді. Өкпе обырына жасалған отадан кейінгі тыныс алу оңалтуында да қолданылады.",
      zh: "利用近红外线的全身温热疗法。对缓解支气管炎症、改善血液循环、恢复疲劳有效，也用于肺癌术后的呼吸康复。",
  ...
  lymphDrainage: {
    ...
    description: {
      ...
      kz: "Тәжірибелі терапевт лимфа тамырлары бойымен массаж жасап, лимфа айналымына көмектеседі. Отадан кейін лимфа түйіндері алынғанда пайда болатын лимфедеманы емдеуде аса маңызды; емделмесе өмір бойы ауырсыну мен жүйке ұюы сақталуы мүмкін.",
      zh: "由熟练治疗师沿淋巴管进行按摩，促进淋巴液循环。对术后淋巴结切除引起的淋巴水肿治疗必不可少；若置之不理，疼痛和神经麻木可能终生持续。",
      ja: "熟練したセラピストがリンパ管に沿ってマッサージし、リンパ液の循環を助けます。手術後のリンパ節切除によるリンパ浮腫の治療に不可欠で、放置すると痛みや神経のしびれが一生続くことがあります。",
  ...
  ict: {
    ...
    description: {
      ...
      ru: "Метод, сочетающий иглоукалывание с электростимуляцией. Улучшает кровообращение и лимфоток, снимает боль и помогает восстановлению тканей.",
      kz: "Ине терапиясы мен электр ынталандыруды біріктірген ем әдісі. Қан және лимфа айналымын жақсартып, ауырсынуды басуға және тіндердің қалпына келуіне көмектеседі.",
      zh: "结合针灸与电刺激的治疗方法。改善血液及淋巴循环，缓解疼痛并帮助组织恢复。",
  ...
  selenium: {
    ...
    description: {
      ...
      kz: "Е дәруменінен шамамен 2,000 есе күшті антиоксиданттық қасиеті бар маңызды минерал. Бос радикалдарды басу, ДНҚ зақымдануын болдырмау және ісік жасушаларының жойылуын туындату механизмдері бар. Химиотерапия кезінде жасуша зақымдануын азайту үшін қолданылады.",
      zh: "抗氧化能力约为维生素E的2,000倍的必需矿物质。具有抑制活性氧、防止DNA损伤、诱导癌细胞死亡的机制。用于化疗期间将细胞损伤降至最低。",
      ja: "ビタミンEの約2,000倍の抗酸化力を持つ必須ミネラル。活性酸素の抑制、DNA損傷の防止、がん細胞の死滅誘導の作用があります。抗がん剤治療中の細胞損傷を最小限に抑えるために用いられます。",
    ...
    evidence: {
      ...
      kz: "Селен қабылдағанда химиотерапияның уыттылығы төмендеп, иммундық қызмет жақсаратыны көптеген зерттеулерде расталған",
      zh: "多项研究证实补充硒可降低抗癌药毒性并改善免疫功能",
      ja: "セレン補充により抗がん剤の毒性が低下し免疫機能が改善することが多数の研究で確認されています",
    },
    price: {
  ...
  glutathione: {
    ...
    description: {
      ...
      kz: "Организмдегі күшті антиоксидант: химиотерапиядан кейінгі жасуша зақымдануын қалпына келтіріп, бауырдың детоксикация қызметін қолдайды. Терінің жақсаруына және иммунитетті нығайтуға да тиімді.",
      zh: "体内强效抗氧化剂，修复化疗后的细胞损伤并支持肝脏解毒功能。对改善皮肤和增强免疫力也有效。",
      ja: "体内の強力な抗酸化物質で、抗がん剤治療後の細胞損傷を修復し、肝臓の解毒機能を支えます。皮膚の改善や免疫力強化にも有効です。",
  ...
  highVitaminC: {
    ...
    description: {
      ...
      kz: "Жоғары концентрациялы С дәруменін көктамыр арқылы тікелей жеткізеді. Антиоксиданттық әсерімен ісік жасушаларының өсуін тежеу, иммунитетті нығайту және химиотерапиядан кейінгі шаршауды жеңу үшін қолданылады.",
      zh: "通过静脉注射直接提供高浓度维生素C。利用抗氧化作用抑制癌细胞生长、增强免疫力，并用于化疗疲劳的恢复。",
      ja: "高濃度ビタミンCを点滴で直接補給します。抗酸化作用によるがん細胞の増殖抑制、免疫強化、抗がん剤治療による疲労の回復に用いられます。",
  ...
  placentaExtract: {
    ...
    description: {
      ...
      ru: "Экстракт человеческой плаценты (Laennec/Melsmon и др.) способствует регенерации клеток, регуляции иммунитета и улучшению функции печени. Применяется для сокращения периода восстановления после операции.",
      kz: "Адам плацентасының сығындысы (Laennec/Melsmon және т.б.) жасушалардың қалпына келуіне, иммунитетті реттеуге және бауыр қызметін жақсартуға көмектеседі. Отадан кейінгі қалпына келу мерзімін қысқарту үшін қолданылады.",
      zh: "人胎盘提取物（Laennec/Melsmon等），具有细胞再生、免疫调节、改善肝功能的效果。用于缩短术后恢复期。",
      ja: "ヒト胎盤エキス（Laennec/Melsmonなど）で、細胞再生、免疫調節、肝機能改善の効果があります。手術後の回復期間の短縮に用いられます。",
    },
    type: "injection",
  },
  ...
  chefLive: {
    ...
    description: {
      ...
      kz: "Арнайы аспаз әр науқастың жағдайына сәйкес тағамды сол жерде дайындайтын жеке мәзір бұрышы. 30-дан астам мәзірден таңдауға болады; химиотерапияға арналған, аз қалдықты, асқазан резекциясынан кейінгі диета сияқты ауруға бейімделген арнайы мәзірлер бар.",
      zh: "由专属厨师根据患者状况现场烹饪的定制餐饮区。可从30种以上菜单中选择，并设有化疗专用、低渣、胃切除饮食等针对不同疾病的特色菜单。",
      ja: "専属シェフが患者の状態に合わせてその場で調理するオーダーメイド食事コーナー。30種類以上のメニューから選べ、抗がん剤治療向け、低残渣、胃切除後食など疾患別の特化メニューがあります。",
  ...
  lowResidueDiet: {
    ...
    description: {
      ...
      ru: "Диетотерапия, минимизирующая нагрузку на кишечник после резекции толстой кишки или желудка. Состоит из легкоусвояемых продуктов, слабо раздражающих кишечник.",
      kz: "Тоқ ішек немесе асқазан резекциясынан кейін ішекке түсетін жүктемені азайтатын диета. Жеңіл сіңетін және ішекті аз тітіркендіретін тағамдардан құралады.",
      zh: "在结直肠、胃切除术后将肠道负担降至最低的饮食疗法。由易消化、对肠道刺激小的食物组成。",
  ...
  gastrectomyDiet: {
    ...
    description: {
      ...
      ru: "Программа дробного питания малыми порциями для профилактики демпинг-синдрома (головокружение и гипогликемия сразу после еды) после гастрэктомии. Включает ограничение простых сахаров и раздельный приём жидкости и пищи.",
      kz: "Асқазан резекциясынан кейін пайда болатын демпинг-синдромның (тамақтан кейін бірден бас айналу, гипогликемия) алдын алуға арналған аз мөлшерде жиі тамақтану бағдарламасы. Қарапайым қантты шектеу, сұйықтық пен тамақты бөлек қабылдау сияқты жеке бақылау ұсынылады.",
      zh: "预防胃切除后出现的倾倒综合征（餐后立即头晕、低血糖）的少量多餐饮食方案。提供限制单糖、水分与进餐分开等定制管理。",
      ja: "胃切除後に起こるダンピング症候群（食直後のめまい・低血糖）を予防する少量頻回食プログラム。単純糖の制限、水分と食事の分離などオーダーメイドの管理を行います。",
    },
  ...
  lowIodideDiet: {
    ...
    description: {
      ...
      kz: "Қалқанша безі обырына жасалған отадан кейін радиойод терапиясының алдында тағайындалатын йоды аз диета. Радиойод емінің тиімділігін барынша арттыру үшін йод қабылдауды шектейді.",
      zh: "甲状腺癌术后放射性碘治疗前实施的低碘饮食。为最大化放射性碘治疗效果而限制碘的摄入。",
      ja: "甲状腺がん手術後、放射性ヨウ素治療の前に行う低ヨウ素食。放射性ヨウ素治療の効果を最大化するためヨウ素の摂取を制限します。",
    },
