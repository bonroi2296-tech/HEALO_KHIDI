  ...
  seongdong: {
    ...
    doctors: [
      ...
      },
      {
        ...
        title: { ko: "의무원장", en: "Medical Director" },
        specialty: { ko: "통합면역센터, 한방내과", en: "Integrative Immunity Center, Korean Internal Medicine" },
      ...
      },
      {
        ...
        title: { ko: "양방대표원장", en: "Western Medicine Director" },
        specialty: { ko: "통합면역센터, 정형외과", en: "Integrative Immunity Center, Orthopedics" },
      ...
      },
      {
        ...
        title: { ko: "진료원장", en: "Clinical Director" },
        specialty: { ko: "통증재활센터, 한방내과", en: "Pain Rehabilitation Center, Korean Internal Medicine" },
      ...
      },
      {
        ...
        title: { ko: "진료원장", en: "Clinical Director" },
        specialty: { ko: "항노화센터, 한방피부과", en: "Anti-Aging Center, Korean Dermatology" },
      ...
      },
      {
        ...
        title: { ko: "진료원장", en: "Clinical Director" },
        specialty: { ko: "항노화센터, 한방내과", en: "Anti-Aging Center, Korean Internal Medicine" },
