...
//      바꿀 땐 여기만 바꾸면 화면·RAG(ko)·검사(check:cancer-i18n)가 같이 따라온다. 숫자(30종·2,000배)는 원문 그대로 유지할 것.
export const ITCRN_FRAMEWORK = {
  immunity: {
    title: { ko: "면역 (Immunity)", en: "Immunity", ru: "Иммунитет", kz: "Иммунитет", zh: "免疫 (Immunity)", ja: "免疫 (Immunity)" },
    desc: {
      ...
      ru: "Одновременно активирует клеточный и гуморальный иммунитет, восстанавливая иммунную систему, ослабленную операцией или химиотерапией",
      kz: "Жасушалық және гуморальдық иммунитетті бір мезгілде белсендіріп, ота немесе химиотерапиядан кейін әлсіреген иммундық жүйені қалпына келтіреді",
    ...
    evidence: {
      ...
      ru: "Тимозин α1: активирует T-клетки и NK-клетки; механизм прямого уничтожения раковых клеток",
      kz: "Тимозин α1: T жасушалары мен NK жасушаларын белсендіреді; ісік жасушаларына тікелей әсер ету механизмі",
      zh: "胸腺肽α1：激活T细胞与NK细胞，具有直接杀伤癌细胞的机制",
      ja: "サイモシンα1：T細胞・NK細胞を活性化し、がん細胞を直接攻撃する機序",
    },
  },
  temperature: {
    title: { ko: "체온 (Temperature)", en: "Temperature", ru: "Температура", kz: "Дене қызуы (Temperature)", zh: "体温 (Temperature)", ja: "体温 (Temperature)" },
    desc: {
      ko: "온열 요법으로 암세포 사멸 유도 + 항암 효과 증폭",
      en: "Hyperthermia induces cancer cell death and amplifies chemotherapy efficacy",
      ru: "Гипертермия способствует гибели раковых клеток и усиливает эффект химиотерапии",
      kz: "Гипертермия ісік жасушаларының жойылуына ықпал етіп, химиотерапияның әсерін күшейтеді",
    ...
    evidence: {
      ...
      ru: "Радиочастотная гипертермия в сочетании с химиотерапией: значимое увеличение выживаемости (зарубежные клинические исследования)",
      kz: "Радиожиілікті гипертермияны химиотерапиямен қатар қолданғанда өмір сүру ұзақтығы айтарлықтай артады (шетелдік клиникалық зерттеулер)",
      zh: "射频热疗联合化疗：海外临床研究显示生存期显著延长",
      ja: "高周波温熱療法と抗がん剤の併用で生存期間が有意に延長（海外臨床）",
    },
  },
  circulation: {
    title: { ko: "순환 (Circulation)", en: "Circulation", ru: "Циркуляция", kz: "Қан айналымы (Circulation)", zh: "循环 (Circulation)", ja: "循環 (Circulation)" },
    desc: {
      ko: "림프·혈액 순환 개선으로 부종, 노폐물, 조직 회복 지원",
      en: "Improves lymphatic and blood circulation to reduce edema and aid recovery",
      ru: "Улучшение лимфо- и кровообращения: уменьшение отёков, выведение продуктов обмена, поддержка восстановления тканей",
      kz: "Лимфа мен қан айналымын жақсартып, ісінуді азайтады, зат алмасу қалдықтарын шығарады және тіндердің қалпына келуіне көмектеседі",
  ...
  resistibility: {
    ...
    desc: {
      ...
      ru: "Антиоксидантная и детоксикационная терапия сводит повреждение клеток к минимуму",
      kz: "Антиоксиданттық және детоксикациялық терапия жасуша зақымдануын барынша азайтады",
  ...
  nutrition: {
    ...
    desc: {
      ...
      ru: "Более 30 индивидуальных лечебных меню и живая кухня шеф-повара — питание под состояние каждого пациента",
      kz: "30-дан астам жеке емдік мәзір және аспаздың көз алдыңызда дайындауы — әр науқастың жағдайына сай емдік тамақтану",
      zh: "30余种个性化治疗餐 + 厨师现场烹饪，按每位患者的状况提供治疗饮食",
  ...
  chemoSupport: {
    title: { ko: "항암 치료 지원", en: "Chemotherapy Support", ru: "Поддержка химиотерапии", kz: "Химиотерапияны қолдау", zh: "化疗支持", ja: "抗がん剤治療サポート" },
    before: { ko: "체력 관리, 면역력 강화", en: "Building strength and boosting immunity", ru: "Поддержание сил, укрепление иммунитета", kz: "Күш-қуатты сақтау, иммунитетті нығайту", zh: "体力管理、增强免疫力", ja: "体力管理・免疫力の強化" },
    during: { ko: "구토·피로 완화, 식욕 저하 개선, 구내염 개선", en: "Relief of nausea and fatigue, improved appetite, easing of mouth sores", ru: "Облегчение тошноты и усталости, улучшение аппетита, уменьшение стоматита", kz: "Жүрек айну мен шаршауды жеңілдету, тәбетті жақсарту, стоматитті азайту", zh: "缓解呕吐与疲劳、改善食欲减退、改善口腔炎", ja: "吐き気・倦怠感の緩和、食欲低下の改善、口内炎の改善" },
    after: { ko: "전이·재발 예방, 미세잔존암 관리", en: "Support against metastasis and recurrence; management of minimal residual disease", ru: "Профилактика метастазов и рецидива, контроль минимальной остаточной болезни", kz: "Метастаз бен рецидивтің алдын алу, минималды қалдық ауруды бақылау", zh: "预防转移与复发、管理微小残留病灶", ja: "転移・再発の予防、微小残存がんの管理" },
  },
};
...
export const CANCER_DETAILS = {
  female: {
    ...
    intro: {
      ...
      ru: "При женских формах рака долгосрочное послеоперационное ведение определяет прогноз. Immune Hospital обеспечивает комплексное сопровождение — от восстановления до и после операции и контроля симптомов во время химиотерапии до профилактики рецидива.",
      kz: "Әйелдер обырында операциядан кейінгі ұзақ мерзімді бақылау нәтиже үшін шешуші маңызға ие. Immune Hospital операцияға дейінгі және кейінгі қалпына келуден бастап, химиотерапия кезіндегі симптомдарды бақылау мен рецидивтің алдын алуға дейін кешенді көмек көрсетеді.",
      zh: "对于女性癌症，术后的长期管理对预后起决定性作用。Immune Hospital 提供从术前术后康复、化疗期间症状管理到复发预防的一体化诊疗。",
      ja: "女性がんでは術後の長期的な管理が予後を左右します。Immune Hospital は手術前後の回復から抗がん剤治療中の症状管理、寛解期の再発予防まで一貫してサポートします。",
    },
    complications: [
  ...
  digest: {
    ...
    intro: {
      ...
      ru: "После резекции толстой кишки или желудка способ питания определяет скорость восстановления. Immune Hospital с первых дней после операции системно обеспечивает уход за стомой, контроль демпинг-синдрома и низкошлаковую лечебную диету.",
      kz: "Тоқ ішек немесе асқазанды кесіп алғаннан кейін «тамақтану тәсілі» — қалпына келу жылдамдығының кепілі. Immune Hospital операциядан кейін бірден стоманы күтуді, демпинг-синдромды бақылауды және аз қалдықты емдік диетаны жүйелі түрде ұсынады.",
      zh: "结直肠或胃切除术后，'饮食方式'就是'恢复速度'。Immune Hospital 从术后即刻起，系统地提供造口护理、倾倒综合征管理和低渣治疗膳食。",
      ja: "大腸・胃の切除後は「食べ方」がそのまま「回復速度」になります。Immune Hospital はストーマケア、ダンピング症候群への対応、低残渣治療食を術後すぐから体系的に提供します。",
    },
    complications: [
      ...
      { name: { ko: "덤핑증후군", en: "Dumping syndrome", ru: "Демпинг-синдром", kz: "Демпинг-синдром", zh: "倾倒综合征", ja: "ダンピング症候群" }, desc: { ko: "위절제 후 식사 직후 어지럼·저혈당 (위절제 환자)", en: "Dizziness and hypoglycemia right after eating following gastrectomy (gastrectomy patients)", ru: "Головокружение и гипогликемия сразу после еды после гастрэктомии (у пациентов с гастрэктомией)", kz: "Гастрэктомиядан кейін тамақтанғаннан соң бас айналу мен гипогликемия (гастрэктомия науқастарі)", zh: "胃切除后进食后立即出现头晕、低血糖（胃切除患者）", ja: "胃切除後、食後すぐのめまい・低血糖（胃切除患者）" } },
    ...
    //       바뀐 원문 표기를 그대로 옮기고 확인일을 갱신해라(출처 줄의 «2026-09 확인» 부분 — 2026-09-06 에 원문을 다시 열어 같은 표기·같은 참고논문임을 확인하고 올렸다).
    ...
    stats: {
      ...
      survivalImprovementSource: { ko: "출처: 면력한방병원 공식 사이트 (2026-09 확인). 해당 페이지가 밝힌 참고논문 — Rao X.Q. et al. (1994), CJITWM 14(6):366.", en: "Source: Immune Hospital official website (retrieved September 2026). Reference cited on that page — Rao X.Q. et al. (1994), CJITWM 14(6):366.", ru: "Источник: официальный сайт Immune Hospital (проверено в сентябре 2026). Работа, указанная на той странице, — Rao X.Q. et al. (1994), CJITWM 14(6):366.", kz: "Дереккөз: Immune Hospital-дың ресми сайты (2026 жылғы қыркүйекте тексерілді). Сол беттегі сілтеме — Rao X.Q. et al. (1994), CJITWM 14(6):366.", zh: "来源：Immune Hospital 官方网站（2026年9月确认）。该页面所引文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。", ja: "出典：Immune Hospital 公式サイト（2026年9月確認）。同ページが挙げる引用文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。" },
  ...
  liver: {
    ...
    intro: {
      ...
      ru: "Резекция печени, желчевыводящих путей и поджелудочной железы влияет на сам обмен веществ. Immune Hospital комплексно ведёт снижение функции печени, подтекание желчи, нарушения пищеварения и всасывания, а также послеоперационный диабет.",
      kz: "Бауыр, өт жолдары мен ұйқы безін кесіп алу зат алмасу қызметінің өзіне әсер етеді. Immune Hospital бауыр қызметінің төмендеуін, өттің ағуын, ас қорыту мен сіңіру бұзылыстарын және операциядан кейінгі қант диабетін кешенді түрде басқарады.",
      zh: "肝、胆道、胰腺切除会直接影响代谢功能本身。Immune Hospital 对肝功能下降、胆汁漏、消化吸收障碍乃至术后糖尿病进行综合管理。",
      ja: "肝臓・胆道・膵臓の切除は代謝機能そのものに影響します。Immune Hospital は肝機能低下、胆汁漏、消化・吸収障害、術後糖尿病まで総合的に管理します。",
    },
    complications: [
      {
  ...
  lung: {
    ...
    intro: {
      ...
      ru: "После резекции лёгкого восстановление дыхательного объёма — ключ к возвращению к повседневной жизни. Immune Hospital сочетает дыхательную реабилитацию, лечение воспаления бронхов и восстановление иммунитета.",
      kz: "Өкпені кесіп алғаннан кейін «тыныс алу көлемін» қалпына келтіру күнделікті өмірге оралудың кепілі. Immune Hospital тыныс алу реабилитациясын, бронх қабынуын емдеуді және иммунитетті қалпына келтіруді қатар жүргізеді.",
      zh: "肺切除术后，'呼吸容量'的恢复是回归日常生活的关键。Immune Hospital 同步进行呼吸康复、支气管炎症管理和免疫恢复。",
      ja: "肺切除後は「呼吸容量」の回復が日常復帰の鍵となります。Immune Hospital は呼吸リハビリ、気管支炎症の管理、免疫回復を併行します。",
    },
    complications: [
  ...
  thyroid: {
    ...
    intro: {
      ...
      ru: "Рак щитовидной железы имеет очень благоприятный прогноз, но после резекции требует пожизненного контроля гормонов. Immune Hospital комплексно ведёт нарушения голоса, гипокальциемию, дефицит гормонов, рубцы на шее и нарушение глотания.",
      kz: "Қалқанша без обырының болжамы өте жақсы, бірақ кесіп алғаннан кейін өмір бойы гормондарды бақылау қажет. Immune Hospital дауыс бұзылысын, гипокальциемияны, гормон тапшылығын, мойындағы тыртықты және жұтынудың қиындауын кешенді басқарады.",
      zh: "甲状腺癌预后非常好，但切除后需要终身的激素管理。Immune Hospital 对声音障碍、低钙血症、激素缺乏、颈部瘢痕乃至吞咽困难进行综合管理。",
      ja: "甲状腺がんは予後が非常に良好ですが、切除後は生涯にわたるホルモン管理が必要です。Immune Hospital は音声障害、低カルシウム血症、ホルモン欠乏、頸部の傷跡、嚥下困難まで総合的に管理します。",
    },
    complications: [
  ...
  etc: {
    ...
    intro: {
      ...
      ru: "Пятиосевая система (ITCRN) Immune Hospital применяется также при онкогематологии, опухолях мозга, простаты, почек и других редких видах рака — с индивидуальным планом лечения под конкретную форму рака.",
      kz: "Immune Hospital-дың бес осьтік (ITCRN) жүйесі қан обырына, ми ісіктеріне, қуық асты безіне, бүйрекке және басқа сирек обыр түрлеріне де қолданылады. Нақты обыр түріне бейімделген емдеу жоспары құрылады.",
      zh: "Immune Hospital 的五轴（ITCRN）框架同样适用于血液癌、脑肿瘤、前列腺、肾脏及其他罕见癌症，并制定针对特定癌种的定制治疗方案。",
      ja: "Immune Hospital の5軸（ITCRN）フレームワークは、血液がん、脳腫瘍、前立腺、腎臓、その他の希少がんにも適用されます。特定のがん種に合わせた治療計画を立てます。",
    },
    complications: [
