...
export const CANCER_DETAILS = {
  ...
  digest: {
    ...
    stats: {
      ...
      survivalImprovementSource: { ko: "출처: 면력한방병원 공식 사이트 (2026-09 확인). 해당 페이지가 밝힌 참고논문 — Rao X.Q. et al. (1994), CJITWM 14(6):366.", en: "Source: Immune Hospital official website (retrieved September 2026). Reference cited on that page — Rao X.Q. et al. (1994), CJITWM 14(6):366.", ru: "Источник: официальный сайт Иммунной клиники (проверено в сентябре 2026). Работа, указанная на той странице, — Rao X.Q. et al. (1994), CJITWM 14(6):366.", kz: "Дереккөз: Иммундық клиниканың ресми сайты (2026 жылғы қыркүйекте тексерілді). Сол беттегі сілтеме — Rao X.Q. et al. (1994), CJITWM 14(6):366.", zh: "来源：免疫医院官方网站（2026年9月确认）。该页面所引文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。", ja: "出典：免疫病院公式サイト（2026年9月確認）。同ページが挙げる引用文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。" },
