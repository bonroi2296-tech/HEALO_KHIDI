...
export const CANCER_DETAILS = {
  ...
  digest: {
    ...
    complications: [
      ...
      { name: { ko: "덤핑증후군", en: "Dumping syndrome", ru: "Демпинг-синдром", kz: "Демпинг-синдром", zh: "倾倒综合征", ja: "ダンピング症候群" }, desc: { ko: "위절제 후 식사 직후 어지럼·저혈당 (위절제 환자)", en: "Dizziness and hypoglycemia right after eating following gastrectomy (gastrectomy patients)", ru: "Головокружение и гипогликемия сразу после еды после гастрэктомии (у пациентов с гастрэктомией)", kz: "Гастрэктомиядан кейін тамақтанғаннан соң бас айналу мен гипогликемия (гастрэктомия науқастары)", zh: "胃切除后进食后立即出现头晕、低血糖（胃切除患者）", ja: "胃切除後、食後すぐのめまい・低血糖（胃切除患者）" } },
    ...
    stats: {
      ...
      survivalImprovementSource: { ko: "출처: 면력한방병원 공식 사이트 (2026-09 확인). 해당 페이지가 밝힌 참고논문 — Rao X.Q. et al. (1994), CJITWM 14(6):366.", en: "Source: Immune Hospital official website (retrieved 2026-09). Reference cited on that page — Rao X.Q. et al. (1994), CJITWM 14(6):366.", ru: "Источник: официальный сайт Immune Hospital (проверено 2026-09). Работа, указанная на той странице, — Rao X.Q. et al. (1994), CJITWM 14(6):366.", kz: "Дереккөз: Immune Hospital-дың ресми сайты (2026-09 тексерілді). Сол беттегі сілтеме — Rao X.Q. et al. (1994), CJITWM 14(6):366.", zh: "来源：Immune Hospital 官方网站（2026-09 确认）。该页面所引文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。", ja: "出典：Immune Hospital 公式サイト（2026-09 確認）。同ページが挙げる引用文献 — Rao X.Q. et al. (1994), CJITWM 14(6):366。" },
