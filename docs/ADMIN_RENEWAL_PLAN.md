...
**남은 후속(전부 PO 판단 대기, 급하지 않음)**: ⓐ 4단계 C(초대토큰 담당자 검증 재조이기 — 미채택, 감사로그로 대체) ⓑ 5단계 파트너 포털 **신규 기능** ⓒ 애매 2화면(/admin/treatments·/admin/doctors) 숨김 여부 ⓓ B 인증실패 audit(requirePortalAuth 공통 공백).
