...
## #115 — 인코딩 깨진 출력에서 한글 주소를 추측 복원 → 제안서에 가짜 주소 기재 + 멀쩡한 옛 문서 탓 (2026-07-13, PO가 잡음)
...
> 📦 이식 기록: 이 반성문은 2026-07-13 작성 후 rescue 상자(`rescue-archive-20260716` 태그)에만 있다가 2026-07-24 본판 장부로 이식됨(rescue 장부에선 #80 — 본판 #80과 다른 사건이라 재번호).
