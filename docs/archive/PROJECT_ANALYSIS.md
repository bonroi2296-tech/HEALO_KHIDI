# healwith 프로젝트 분석 보고서

## 📋 프로젝트 개요

**healwith**는 한국 의료 관광을 위한 AI 기반 의료 컨시어지 플랫폼입니다. 해외 환자들이 한국의 병원과 시술을 찾고, 비교하고, 문의할 수 있는 서비스를 제공합니다.
...
healwith 프로젝트는 **잘 구조화된 React 애플리케이션**입니다. 핵심 기능이 구현되어 있고, 사용자 경험도 고려되어 있습니다. 
