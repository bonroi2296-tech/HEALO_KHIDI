...
SCREENS = [
    dict(
        ...
        purpose="카자흐스탄·러시아권 환자가 자국어로 첫 화면을 만나고, 두 갈래(바로 대화 / 문의 남기기)"
                " 중 하나로 즉시 진입하게 한다.",
        parts=[
            "상단 바 — 로고·메뉴·언어 전환(6개 언어)·로그인",
            "히어로 — 한 줄 가치 제안 + [상담 시작] [문의 남기기]",
            "AI 사전상담 진입 카드 — 24시간 응대",
            "안내 카드 4종 — 암종별 안내 · 협진 병원 · 치료 절차 · 비용 안내",
            "환자 여정 7단계 도식",
            "하단 — 유치업 등록번호 · 보증보험 · 법정 고지 · 개인정보 처리방침",
        ],
        data=[
        ...
        nexts="→ P-02 문의 접수 · P-03 AI 사전상담",
        notes=["언어 전환은 주소 앞자리(/ru, /kz …)를 바꾸며 선택은 다음 방문까지 유지된다.",
               "모든 문구는 사전에서 나오고 화면에 직접 쓰는 것(하드코딩)은 자동 검사로 막는다."],
    ),
    dict(
        no="P-02", file="P-02_inquiry.png", name="통합 문의 접수 (2단계)",
        ict="② 사전 진료의뢰 및 상담", path="/inquiry", who="누구나(비로그인)",
        purpose="자료가 아직 없어도 접수되게 문턱을 낮추고, 대학병원 의뢰에 필요한 자료는 2단계에서 받는다.",
        parts=[
            "진행 표시 — 1단계 접수 / 2단계 대학병원 의뢰 준비",
            "1단계 — 이름·연락 수단·국적·언어 / 암종·병기 / 하고 싶은 말",
            "2단계 — 진단서·검사지·영상(CD 폴더째) / 여권 라틴 표기 / 보험",
            "자료 묶음 끌어다 놓기 — 올리는 즉시 무엇인지 자동 판독, 빠진 서류만 알려줌",
            "아래 고정 막대 — 남은 항목 · [보내기]",
        ],
        data=[
        ...
        notes=["1단계만 채워도 접수된다 — 자료가 없어 못 보내는 일을 없앤다.",
    ...
    dict(
        ...
        parts=["왼쪽 메뉴 — 인박스·케이스·상담·견적·알림·전환 현황",
               "검색·필터 — 국적·암종·단계·담당자",
    ...
    dict(
        no="P-08", file="P-08_portal.png", name="사후관리 — 환자 포털",
        ict="④ · ⑤ · ⑥", path="/portal", who="환자(로그인)",
        purpose="귀국 후에도 한국 의료진과 끊기지 않게 경과를 주고받고, 재방문 시점을 놓치지 않게 한다.",
        parts=["오늘의 체크 — 증상·통증·체온·복약 여부",
               "다음 일정 — 1주·2주·1개월·3개월·6개월 자동 안내",
               "검사 결과 올리기 — 현지 병원에서 받은 검사지·영상",
               "이상 징후 알림 — AI가 감지 → 담당 의료진에게 전달",
               "교육 콘텐츠 — 암 5종 식이·운동·복약·경고징후(6개 언어)",
               "재방문 상담 — 필요성 자동 판단 → 예상 비용·일정 안내",
               "[남은 것] 단계별 자동 발송 — 귀국 후 시기에 맞춰 콘텐츠를 자동으로 보내는 부분"],
        data=["education_contents 18건 — 위·유방·간·폐·갑상선 5종, 러시아어 본문 전건 채워 발행",
              "symptom_reports · followup_schedules — 기능은 서 있으나 실사용 데이터 0~1건",
              "device_tokens 7건(푸시 알림 등록)"],
        nexts="→ P-04 원격 경과상담 · P-09 성과 대시보드",
        notes=["교육 콘텐츠는 /education 에서 6개 언어로 실제 열람된다(2026-08-19 실서비스 확인).",
               "나머지 칸은 기능이 서 있으나 유치 확정 환자가 없어 실사용 데이터가 0건이다 — "
    ...
    dict(
        ...
        parts=["지표 카드 — 유치 · 사전상담+사후관리 · 만족도 · 다국어",
               "유치 전환 깔때기 — 문의 → 사전상담 → 의뢰 → 방한 → 치료 → 사후관리",
