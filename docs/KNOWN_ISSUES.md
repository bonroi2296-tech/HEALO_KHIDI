...
- **결제 현황 정정(2026-07-27 실측 기준)**: 2026-07-24 기록의 「미결제 잔여」 목록은 낡았다 — **Supabase = Pro · Vercel = Pro · Apple $99 결제완료 · LiveKit = 무료 플랜(NEXT INVOICE $0.00)**. 남은 건 **LiveKit 유료 전환**(무료 한도 WebRTC 5,000분/월 — 2026-07 사용량 2,593분, 8/27 평가 준비로 늘면 이번 달에 찰 수 있다)과 Gemini spend cap.
