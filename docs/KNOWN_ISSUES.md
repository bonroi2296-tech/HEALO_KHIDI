...
- 부하 측: 방치된 화상상담 탭이 4~8초마다 무한 폴링하던 것 수리(POSTMORTEMS #119 / PR #969). 3시간 요청의 **72%가 상담방 하나**였음.
- 화면 측: 인증 서버 무응답 시 로딩에 갇히던 것 수리(POSTMORTEMS #118 / PR #968, `withAuthTimeout`).
