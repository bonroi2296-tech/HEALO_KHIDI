...
**고치는 법은 위 2곳과 똑같다**(`reqSeqRef` 순번 4줄). 그 화면에서 「거름망 눌렀는데 목록이 이상하다」가
...
## 🔴 오후 3시 배포 창구가 매일 **2시간 반~3시간 늦게** 열린다 — 깃허브가 예약을 제때 안 깨운다 (2026-07-31 실측, PO 제보)
...
## 🔴🛑 KHIDI 중간평가(2026-08-27)까지 **29일 남았는데 공식 지표가 사실상 0** — 잔금 30% 가 걸린 사안 (2026-07-29 DB 실측)
