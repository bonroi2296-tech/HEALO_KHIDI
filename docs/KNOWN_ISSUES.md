...
## 🟢 2026-09-05 트렌드 스캔 발견: 보석 2건(①적용함 ②나중에) + 기록만 3건 + 뺀 것 10건

> `/trend` 주간 스캔(창: 2026-08-22~09-05). **코드 변경은 ① 판 올리기(next·sharp)뿐, 나머지는 기록.** 후보 15건을 저장소 전수 검색·실DB·실서비스로 대조해 **보석 2건**만 남겼다.
> 나머지 13건 = 기록만 한 3건(③ 3.8 Flash · ⑤ 시장 2건) + 뺀 10건(④, «왜 뺐나» 한 줄씩 — 다음 스캔이 같은 걸 또 캐지 않게).
