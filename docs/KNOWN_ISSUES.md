...
| 4 | ~~앱 링크 미선언~~ | ✅ 해소 — `autoVerify` + 서버 `assetlinks.json` 200 (2026-08-29 실측) | `AndroidManifest.xml` | 필요 |
...
| 11 | 썸네일 삭제 X 4곳 = 보이지 않는 클릭 지뢰 | 🟡 뿌리(12번)는 해소 · 이 4곳은 화면으로 재확인 필요 | 백오피스 4파일 | 불필요 |
