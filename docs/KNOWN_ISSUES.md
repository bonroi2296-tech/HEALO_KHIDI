...
## 🔸 「접근 권한 없음」 오류 화면은 아직 한국어 (2026-07-29, 위 확인 중 곁가지로 발견)

- 러시아어로 바꾼 상태에서 권한 없는 주소(`/hospital`)에 들어가면 껍데기는 러시아어인데 본문만 **「접근 권한 없음 · 병원 포털에 접속할 수 없습니다」** 한국어로 뜬다.
- 자주 볼 화면은 아니지만, 파트너가 길을 잘못 들었을 때 **가장 도움이 필요한 순간**에 한국어가 나온다. 다음에 포털 손볼 때 같이.
