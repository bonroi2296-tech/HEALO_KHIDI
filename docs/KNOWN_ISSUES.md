...
## 🔸 [B2B 판] 면력 의료진 **27명 중 4명만** 싣고 있다 — 사진 29장은 이미 있는데 «누가 누구인지»가 확인 안 됨 (2026-07-29)

- **상태**: 판의 의료진 섹션에 지점장 4명(황이준·유형진·배길준·강주안)만 있다. 병원 사이트에는 **27명**이 있다 (강서 6 · 광명 7 · 신촌 6 · 성동 8).
- **자산은 이미 있다**: `public/immune/doctor/` 에 **29장**이 로마자 파일명(`gangeo-dr-lee-useok.jpg` 등)으로 저장돼 있다. 27명을 덮고도 남는다.
  ⚠️ 이걸 모르고 이번에 13장을 또 받았다가 지웠다 — **오늘만 세 번째로 「있는 자산부터 뒤져라」를 어겼다**(면력 시설 사진 22장 · 지점 사진 20장 · 의료진 사진 29장).
- **왜 아직 안 실었나 (의도적 보류)**: **파일명이 그 사람이라는 증거가 아니다.** 실제로 확인해 보니
  - 지점장 4명은 병원 사이트 사진을 받아 **눈으로 대조 — 같은 사람 확인** ✅
  - 나머지는 우리 파일이 다시 저장되며(png↔jpg) 바이트가 달라 해시로 못 맞춘다. 픽셀로 맞춰봤더니 **13명 중 12명은 일치, 1명(강서 배상근)은 다른 사람 파일(`gangeo-dr-im-jisung.jpg`)에 더 가깝게 나왔다** — 즉 **짝짓기가 틀린 게 최소 1건 있을 수 있다.**
  - 성동 5명은 병원 서버가 연속 요청을 막아 대조 자체를 못 했다.
- **왜 중요한가**: 의료진은 **이름은 맞는데 얼굴이 다르면 주소 오류보다 큰 사고**다(실명 + 남의 얼굴). 그래서 «많이 싣기»보다 «틀리지 않기»를 택해 4명에서 멈췄다.
- **다음에 할 것**: ①병원에서 의료진 명단·사진을 **정식으로 받는다**(가장 확실) ②아니면 27명 각각을 병원 페이지 사진과 나란히 놓고 눈으로 대조한 뒤 싣는다(요청 간격을 두고).
