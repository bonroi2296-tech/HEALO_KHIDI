...
1. **에이전시 포털 — 병원 응답 경로의 타임라인 중복이 미해결** (2026-07-07 PR #706 때 남긴 것). 케이스 상태 이력 중복은 잡았는데 `hospital_leads → case_status_history` 경로는 별도 소스라 그대로다. **재검토: 2026-08-07** · 지금 가능 · 어시 몫.
