...
- 진짜 비용은 모델보다 **파이썬 워커 상시 가동**(LiveKit Cloud Agents) — 켜는 방식에서 확정.
  - **2026-07-28 해소**: LiveKit **Ship($50/월) 구독** → 통역봇 **5,000분/월 포함**(무료 Build 는 1,000분).
    30분 상담 기준 **월 약 166건**까지 봇 비용 0 = KHIDI 목표 120건(≈3,600분)은 포함량 안. 초과분만 $0.01/분.
    봇 배포 슬롯 2개·동시 세션 20개도 같이 열렸다.
