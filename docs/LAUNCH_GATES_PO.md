...
| 7 | 💤 **관문7 — Gemini 유료 결제 확인** (의료 PII 학습 방지) | PO 콘솔 | **보채기 제외, 단 조건부 복귀** — PO 정의 "오픈 = 실제 그만큼의 리소스가 발생할 때"(2026-07-02). 현재 찔끔 유입은 문턱 아래 → PO 자가 관리. **비테스트 실문의 주 5건↑ 또는 AI챗 실사용 지속 시 보채기 복귀** |
