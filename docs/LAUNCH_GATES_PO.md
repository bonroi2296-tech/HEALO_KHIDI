...
| 순위 | 관문 | 누가 | 비고 |
|---|------|------|------|
| 1 | 🔴 **관문7 — Gemini 유료 결제 확인** (의료 PII 학습 방지) | PO 콘솔 | ↓ 아래 가이드 |
| 2 | 🟢 **관문8 — 텔레그램 알림 env 2개** | PO 콘솔 | ↓ 아래 가이드 |
| 3 | 🟡 **관문10 — DPA 서명** (무료) | PO | `docs/audit/DPA_SIGNING_GUIDE.md` |
| 4 | 🔴 **관문13~17 — 앱스토어**(결제·Firebase·에셋·빌드) | PO | 아래 C섹션 |
...
| 3 | **구글 OAuth 게시(테스트→프로덕션)** | PO 콘솔 | ✅ **닫힘(2026-07-02 실측)** — PO가 이전에 게시 완료. 증거: 테스트 사용자 목록에 없는 외부 계정(medextravel.kg@gmail.com, 키르기스스탄 의료관광 에이전시 추정)이 2026-07-02 구글 로그인 실가입 성공(auth.users 실DB). 테스트 모드였다면 불가능 |
