...
| 순위 | 관문 | 누가 | 비고 |
|---|------|------|------|
| 1 | 💤 **관문7 — Gemini 유료 결제 확인** (의료 PII 학습 방지) | PO 콘솔 | **보채기 제외, 단 조건부 복귀** — PO 정의 "오픈 = 실제 그만큼의 리소스가 발생할 때"(2026-07-02). 현재 찔끔 유입은 문턱 아래 → PO 자가 관리. **비테스트 실문의 주 5건↑ 또는 AI챗 실사용 지속 시 보채기 복귀** |
| 2 | 🟢 **관문8 — 텔레그램 알림 env 2개** | PO 콘솔 | ↓ 아래 가이드 |
| 3 | ⏰ **구글 광고 「본인 인증」 — 기한 2026-08-12** | **PO 본인만**(신분 확인이라 어시 불가) | **뭘 하나**: https://ads.google.com 로그인(계정 `671-067-3358`) → 구글이 띄우는 **「본인 인증을 해 주세요」** 창의 **「확인」**. **왜**: 인증 창이 뜬 뒤엔 설정 저장이 막힌다(2026-07-29 「유럽 정치광고 없음」 답이 실제로 유실됨). **2026-08-12 뒤엔 「나중에」가 사라진다.** **안 급한 이유**: 광고가 아직 초안이라 돈이 안 나간다. 상세 `docs/광고_캠페인_플랜.md` |
| 4 | 🟡 **관문10 — DPA 서명** (무료) | PO | `docs/audit/DPA_SIGNING_GUIDE.md` |
| 5 | 🔴 **관문13~17 — 앱스토어**(결제·Firebase·에셋·빌드) | PO | 아래 C섹션 · **결제 부분은 보채기 제외**(PO 인지·직접, 2026-07-02) |
...
## 🔴 관문 7 — Gemini 유료 결제 확인 (의료 PII·출시 전 필수) — 2026-07-27 기준, 이후 어시 미확인

> ⚠️ **결제 상태의 정본은 PO 로컬 폴더**(`05. 비용 집행 > 02. 온라인 결제`)다 — 어시는 못 본다. 이 관문이 아직 열려 있는지는 **PO 만 안다**(반성문 #137).
