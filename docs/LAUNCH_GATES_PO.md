...
| 순위 | 관문 | 누가 | 비고 |
|---|------|------|------|
| 1 | 💤 **관문7 — Gemini 유료 결제 확인** (의료 PII 학습 방지) | PO 콘솔 | **보채기 제외** — PO 인지·정식 오픈 전 직접 처리(2026-07-02 PO 지시) |
...
> 💤 **보채기 제외 규칙(2026-07-02 PO 지시)**: 유료 결제류 관문은 PO가 내용을 충분히 인지하고 있고 **정식 오픈 전에 직접 처리**하기로 함 — 세션 리마인드(보채기) 대상에서 제외. 단 **새로운 돈 이슈**(새 유료 필요·예상 밖 과금)가 생기면 즉시 보고.
